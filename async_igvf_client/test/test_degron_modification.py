...
class TestDegronModification(unittest.TestCase):
    """DegronModification unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DegronModification:
        """Test DegronModification
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DegronModification`
        """
        model = DegronModification()
        if include_optional:
            return DegronModification(
    ...
    def testDegronModification(self):
        """Test DegronModification"""
