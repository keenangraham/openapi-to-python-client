    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "type": "Set<ModelFileCollectionsEnum>",
            "format": ""
        },
        {
            "name": "status",
        ...
        },
        {
            ...
            "type": "ModelFileUploadStatusEnum",
            "format": ""
        },
        {
...
export enum ModelFileCollectionsEnum {
    ClinGen = 'ClinGen',
    Encode = 'ENCODE',
    GregoR = 'GREGoR',
...
export enum ModelFileFileFormatEnum {
    Hdf5 = 'hdf5',
    Json = 'json',
    Tar = 'tar',
    Tsv = 'tsv'
}
export enum ModelFileUploadStatusEnum {
    Pending = 'pending',
