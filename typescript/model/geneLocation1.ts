...
*/
export class GeneLocation1 {
    /**
    * The genome assembly to which coordinates relate. e.g. GRCh38.
    */
    'assembly': GeneLocation1.AssemblyEnum;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "assembly",
            "baseName": "assembly",
            "type": "GeneLocation1.AssemblyEnum"
        },
        {
            "name": "chromosome",
            "baseName": "chromosome",
    ...
    static getAttributeTypeMap() {
        return GeneLocation1.attributeTypeMap;
    }
}

export namespace GeneLocation1 {
