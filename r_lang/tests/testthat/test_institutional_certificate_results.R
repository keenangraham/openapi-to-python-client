...
context("Test InstitutionalCertificateResults")

model_instance <- InstitutionalCertificateResults$new()

test_that("@graph", {
  # tests for the property `@graph` (array[InstitutionalCertificate])
