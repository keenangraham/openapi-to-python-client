...
context("Test GenomeBrowserAnnotationFileResults")

model_instance <- GenomeBrowserAnnotationFileResults$new()

test_that("@graph", {
  # tests for the property `@graph` (array[GenomeBrowserAnnotationFile])
