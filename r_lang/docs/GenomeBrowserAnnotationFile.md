...
------------ | ------------- | ------------- | -------------
**assembly** | **character** | Genome assembly applicable for the annotation data. | [optional] [Enum: [GRCh38, GRCm39]] 
...
**file_format** | **character** | The file format or extension of the file. | [optional] [Enum: [bigBed, tabix]] 
...
**summary** | **character** | A summary of the genome browser annotation file. | [optional] 
