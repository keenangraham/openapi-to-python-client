...
#' @field title The complete name of the originating lab or vendor. character [optional]
#' @field name A short unique name for the source. character [optional]
#' @field @id  character [optional]
#' @field @type  list(character) [optional]
#' @field summary A summary of the source. character [optional]
...
Source <- R6::R6Class(
  ...
  public = list(
    ...
    #' @param title The complete name of the originating lab or vendor.
    #' @param name A short unique name for the source.
    #' @param @id @id
    #' @param @type @type
    #' @param summary A summary of the source.
    #' @param ... Other optional arguments.
    #' @export
    initialize = function(`release_timestamp` = NULL, `status` = NULL, `url` = NULL, `schema_version` = NULL, `uuid` = NULL, `notes` = NULL, `aliases` = NULL, `creation_timestamp` = NULL, `submitted_by` = NULL, `submitter_comment` = NULL, `description` = NULL, `title` = NULL, `name` = NULL, `@id` = NULL, `@type` = NULL, `summary` = NULL, ...) {
    ...
    #' To JSON String
    #'
    #' @return Source in JSON format
    #' @export
    toJSON = function() {
      SourceObject <- list()
      if (!is.null(self$`release_timestamp`)) {
        SourceObject[["release_timestamp"]] <-
      ...
      if (!is.null(self$`aliases`)) {
        SourceObject[["aliases"]] <-
          self$`aliases`
      }
      if (!is.null(self$`creation_timestamp`)) {
        SourceObject[["creation_timestamp"]] <-
          self$`creation_timestamp`
      }
      if (!is.null(self$`submitted_by`)) {
        SourceObject[["submitted_by"]] <-
          self$`submitted_by`
      }
      if (!is.null(self$`submitter_comment`)) {
        SourceObject[["submitter_comment"]] <-
    ...
    #' Deserialize JSON string into an instance of Source
    #'
    #' @description
    #' Deserialize JSON string into an instance of Source
    #'
    #' @param input_json the JSON input
    #' @return the instance of Source
    #' @export
    ...
    #' Validate JSON input with respect to Source
    #'
    #' @description
    #' Validate JSON input with respect to Source and throw an exception if invalid
    #'
...
# Source$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
