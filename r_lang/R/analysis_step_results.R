#' Create a new AnalysisStepResults
#'
#' @description
#' AnalysisStepResults Class
#'
#' @docType class
#' @title AnalysisStepResults
#' @description AnalysisStepResults Class
#' @format An \code{R6Class} generator object
#' @field @graph  list(\link{AnalysisStep}) [optional]
...
#' @export
AnalysisStepResults <- R6::R6Class(
  "AnalysisStepResults",
  public = list(
    `@graph` = NULL,
    `@id` = NULL,
    ...
    `total` = NULL,
    `facets` = NULL,
    #' Initialize a new AnalysisStepResults class.
    #'
    #' @description
    #' Initialize a new AnalysisStepResults class.
    #'
    ...
    #' To JSON String
    #'
    #' @return AnalysisStepResults in JSON format
    #' @export
    toJSON = function() {
      AnalysisStepResultsObject <- list()
      if (!is.null(self$`@graph`)) {
        AnalysisStepResultsObject[["@graph"]] <-
          lapply(self$`@graph`, function(x) x$toJSON())
      }
      if (!is.null(self$`@id`)) {
        AnalysisStepResultsObject[["@id"]] <-
          self$`@id`
      }
      if (!is.null(self$`@type`)) {
        AnalysisStepResultsObject[["@type"]] <-
          self$`@type`
      }
      if (!is.null(self$`total`)) {
        AnalysisStepResultsObject[["total"]] <-
          self$`total`
      }
      if (!is.null(self$`facets`)) {
        AnalysisStepResultsObject[["facets"]] <-
          lapply(self$`facets`, function(x) x$toJSON())
      }
      AnalysisStepResultsObject
    },
    #' Deserialize JSON string into an instance of AnalysisStepResults
    #'
    #' @description
    #' Deserialize JSON string into an instance of AnalysisStepResults
    #'
    #' @param input_json the JSON input
    #' @return the instance of AnalysisStepResults
    #' @export
    fromJSON = function(input_json) {
      this_object <- jsonlite::fromJSON(input_json)
      if (!is.null(this_object$`@graph`)) {
        self$`@graph` <- ApiClient$new()$deserializeObj(this_object$`@graph`, "array[AnalysisStep]", loadNamespace("igvf_client"))
      }
...
',
    ...
    #' Validate JSON input with respect to AnalysisStepResults
    #'
    #' @description
    #' Validate JSON input with respect to AnalysisStepResults and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of AnalysisStepResults
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# AnalysisStepResults$unlock()
#
## Below is an example to define the print function
# AnalysisStepResults$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# AnalysisStepResults$lock()
