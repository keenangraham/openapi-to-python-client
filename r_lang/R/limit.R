  ...
  public = list(
    ...
    initialize = function(instance = NULL) {
      if (is.null(instance)) {
        ...
        stop(paste("Failed to initialize Limit with oneOf schemas character, integer. Provided class name: ",
                   get(class(instance)[[1]], pos = -1)$classname))
      }
    },
    #' Deserialize JSON string into an instance of Limit.
    #'
    #' @description
    #' Deserialize JSON string into an instance of Limit.
    ...
    fromJSON = function(input) {
      ...
      if (matched == 1) {
        ...
        # no match
        stop(paste("No match found when deserializing the input into Limit with oneOf schemas character, integer. Details: >>",
                   paste(error_messages, collapse = " >> ")))
      }

      self
    },
    #' Serialize Limit to JSON string.
    #'
    #' @description
    #' Serialize Limit to JSON string.
    #'
    #' @return JSON string representation of the Limit.
    #' @export
    ...
    #' Serialize Limit to JSON.
    #'
    #' @description
    #' Serialize Limit to JSON.
    #'
    #' @return JSON representation of the Limit.
    #' @export
    toJSON = function() {
      if (!is.null(self$actual_instance)) {
    ...
    #' Validate the input JSON with respect to Limit.
    #'
    #' @description
    #' Validate the input JSON with respect to Limit and
...
#Limit$set("public", "print", function(...) {
#  print(jsonlite::prettify(self$toJSONString()))
#  invisible(self)
#})
