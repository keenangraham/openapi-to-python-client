#' Create a new WholeOrganismResults
#'
#' @description
#' WholeOrganismResults Class
#'
#' @docType class
#' @title WholeOrganismResults
#' @description WholeOrganismResults Class
#' @format An \code{R6Class} generator object
#' @field @graph  list(\link{WholeOrganism}) [optional]
...
#' @export
WholeOrganismResults <- R6::R6Class(
  ...
  public = list(
    ...
    `total` = NULL,
    `facets` = NULL,
    #' Initialize a new WholeOrganismResults class.
    #'
    #' @description
    #' Initialize a new WholeOrganismResults class.
    #'
    ...
    #' To JSON String
    #'
    #' @return WholeOrganismResults in JSON format
    #' @export
    toJSON = function() {
      WholeOrganismResultsObject <- list()
      if (!is.null(self$`@graph`)) {
        WholeOrganismResultsObject[["@graph"]] <-
          lapply(self$`@graph`, function(x) x$toJSON())
      }
      if (!is.null(self$`@id`)) {
        WholeOrganismResultsObject[["@id"]] <-
          self$`@id`
      }
      if (!is.null(self$`@type`)) {
        WholeOrganismResultsObject[["@type"]] <-
          self$`@type`
      }
      if (!is.null(self$`total`)) {
        WholeOrganismResultsObject[["total"]] <-
          self$`total`
      }
      if (!is.null(self$`facets`)) {
        WholeOrganismResultsObject[["facets"]] <-
          lapply(self$`facets`, function(x) x$toJSON())
      }
      WholeOrganismResultsObject
    },
    #' Deserialize JSON string into an instance of WholeOrganismResults
    #'
    #' @description
    #' Deserialize JSON string into an instance of WholeOrganismResults
    #'
    #' @param input_json the JSON input
    #' @return the instance of WholeOrganismResults
    #' @export
    fromJSON = function(input_json) {
      this_object <- jsonlite::fromJSON(input_json)
      if (!is.null(this_object$`@graph`)) {
        self$`@graph` <- ApiClient$new()$deserializeObj(this_object$`@graph`, "array[WholeOrganism]", loadNamespace("igvf_client"))
      }
...
',
    ...
    #' Validate JSON input with respect to WholeOrganismResults
    #'
    #' @description
    #' Validate JSON input with respect to WholeOrganismResults and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of WholeOrganismResults
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# WholeOrganismResults$unlock()
#
## Below is an example to define the print function
# WholeOrganismResults$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# WholeOrganismResults$lock()
