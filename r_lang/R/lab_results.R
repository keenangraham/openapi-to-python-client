...
#' @docType class
#' @title LabResults
#' @description LabResults Class
#' @format An \code{R6Class} generator object
#' @field @graph  list(\link{Lab}) [optional]
...
LabResults <- R6::R6Class(
  ...
  public = list(
    ...
    `total` = NULL,
    `facets` = NULL,
    #' Initialize a new LabResults class.
    #'
    #' @description
    #' Initialize a new LabResults class.
    #'
    ...
    #' To JSON String
    #'
    #' @return LabResults in JSON format
    #' @export
    toJSON = function() {
      LabResultsObject <- list()
      if (!is.null(self$`@graph`)) {
        LabResultsObject[["@graph"]] <-
      ...
      if (!is.null(self$`@type`)) {
        LabResultsObject[["@type"]] <-
          self$`@type`
      }
      if (!is.null(self$`total`)) {
        LabResultsObject[["total"]] <-
          self$`total`
      }
      if (!is.null(self$`facets`)) {
        LabResultsObject[["facets"]] <-
          lapply(self$`facets`, function(x) x$toJSON())
      }
      LabResultsObject
    },
    #' Deserialize JSON string into an instance of LabResults
    #'
    #' @description
    #' Deserialize JSON string into an instance of LabResults
    #'
    #' @param input_json the JSON input
    #' @return the instance of LabResults
    #' @export
    fromJSON = function(input_json) {
      this_object <- jsonlite::fromJSON(input_json)
      if (!is.null(this_object$`@graph`)) {
        self$`@graph` <- ApiClient$new()$deserializeObj(this_object$`@graph`, "array[Lab]", loadNamespace("igvf_client"))
      }
...
',
    ...
    #' Validate JSON input with respect to LabResults
    #'
    #' @description
    #' Validate JSON input with respect to LabResults and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of LabResults
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# LabResults$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
