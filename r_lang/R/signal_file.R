...
#' @field summary A summary of the signal file. character [optional]
...
SignalFile <- R6::R6Class(
  ...
  public = list(
    ...
    #' @param @id @id
    #' @param @type @type
    #' @param summary A summary of the signal file.
    ...
    initialize = function(`transcriptome_annotation` = NULL, `assembly` = NULL, `release_timestamp` = NULL, `reference_files` = NULL, `documents` = NULL, `lab` = NULL, `award` = NULL, `accession` = NULL, `alternate_accessions` = NULL, `collections` = NULL, `status` = NULL, `revoke_detail` = NULL, `schema_version` = NULL, `uuid` = NULL, `notes` = NULL, `aliases` = NULL, `creation_timestamp` = NULL, `submitted_by` = NULL, `submitter_comment` = NULL, `description` = NULL, `analysis_step_version` = NULL, `content_md5sum` = NULL, `content_type` = NULL, `dbxrefs` = NULL, `derived_from` = NULL, `file_format` = NULL, `file_format_specifications` = NULL, `file_set` = NULL, `file_size` = NULL, `md5sum` = NULL, `submitted_file_name` = NULL, `upload_status` = NULL, `validation_error_detail` = NULL, `strand_specificity` = NULL, `filtered` = NULL, `normalized` = NULL, `start_view_position` = NULL, `@id` = NULL, `@type` = NULL, `summary` = NULL, `integrated_in` = NULL, `input_file_for` = NULL, `gene_list_for` = NULL, `loci_list_for` = NULL, `href` = NULL, `s3_uri` = NULL, `upload_credentials` = NULL, `content_summary` = NULL, ...) {
      ...
      if (!is.null(`strand_specificity`)) {
        if (!(`strand_specificity` %in% c("plus", "minus", "unstranded"))) {
          stop(paste("Error! \"", `strand_specificity`, "\" cannot be assigned to `strand_specificity`. Must be \"plus\", \"minus\", \"unstranded\".", sep = ""))
        }
      ...
      if (!is.null(`start_view_position`)) {
        if (!(is.character(`start_view_position`) && length(`start_view_position`) == 1)) {
          stop(paste("Error! Invalid data for `start_view_position`. Must be a string:", `start_view_position`))
        }
        self$`start_view_position` <- `start_view_position`
      }
      if (!is.null(`@id`)) {
    ...
    #' To JSON String
    #'
    #' @return SignalFile in JSON format
    #' @export
    toJSON = function() {
      ...
      if (!is.null(self$`lab`)) {
        SignalFileObject[["lab"]] <-
          self$`lab`
      }
      if (!is.null(self$`award`)) {
        SignalFileObject[["award"]] <-
          self$`award`
      }
      if (!is.null(self$`accession`)) {
        SignalFileObject[["accession"]] <-
          self$`accession`
      }
      if (!is.null(self$`alternate_accessions`)) {
        SignalFileObject[["alternate_accessions"]] <-
          self$`alternate_accessions`
      }
      if (!is.null(self$`collections`)) {
        SignalFileObject[["collections"]] <-
          self$`collections`
      }
      if (!is.null(self$`status`)) {
        SignalFileObject[["status"]] <-
          self$`status`
      }
      if (!is.null(self$`revoke_detail`)) {
        SignalFileObject[["revoke_detail"]] <-
          self$`revoke_detail`
      }
      if (!is.null(self$`schema_version`)) {
        SignalFileObject[["schema_version"]] <-
          self$`schema_version`
      }
      if (!is.null(self$`uuid`)) {
        SignalFileObject[["uuid"]] <-
          self$`uuid`
      }
      if (!is.null(self$`notes`)) {
        SignalFileObject[["notes"]] <-
          self$`notes`
      }
      if (!is.null(self$`aliases`)) {
        SignalFileObject[["aliases"]] <-
          self$`aliases`
      }
      if (!is.null(self$`creation_timestamp`)) {
        SignalFileObject[["creation_timestamp"]] <-
          self$`creation_timestamp`
      }
      if (!is.null(self$`submitted_by`)) {
        SignalFileObject[["submitted_by"]] <-
          self$`submitted_by`
      }
      if (!is.null(self$`submitter_comment`)) {
        SignalFileObject[["submitter_comment"]] <-
          self$`submitter_comment`
      }
      if (!is.null(self$`description`)) {
        SignalFileObject[["description"]] <-
          self$`description`
      }
      if (!is.null(self$`analysis_step_version`)) {
        SignalFileObject[["analysis_step_version"]] <-
          self$`analysis_step_version`
      }
      if (!is.null(self$`content_md5sum`)) {
        SignalFileObject[["content_md5sum"]] <-
          self$`content_md5sum`
      }
      if (!is.null(self$`content_type`)) {
        SignalFileObject[["content_type"]] <-
          self$`content_type`
      }
      if (!is.null(self$`dbxrefs`)) {
        SignalFileObject[["dbxrefs"]] <-
          self$`dbxrefs`
      }
      if (!is.null(self$`derived_from`)) {
        SignalFileObject[["derived_from"]] <-
          self$`derived_from`
      }
      if (!is.null(self$`file_format`)) {
        SignalFileObject[["file_format"]] <-
          self$`file_format`
      }
      if (!is.null(self$`file_format_specifications`)) {
        SignalFileObject[["file_format_specifications"]] <-
          self$`file_format_specifications`
      }
      if (!is.null(self$`file_set`)) {
        SignalFileObject[["file_set"]] <-
          self$`file_set`
      }
      if (!is.null(self$`file_size`)) {
        SignalFileObject[["file_size"]] <-
          self$`file_size`
      }
      if (!is.null(self$`md5sum`)) {
        SignalFileObject[["md5sum"]] <-
          self$`md5sum`
      }
      if (!is.null(self$`submitted_file_name`)) {
        SignalFileObject[["submitted_file_name"]] <-
          self$`submitted_file_name`
      }
      if (!is.null(self$`upload_status`)) {
        SignalFileObject[["upload_status"]] <-
          self$`upload_status`
      }
      ...
      if (!is.null(self$`start_view_position`)) {
        SignalFileObject[["start_view_position"]] <-
          self$`start_view_position`
      }
      if (!is.null(self$`@id`)) {
        SignalFileObject[["@id"]] <-
          self$`@id`
      ...
      if (!is.null(self$`@type`)) {
        SignalFileObject[["@type"]] <-
          self$`@type`
      }
      if (!is.null(self$`summary`)) {
        SignalFileObject[["summary"]] <-
          self$`summary`
      }
      if (!is.null(self$`integrated_in`)) {
        SignalFileObject[["integrated_in"]] <-
          self$`integrated_in`
      }
      if (!is.null(self$`input_file_for`)) {
        SignalFileObject[["input_file_for"]] <-
          self$`input_file_for`
      }
      if (!is.null(self$`gene_list_for`)) {
        SignalFileObject[["gene_list_for"]] <-
          self$`gene_list_for`
      }
      if (!is.null(self$`loci_list_for`)) {
        SignalFileObject[["loci_list_for"]] <-
          self$`loci_list_for`
      }
      ...
      if (!is.null(self$`s3_uri`)) {
        SignalFileObject[["s3_uri"]] <-
          self$`s3_uri`
      }
      if (!is.null(self$`upload_credentials`)) {
        SignalFileObject[["upload_credentials"]] <-
    ...
    #' Deserialize JSON string into an instance of SignalFile
    #'
    #' @description
    #' Deserialize JSON string into an instance of SignalFile
    #'
    #' @param input_json the JSON input
    #' @return the instance of SignalFile
    #' @export
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`reference_files`)) {
        self$`reference_files` <- ApiClient$new()$deserializeObj(this_object$`reference_files`, "set[character]", loadNamespace("igvf_client"))
      ...
      if (!is.null(this_object$`start_view_position`)) {
    ...
    #'
    #' @description
    #' Validate JSON input with respect to SignalFile and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of SignalFile
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# SignalFile$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
