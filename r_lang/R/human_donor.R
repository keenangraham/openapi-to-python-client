  ...
  public = list(
    ...
    initialize = function(`release_timestamp` = NULL, `taxa` = NULL, `publications` = NULL, `publication_identifiers` = NULL, `url` = NULL, `documents` = NULL, `lab` = NULL, `award` = NULL, `accession` = NULL, `alternate_accessions` = NULL, `collections` = NULL, `status` = NULL, `revoke_detail` = NULL, `schema_version` = NULL, `uuid` = NULL, `notes` = NULL, `aliases` = NULL, `creation_timestamp` = NULL, `submitted_by` = NULL, `submitter_comment` = NULL, `description` = NULL, `dbxrefs` = NULL, `sex` = NULL, `phenotypic_features` = NULL, `virtual` = NULL, `related_donors` = NULL, `ethnicities` = NULL, `human_donor_identifiers` = NULL, `@id` = NULL, `@type` = NULL, `summary` = NULL, additional_properties = NULL, ...) {
      ...
      if (!is.null(`related_donors`)) {
        ...
        if (!identical(`related_donors`, unique(`related_donors`))) {
          stop("Error! Items in `related_donors` are not unique.")
        }
      ...
      if (!is.null(`ethnicities`)) {
        ...
        if (!identical(`ethnicities`, unique(`ethnicities`))) {
          stop("Error! Items in `ethnicities` are not unique.")
        }
      ...
      if (!is.null(`human_donor_identifiers`)) {
        ...
        if (!identical(`human_donor_identifiers`, unique(`human_donor_identifiers`))) {
          stop("Error! Items in `human_donor_identifiers` are not unique.")
        }
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`related_donors`)) {
        self$`related_donors` <- ApiClient$new()$deserializeObj(this_object$`related_donors`, "set[RelatedDonor]", loadNamespace("igvf_client"))
        if (!identical(self$`related_donors`, unique(self$`related_donors`))) {
          stop("Error! Items in `related_donors` are not unique.")
        }
      }
      if (!is.null(this_object$`ethnicities`)) {
        self$`ethnicities` <- ApiClient$new()$deserializeObj(this_object$`ethnicities`, "set[character]", loadNamespace("igvf_client"))
        if (!identical(self$`ethnicities`, unique(self$`ethnicities`))) {
          stop("Error! Items in `ethnicities` are not unique.")
        }
      }
      if (!is.null(this_object$`human_donor_identifiers`)) {
        self$`human_donor_identifiers` <- ApiClient$new()$deserializeObj(this_object$`human_donor_identifiers`, "set[character]", loadNamespace("igvf_client"))
        if (!identical(self$`human_donor_identifiers`, unique(self$`human_donor_identifiers`))) {
          stop("Error! Items in `human_donor_identifiers` are not unique.")
        }
      }
