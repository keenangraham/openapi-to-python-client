  ...
  public = list(
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`cell_fate_change_treatments`)) {
        self$`cell_fate_change_treatments` <- ApiClient$new()$deserializeObj(this_object$`cell_fate_change_treatments`, "set[character]", loadNamespace("igvf_client"))
      ...
      if (!is.null(this_object$`demultiplexed_to`)) {
        self$`demultiplexed_to` <- ApiClient$new()$deserializeObj(this_object$`demultiplexed_to`, "set[character]", loadNamespace("igvf_client"))
