...
TabularFile <- R6::R6Class(
  ...
  public = list(
    ...
    #' To JSON String
    #'
    #' @return TabularFile in JSON format
    #' @export
    toJSON = function() {
      ...
      if (!is.null(self$`release_timestamp`)) {
        TabularFileObject[["release_timestamp"]] <-
          self$`release_timestamp`
      }
      if (!is.null(self$`file_format_type`)) {
        TabularFileObject[["file_format_type"]] <-
      ...
      if (!is.null(self$`documents`)) {
        TabularFileObject[["documents"]] <-
          self$`documents`
      }
      if (!is.null(self$`lab`)) {
        TabularFileObject[["lab"]] <-
          self$`lab`
      }
      if (!is.null(self$`award`)) {
        TabularFileObject[["award"]] <-
          self$`award`
      }
      if (!is.null(self$`accession`)) {
        TabularFileObject[["accession"]] <-
          self$`accession`
      }
      if (!is.null(self$`alternate_accessions`)) {
        TabularFileObject[["alternate_accessions"]] <-
          self$`alternate_accessions`
      }
      if (!is.null(self$`collections`)) {
        TabularFileObject[["collections"]] <-
          self$`collections`
      }
      if (!is.null(self$`status`)) {
        TabularFileObject[["status"]] <-
          self$`status`
      }
      if (!is.null(self$`revoke_detail`)) {
        TabularFileObject[["revoke_detail"]] <-
          self$`revoke_detail`
      }
      if (!is.null(self$`schema_version`)) {
        TabularFileObject[["schema_version"]] <-
          self$`schema_version`
      }
      if (!is.null(self$`uuid`)) {
        TabularFileObject[["uuid"]] <-
          self$`uuid`
      }
      if (!is.null(self$`notes`)) {
        TabularFileObject[["notes"]] <-
          self$`notes`
      }
      if (!is.null(self$`aliases`)) {
        TabularFileObject[["aliases"]] <-
          self$`aliases`
      }
      if (!is.null(self$`creation_timestamp`)) {
        TabularFileObject[["creation_timestamp"]] <-
          self$`creation_timestamp`
      }
      if (!is.null(self$`submitted_by`)) {
        TabularFileObject[["submitted_by"]] <-
          self$`submitted_by`
      }
      if (!is.null(self$`submitter_comment`)) {
        TabularFileObject[["submitter_comment"]] <-
          self$`submitter_comment`
      }
      if (!is.null(self$`description`)) {
        TabularFileObject[["description"]] <-
          self$`description`
      }
      if (!is.null(self$`analysis_step_version`)) {
        TabularFileObject[["analysis_step_version"]] <-
          self$`analysis_step_version`
      }
      if (!is.null(self$`content_md5sum`)) {
        TabularFileObject[["content_md5sum"]] <-
          self$`content_md5sum`
      }
      if (!is.null(self$`content_type`)) {
        TabularFileObject[["content_type"]] <-
          self$`content_type`
      }
      if (!is.null(self$`dbxrefs`)) {
        TabularFileObject[["dbxrefs"]] <-
          self$`dbxrefs`
      }
      if (!is.null(self$`derived_from`)) {
        TabularFileObject[["derived_from"]] <-
          self$`derived_from`
      }
      ...
      if (!is.null(self$`file_set`)) {
        TabularFileObject[["file_set"]] <-
          self$`file_set`
      }
      if (!is.null(self$`file_size`)) {
        TabularFileObject[["file_size"]] <-
          self$`file_size`
      }
      if (!is.null(self$`md5sum`)) {
        TabularFileObject[["md5sum"]] <-
          self$`md5sum`
      }
      if (!is.null(self$`submitted_file_name`)) {
        TabularFileObject[["submitted_file_name"]] <-
          self$`submitted_file_name`
      }
      if (!is.null(self$`upload_status`)) {
        TabularFileObject[["upload_status"]] <-
          self$`upload_status`
      }
      if (!is.null(self$`validation_error_detail`)) {
        TabularFileObject[["validation_error_detail"]] <-
      ...
      if (!is.null(self$`@type`)) {
        TabularFileObject[["@type"]] <-
          self$`@type`
      }
      if (!is.null(self$`summary`)) {
        TabularFileObject[["summary"]] <-
          self$`summary`
      }
      if (!is.null(self$`integrated_in`)) {
        TabularFileObject[["integrated_in"]] <-
          self$`integrated_in`
      }
      if (!is.null(self$`input_file_for`)) {
        TabularFileObject[["input_file_for"]] <-
          self$`input_file_for`
      }
      if (!is.null(self$`gene_list_for`)) {
        TabularFileObject[["gene_list_for"]] <-
          self$`gene_list_for`
      }
    ...
    #' @return the instance of TabularFile
    #' @export
    ...
    #'
    #' @description
    #' Validate JSON input with respect to TabularFile and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of TabularFile
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# TabularFile$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
