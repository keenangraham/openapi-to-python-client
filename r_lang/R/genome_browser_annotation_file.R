#' Create a new GenomeBrowserAnnotationFile
#'
#' @description
...
#' @field summary A summary of the genome browser annotation file. character [optional]
...
GenomeBrowserAnnotationFile <- R6::R6Class(
  ...
  public = list(
    ...
    #' @param @id @id
    #' @param @type @type
    #' @param summary A summary of the genome browser annotation file.
    ...
    initialize = function(`assembly` = NULL, `release_timestamp` = NULL, `file_format_type` = NULL, `transcriptome_annotation` = NULL, `documents` = NULL, `lab` = NULL, `award` = NULL, `accession` = NULL, `alternate_accessions` = NULL, `collections` = NULL, `status` = NULL, `revoke_detail` = NULL, `schema_version` = NULL, `uuid` = NULL, `notes` = NULL, `aliases` = NULL, `creation_timestamp` = NULL, `submitted_by` = NULL, `submitter_comment` = NULL, `description` = NULL, `analysis_step_version` = NULL, `content_md5sum` = NULL, `content_type` = NULL, `dbxrefs` = NULL, `derived_from` = NULL, `file_format` = NULL, `file_format_specifications` = NULL, `file_set` = NULL, `file_size` = NULL, `md5sum` = NULL, `submitted_file_name` = NULL, `upload_status` = NULL, `validation_error_detail` = NULL, `@id` = NULL, `@type` = NULL, `summary` = NULL, `integrated_in` = NULL, `input_file_for` = NULL, `gene_list_for` = NULL, `loci_list_for` = NULL, `href` = NULL, `s3_uri` = NULL, `upload_credentials` = NULL, ...) {
      ...
      if (!is.null(`file_format`)) {
        if (!(`file_format` %in% c("bigBed", "tabix"))) {
          stop(paste("Error! \"", `file_format`, "\" cannot be assigned to `file_format`. Must be \"bigBed\", \"tabix\".", sep = ""))
        }
    ...
    #' To JSON String
    #'
    #' @return GenomeBrowserAnnotationFile in JSON format
    #' @export
    toJSON = function() {
      ...
      if (!is.null(self$`release_timestamp`)) {
        GenomeBrowserAnnotationFileObject[["release_timestamp"]] <-
          self$`release_timestamp`
      }
      if (!is.null(self$`file_format_type`)) {
        GenomeBrowserAnnotationFileObject[["file_format_type"]] <-
          self$`file_format_type`
      }
      if (!is.null(self$`transcriptome_annotation`)) {
        GenomeBrowserAnnotationFileObject[["transcriptome_annotation"]] <-
          self$`transcriptome_annotation`
      }
      if (!is.null(self$`documents`)) {
        GenomeBrowserAnnotationFileObject[["documents"]] <-
          self$`documents`
      }
      if (!is.null(self$`lab`)) {
        GenomeBrowserAnnotationFileObject[["lab"]] <-
          self$`lab`
      }
      if (!is.null(self$`award`)) {
        GenomeBrowserAnnotationFileObject[["award"]] <-
          self$`award`
      }
      if (!is.null(self$`accession`)) {
        GenomeBrowserAnnotationFileObject[["accession"]] <-
          self$`accession`
      }
      if (!is.null(self$`alternate_accessions`)) {
        GenomeBrowserAnnotationFileObject[["alternate_accessions"]] <-
          self$`alternate_accessions`
      }
      if (!is.null(self$`collections`)) {
        GenomeBrowserAnnotationFileObject[["collections"]] <-
          self$`collections`
      }
      if (!is.null(self$`status`)) {
        GenomeBrowserAnnotationFileObject[["status"]] <-
          self$`status`
      }
      if (!is.null(self$`revoke_detail`)) {
        GenomeBrowserAnnotationFileObject[["revoke_detail"]] <-
          self$`revoke_detail`
      }
      if (!is.null(self$`schema_version`)) {
        GenomeBrowserAnnotationFileObject[["schema_version"]] <-
          self$`schema_version`
      }
      if (!is.null(self$`uuid`)) {
        GenomeBrowserAnnotationFileObject[["uuid"]] <-
          self$`uuid`
      }
      if (!is.null(self$`notes`)) {
        GenomeBrowserAnnotationFileObject[["notes"]] <-
          self$`notes`
      }
      if (!is.null(self$`aliases`)) {
        GenomeBrowserAnnotationFileObject[["aliases"]] <-
          self$`aliases`
      }
      if (!is.null(self$`creation_timestamp`)) {
        GenomeBrowserAnnotationFileObject[["creation_timestamp"]] <-
          self$`creation_timestamp`
      }
      if (!is.null(self$`submitted_by`)) {
        GenomeBrowserAnnotationFileObject[["submitted_by"]] <-
          self$`submitted_by`
      }
      if (!is.null(self$`submitter_comment`)) {
        GenomeBrowserAnnotationFileObject[["submitter_comment"]] <-
          self$`submitter_comment`
      }
      if (!is.null(self$`description`)) {
        GenomeBrowserAnnotationFileObject[["description"]] <-
          self$`description`
      }
      if (!is.null(self$`analysis_step_version`)) {
        GenomeBrowserAnnotationFileObject[["analysis_step_version"]] <-
          self$`analysis_step_version`
      }
      if (!is.null(self$`content_md5sum`)) {
        GenomeBrowserAnnotationFileObject[["content_md5sum"]] <-
          self$`content_md5sum`
      }
      if (!is.null(self$`content_type`)) {
        GenomeBrowserAnnotationFileObject[["content_type"]] <-
          self$`content_type`
      }
      if (!is.null(self$`dbxrefs`)) {
        GenomeBrowserAnnotationFileObject[["dbxrefs"]] <-
          self$`dbxrefs`
      }
      if (!is.null(self$`derived_from`)) {
        GenomeBrowserAnnotationFileObject[["derived_from"]] <-
          self$`derived_from`
      }
      if (!is.null(self$`file_format`)) {
        GenomeBrowserAnnotationFileObject[["file_format"]] <-
          self$`file_format`
      }
      if (!is.null(self$`file_format_specifications`)) {
        GenomeBrowserAnnotationFileObject[["file_format_specifications"]] <-
          self$`file_format_specifications`
      }
      if (!is.null(self$`file_set`)) {
        GenomeBrowserAnnotationFileObject[["file_set"]] <-
          self$`file_set`
      }
      if (!is.null(self$`file_size`)) {
        GenomeBrowserAnnotationFileObject[["file_size"]] <-
          self$`file_size`
      }
      if (!is.null(self$`md5sum`)) {
        GenomeBrowserAnnotationFileObject[["md5sum"]] <-
          self$`md5sum`
      }
      if (!is.null(self$`submitted_file_name`)) {
        GenomeBrowserAnnotationFileObject[["submitted_file_name"]] <-
          self$`submitted_file_name`
      }
      if (!is.null(self$`upload_status`)) {
        GenomeBrowserAnnotationFileObject[["upload_status"]] <-
          self$`upload_status`
      }
      if (!is.null(self$`validation_error_detail`)) {
        GenomeBrowserAnnotationFileObject[["validation_error_detail"]] <-
          self$`validation_error_detail`
      }
      if (!is.null(self$`@id`)) {
        GenomeBrowserAnnotationFileObject[["@id"]] <-
          self$`@id`
      }
      if (!is.null(self$`@type`)) {
        GenomeBrowserAnnotationFileObject[["@type"]] <-
          self$`@type`
      }
      if (!is.null(self$`summary`)) {
        GenomeBrowserAnnotationFileObject[["summary"]] <-
          self$`summary`
      }
      if (!is.null(self$`integrated_in`)) {
        GenomeBrowserAnnotationFileObject[["integrated_in"]] <-
          self$`integrated_in`
      }
      if (!is.null(self$`input_file_for`)) {
        GenomeBrowserAnnotationFileObject[["input_file_for"]] <-
          self$`input_file_for`
      }
      if (!is.null(self$`gene_list_for`)) {
        GenomeBrowserAnnotationFileObject[["gene_list_for"]] <-
          self$`gene_list_for`
      }
      ...
      if (!is.null(self$`s3_uri`)) {
        GenomeBrowserAnnotationFileObject[["s3_uri"]] <-
          self$`s3_uri`
      }
      if (!is.null(self$`upload_credentials`)) {
        GenomeBrowserAnnotationFileObject[["upload_credentials"]] <-
          self$`upload_credentials`
      }
      GenomeBrowserAnnotationFileObject
    },
    #' Deserialize JSON string into an instance of GenomeBrowserAnnotationFile
    #'
    #' @description
    #' Deserialize JSON string into an instance of GenomeBrowserAnnotationFile
    #'
    #' @param input_json the JSON input
    #' @return the instance of GenomeBrowserAnnotationFile
    #' @export
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`file_format`)) {
        if (!is.null(this_object$`file_format`) && !(this_object$`file_format` %in% c("bigBed", "tabix"))) {
    ...
    #' Validate JSON input with respect to GenomeBrowserAnnotationFile
    #'
    #' @description
    #' Validate JSON input with respect to GenomeBrowserAnnotationFile and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of GenomeBrowserAnnotationFile
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# GenomeBrowserAnnotationFile$unlock()
#
## Below is an example to define the print function
# GenomeBrowserAnnotationFile$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# GenomeBrowserAnnotationFile$lock()
