#' Create a new AnalysisStepVersion
#'
#' @description
...
#' @field analysis_step The analysis step which this version belongs to. character [optional]
#' @field software_versions The software versions used in this analysis step versions. list(character) [optional]
...
AnalysisStepVersion <- R6::R6Class(
  ...
  public = list(
    ...
    #' @param analysis_step The analysis step which this version belongs to.
    #' @param software_versions The software versions used in this analysis step versions.
    #' @param @id @id
    #' @param @type @type
    ...
    initialize = function(`release_timestamp` = NULL, `status` = NULL, `lab` = NULL, `award` = NULL, `schema_version` = NULL, `uuid` = NULL, `notes` = NULL, `aliases` = NULL, `creation_timestamp` = NULL, `submitted_by` = NULL, `submitter_comment` = NULL, `description` = NULL, `analysis_step` = NULL, `software_versions` = NULL, `@id` = NULL, `@type` = NULL, `summary` = NULL, ...) {
      ...
      if (!is.null(`analysis_step`)) {
        if (!(is.character(`analysis_step`) && length(`analysis_step`) == 1)) {
          stop(paste("Error! Invalid data for `analysis_step`. Must be a string:", `analysis_step`))
        }
    ...
    #' To JSON String
    #'
    #' @return AnalysisStepVersion in JSON format
    #' @export
    toJSON = function() {
      ...
      if (!is.null(self$`status`)) {
        AnalysisStepVersionObject[["status"]] <-
          self$`status`
      }
      if (!is.null(self$`lab`)) {
        AnalysisStepVersionObject[["lab"]] <-
          self$`lab`
      }
      if (!is.null(self$`award`)) {
        AnalysisStepVersionObject[["award"]] <-
          self$`award`
      }
      if (!is.null(self$`schema_version`)) {
        AnalysisStepVersionObject[["schema_version"]] <-
          self$`schema_version`
      }
      if (!is.null(self$`uuid`)) {
        AnalysisStepVersionObject[["uuid"]] <-
          self$`uuid`
      }
      if (!is.null(self$`notes`)) {
        AnalysisStepVersionObject[["notes"]] <-
          self$`notes`
      }
      if (!is.null(self$`aliases`)) {
        AnalysisStepVersionObject[["aliases"]] <-
          self$`aliases`
      }
      if (!is.null(self$`creation_timestamp`)) {
        AnalysisStepVersionObject[["creation_timestamp"]] <-
          self$`creation_timestamp`
      }
      if (!is.null(self$`submitted_by`)) {
        AnalysisStepVersionObject[["submitted_by"]] <-
          self$`submitted_by`
      }
      if (!is.null(self$`submitter_comment`)) {
        AnalysisStepVersionObject[["submitter_comment"]] <-
          self$`submitter_comment`
      }
      if (!is.null(self$`description`)) {
        AnalysisStepVersionObject[["description"]] <-
          self$`description`
      }
      if (!is.null(self$`analysis_step`)) {
        AnalysisStepVersionObject[["analysis_step"]] <-
          self$`analysis_step`
      }
      if (!is.null(self$`software_versions`)) {
        AnalysisStepVersionObject[["software_versions"]] <-
          self$`software_versions`
      }
      if (!is.null(self$`@id`)) {
        AnalysisStepVersionObject[["@id"]] <-
          self$`@id`
      }
      if (!is.null(self$`@type`)) {
        AnalysisStepVersionObject[["@type"]] <-
          self$`@type`
      }
    ...
    #' @return the instance of AnalysisStepVersion
    #' @export
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`analysis_step`)) {
      ...
      jsoncontent <- c(
        ...
        if (!is.null(self$`analysis_step`)) {
          ...
          '"analysis_step":
            "%s"
                    ',
          gsub('(?<!\\\\)\\"', '\\\\"', self$`analysis_step`, perl=TRUE)
          )
        },
        if (!is.null(self$`software_versions`)) {
          sprintf(
    ...
    #'
    #' @description
    #' Validate JSON input with respect to AnalysisStepVersion and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of AnalysisStepVersion
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# AnalysisStepVersion$unlock()
#
## Below is an example to define the print function
# AnalysisStepVersion$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# AnalysisStepVersion$lock()
