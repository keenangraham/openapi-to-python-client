  ...
  public = list(
    ...
    initialize = function(instance = NULL) {
      if (is.null(instance)) {
        ...
        stop(paste("Failed to initialize MultiplexedSample with anyOf schemas AnyType. Provided class name: ",
    ...
    fromJSON = function(input) {
      ...
      # no match
      stop(paste("No match found when deserializing the input into MultiplexedSample with anyOf schemas AnyType. Details: >>",
