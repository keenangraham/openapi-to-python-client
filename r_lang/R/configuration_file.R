...
#' @field seqspec_of Sequence files this file is a seqspec of. list(character) [optional]
#' @field @id  character [optional]
#' @field @type  list(character) [optional]
#' @field summary A summary of the configuration file. character [optional]
...
ConfigurationFile <- R6::R6Class(
  ...
  public = list(
    ...
    #' @param seqspec_of Sequence files this file is a seqspec of.
    #' @param @id @id
    #' @param @type @type
    #' @param summary A summary of the configuration file.
    ...
    #' @export
    initialize = function(`release_timestamp` = NULL, `documents` = NULL, `lab` = NULL, `award` = NULL, `accession` = NULL, `alternate_accessions` = NULL, `collections` = NULL, `status` = NULL, `revoke_detail` = NULL, `schema_version` = NULL, `uuid` = NULL, `notes` = NULL, `aliases` = NULL, `creation_timestamp` = NULL, `submitted_by` = NULL, `submitter_comment` = NULL, `description` = NULL, `analysis_step_version` = NULL, `content_md5sum` = NULL, `content_type` = NULL, `dbxrefs` = NULL, `derived_from` = NULL, `file_format` = NULL, `file_format_specifications` = NULL, `file_set` = NULL, `file_size` = NULL, `md5sum` = NULL, `submitted_file_name` = NULL, `upload_status` = NULL, `validation_error_detail` = NULL, `seqspec_of` = NULL, `@id` = NULL, `@type` = NULL, `summary` = NULL, `integrated_in` = NULL, `input_file_for` = NULL, `gene_list_for` = NULL, `loci_list_for` = NULL, `href` = NULL, `s3_uri` = NULL, `upload_credentials` = NULL, ...) {
      ...
      if (!is.null(`seqspec_of`)) {
        stopifnot(is.vector(`seqspec_of`), length(`seqspec_of`) != 0)
        sapply(`seqspec_of`, function(x) stopifnot(is.character(x)))
        if (!identical(`seqspec_of`, unique(`seqspec_of`))) {
          stop("Error! Items in `seqspec_of` are not unique.")
        }
        self$`seqspec_of` <- `seqspec_of`
      }
      if (!is.null(`@id`)) {
    ...
    #' To JSON String
    #'
    #' @return ConfigurationFile in JSON format
    #' @export
    toJSON = function() {
      ...
      if (!is.null(self$`documents`)) {
        ConfigurationFileObject[["documents"]] <-
          self$`documents`
      }
      if (!is.null(self$`lab`)) {
        ConfigurationFileObject[["lab"]] <-
          self$`lab`
      }
      if (!is.null(self$`award`)) {
        ConfigurationFileObject[["award"]] <-
          self$`award`
      }
      if (!is.null(self$`accession`)) {
        ConfigurationFileObject[["accession"]] <-
          self$`accession`
      }
      if (!is.null(self$`alternate_accessions`)) {
        ConfigurationFileObject[["alternate_accessions"]] <-
          self$`alternate_accessions`
      }
      if (!is.null(self$`collections`)) {
        ConfigurationFileObject[["collections"]] <-
          self$`collections`
      }
      if (!is.null(self$`status`)) {
        ConfigurationFileObject[["status"]] <-
          self$`status`
      }
      if (!is.null(self$`revoke_detail`)) {
        ConfigurationFileObject[["revoke_detail"]] <-
          self$`revoke_detail`
      }
      if (!is.null(self$`schema_version`)) {
        ConfigurationFileObject[["schema_version"]] <-
          self$`schema_version`
      }
      if (!is.null(self$`uuid`)) {
        ConfigurationFileObject[["uuid"]] <-
          self$`uuid`
      }
      if (!is.null(self$`notes`)) {
        ConfigurationFileObject[["notes"]] <-
          self$`notes`
      }
      if (!is.null(self$`aliases`)) {
        ConfigurationFileObject[["aliases"]] <-
          self$`aliases`
      }
      if (!is.null(self$`creation_timestamp`)) {
        ConfigurationFileObject[["creation_timestamp"]] <-
          self$`creation_timestamp`
      }
      if (!is.null(self$`submitted_by`)) {
        ConfigurationFileObject[["submitted_by"]] <-
          self$`submitted_by`
      }
      if (!is.null(self$`submitter_comment`)) {
        ConfigurationFileObject[["submitter_comment"]] <-
          self$`submitter_comment`
      }
      if (!is.null(self$`description`)) {
        ConfigurationFileObject[["description"]] <-
          self$`description`
      }
      if (!is.null(self$`analysis_step_version`)) {
        ConfigurationFileObject[["analysis_step_version"]] <-
          self$`analysis_step_version`
      }
      if (!is.null(self$`content_md5sum`)) {
        ConfigurationFileObject[["content_md5sum"]] <-
          self$`content_md5sum`
      }
      if (!is.null(self$`content_type`)) {
        ConfigurationFileObject[["content_type"]] <-
          self$`content_type`
      }
      if (!is.null(self$`dbxrefs`)) {
        ConfigurationFileObject[["dbxrefs"]] <-
          self$`dbxrefs`
      }
      ...
      if (!is.null(self$`file_format_specifications`)) {
        ConfigurationFileObject[["file_format_specifications"]] <-
          self$`file_format_specifications`
      }
      if (!is.null(self$`file_set`)) {
        ConfigurationFileObject[["file_set"]] <-
          self$`file_set`
      }
      if (!is.null(self$`file_size`)) {
        ConfigurationFileObject[["file_size"]] <-
          self$`file_size`
      }
      if (!is.null(self$`md5sum`)) {
        ConfigurationFileObject[["md5sum"]] <-
          self$`md5sum`
      }
      if (!is.null(self$`submitted_file_name`)) {
        ConfigurationFileObject[["submitted_file_name"]] <-
          self$`submitted_file_name`
      }
      if (!is.null(self$`upload_status`)) {
        ConfigurationFileObject[["upload_status"]] <-
          self$`upload_status`
      }
      if (!is.null(self$`validation_error_detail`)) {
        ConfigurationFileObject[["validation_error_detail"]] <-
          self$`validation_error_detail`
      }
      if (!is.null(self$`seqspec_of`)) {
        ConfigurationFileObject[["seqspec_of"]] <-
          self$`seqspec_of`
      }
      if (!is.null(self$`@id`)) {
        ConfigurationFileObject[["@id"]] <-
          self$`@id`
      }
      if (!is.null(self$`@type`)) {
        ConfigurationFileObject[["@type"]] <-
          self$`@type`
      }
      if (!is.null(self$`summary`)) {
        ConfigurationFileObject[["summary"]] <-
          self$`summary`
      }
      if (!is.null(self$`integrated_in`)) {
        ConfigurationFileObject[["integrated_in"]] <-
          self$`integrated_in`
      }
      if (!is.null(self$`input_file_for`)) {
        ConfigurationFileObject[["input_file_for"]] <-
          self$`input_file_for`
      }
      if (!is.null(self$`gene_list_for`)) {
        ConfigurationFileObject[["gene_list_for"]] <-
          self$`gene_list_for`
      }
      if (!is.null(self$`loci_list_for`)) {
        ConfigurationFileObject[["loci_list_for"]] <-
          self$`loci_list_for`
      }
      if (!is.null(self$`href`)) {
        ConfigurationFileObject[["href"]] <-
          self$`href`
      }
      if (!is.null(self$`s3_uri`)) {
        ConfigurationFileObject[["s3_uri"]] <-
          self$`s3_uri`
      }
    ...
    #' @return the instance of ConfigurationFile
    #' @export
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`seqspec_of`)) {
        self$`seqspec_of` <- ApiClient$new()$deserializeObj(this_object$`seqspec_of`, "set[character]", loadNamespace("igvf_client"))
        if (!identical(self$`seqspec_of`, unique(self$`seqspec_of`))) {
          stop("Error! Items in `seqspec_of` are not unique.")
        }
      }
      ...
      jsoncontent <- c(
        ...
        if (!is.null(self$`seqspec_of`)) {
          ...
          '"seqspec_of":
             [%s]
          ',
          paste(unlist(lapply(self$`seqspec_of`, function(x) paste0('"', x, '"'))), collapse = ",")
          )
        },
        if (!is.null(self$`@id`)) {
          sprintf(
    ...
    #'
    #' @description
    #' Validate JSON input with respect to ConfigurationFile and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of ConfigurationFile
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# ConfigurationFile$unlock()
#
## Below is an example to define the print function
# ConfigurationFile$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ConfigurationFile$lock()
