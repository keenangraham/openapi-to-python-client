...
ReferenceFile <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`controlled_access` = NULL, `anvil_url` = NULL, `assembly` = NULL, `release_timestamp` = NULL, `file_format_type` = NULL, `transcriptome_annotation` = NULL, `documents` = NULL, `lab` = NULL, `award` = NULL, `accession` = NULL, `alternate_accessions` = NULL, `collections` = NULL, `status` = NULL, `revoke_detail` = NULL, `schema_version` = NULL, `uuid` = NULL, `notes` = NULL, `aliases` = NULL, `creation_timestamp` = NULL, `submitted_by` = NULL, `submitter_comment` = NULL, `description` = NULL, `analysis_step_version` = NULL, `content_md5sum` = NULL, `content_type` = NULL, `dbxrefs` = NULL, `derived_from` = NULL, `file_format` = NULL, `file_format_specifications` = NULL, `file_set` = NULL, `file_size` = NULL, `md5sum` = NULL, `submitted_file_name` = NULL, `upload_status` = NULL, `validation_error_detail` = NULL, `source_url` = NULL, `sources` = NULL, `external` = NULL, `external_id` = NULL, `@id` = NULL, `@type` = NULL, `summary` = NULL, `integrated_in` = NULL, `input_file_for` = NULL, `gene_list_for` = NULL, `loci_list_for` = NULL, `href` = NULL, `s3_uri` = NULL, `upload_credentials` = NULL, ...) {
      ...
      if (!is.null(`assembly`)) {
        if (!(`assembly` %in% c("GRCh38", "hg19", "GRCm39", "mm10"))) {
          stop(paste("Error! \"", `assembly`, "\" cannot be assigned to `assembly`. Must be \"GRCh38\", \"hg19\", \"GRCm39\", \"mm10\".", sep = ""))
        }
      ...
      if (!is.null(`file_format`)) {
        if (!(`file_format` %in% c("bed", "csv", "dat", "fasta", "gaf", "gds", "gtf", "obo", "owl", "PWM", "tar", "tsv", "txt", "vcf", "xml"))) {
          stop(paste("Error! \"", `file_format`, "\" cannot be assigned to `file_format`. Must be \"bed\", \"csv\", \"dat\", \"fasta\", \"gaf\", \"gds\", \"gtf\", \"obo\", \"owl\", \"PWM\", \"tar\", \"tsv\", \"txt\", \"vcf\", \"xml\".", sep = ""))
        }
    ...
    #' To JSON String
    #'
    #' @return ReferenceFile in JSON format
    #' @export
    toJSON = function() {
      ...
      if (!is.null(self$`anvil_url`)) {
        ReferenceFileObject[["anvil_url"]] <-
          self$`anvil_url`
      }
      if (!is.null(self$`assembly`)) {
        ReferenceFileObject[["assembly"]] <-
          self$`assembly`
      }
      if (!is.null(self$`release_timestamp`)) {
        ReferenceFileObject[["release_timestamp"]] <-
          self$`release_timestamp`
      }
      if (!is.null(self$`file_format_type`)) {
        ReferenceFileObject[["file_format_type"]] <-
          self$`file_format_type`
      }
      if (!is.null(self$`transcriptome_annotation`)) {
        ReferenceFileObject[["transcriptome_annotation"]] <-
          self$`transcriptome_annotation`
      }
      if (!is.null(self$`documents`)) {
        ReferenceFileObject[["documents"]] <-
          self$`documents`
      }
      if (!is.null(self$`lab`)) {
        ReferenceFileObject[["lab"]] <-
          self$`lab`
      }
      if (!is.null(self$`award`)) {
        ReferenceFileObject[["award"]] <-
          self$`award`
      }
      if (!is.null(self$`accession`)) {
        ReferenceFileObject[["accession"]] <-
          self$`accession`
      }
      if (!is.null(self$`alternate_accessions`)) {
        ReferenceFileObject[["alternate_accessions"]] <-
          self$`alternate_accessions`
      }
      if (!is.null(self$`collections`)) {
        ReferenceFileObject[["collections"]] <-
          self$`collections`
      }
      if (!is.null(self$`status`)) {
        ReferenceFileObject[["status"]] <-
          self$`status`
      }
      if (!is.null(self$`revoke_detail`)) {
        ReferenceFileObject[["revoke_detail"]] <-
          self$`revoke_detail`
      }
      if (!is.null(self$`schema_version`)) {
        ReferenceFileObject[["schema_version"]] <-
          self$`schema_version`
      }
      if (!is.null(self$`uuid`)) {
        ReferenceFileObject[["uuid"]] <-
          self$`uuid`
      }
      if (!is.null(self$`notes`)) {
        ReferenceFileObject[["notes"]] <-
          self$`notes`
      }
      if (!is.null(self$`aliases`)) {
        ReferenceFileObject[["aliases"]] <-
          self$`aliases`
      }
      if (!is.null(self$`creation_timestamp`)) {
        ReferenceFileObject[["creation_timestamp"]] <-
          self$`creation_timestamp`
      }
      if (!is.null(self$`submitted_by`)) {
        ReferenceFileObject[["submitted_by"]] <-
          self$`submitted_by`
      }
      if (!is.null(self$`submitter_comment`)) {
        ReferenceFileObject[["submitter_comment"]] <-
          self$`submitter_comment`
      }
      if (!is.null(self$`description`)) {
        ReferenceFileObject[["description"]] <-
          self$`description`
      }
      if (!is.null(self$`analysis_step_version`)) {
        ReferenceFileObject[["analysis_step_version"]] <-
          self$`analysis_step_version`
      }
      if (!is.null(self$`content_md5sum`)) {
        ReferenceFileObject[["content_md5sum"]] <-
          self$`content_md5sum`
      }
      if (!is.null(self$`content_type`)) {
        ReferenceFileObject[["content_type"]] <-
          self$`content_type`
      }
      if (!is.null(self$`dbxrefs`)) {
        ReferenceFileObject[["dbxrefs"]] <-
          self$`dbxrefs`
      }
      if (!is.null(self$`derived_from`)) {
        ReferenceFileObject[["derived_from"]] <-
          self$`derived_from`
      }
      if (!is.null(self$`file_format`)) {
        ReferenceFileObject[["file_format"]] <-
          self$`file_format`
      }
      if (!is.null(self$`file_format_specifications`)) {
        ReferenceFileObject[["file_format_specifications"]] <-
          self$`file_format_specifications`
      }
      if (!is.null(self$`file_set`)) {
        ReferenceFileObject[["file_set"]] <-
          self$`file_set`
      }
      if (!is.null(self$`file_size`)) {
        ReferenceFileObject[["file_size"]] <-
          self$`file_size`
      }
      if (!is.null(self$`md5sum`)) {
        ReferenceFileObject[["md5sum"]] <-
          self$`md5sum`
      }
      if (!is.null(self$`submitted_file_name`)) {
        ReferenceFileObject[["submitted_file_name"]] <-
          self$`submitted_file_name`
      }
      if (!is.null(self$`upload_status`)) {
        ReferenceFileObject[["upload_status"]] <-
          self$`upload_status`
      }
      ...
      if (!is.null(self$`@type`)) {
        ReferenceFileObject[["@type"]] <-
          self$`@type`
      }
      if (!is.null(self$`summary`)) {
        ReferenceFileObject[["summary"]] <-
          self$`summary`
      }
      if (!is.null(self$`integrated_in`)) {
        ReferenceFileObject[["integrated_in"]] <-
          self$`integrated_in`
      }
      if (!is.null(self$`input_file_for`)) {
        ReferenceFileObject[["input_file_for"]] <-
          self$`input_file_for`
      }
      if (!is.null(self$`gene_list_for`)) {
        ReferenceFileObject[["gene_list_for"]] <-
          self$`gene_list_for`
      }
      if (!is.null(self$`loci_list_for`)) {
        ReferenceFileObject[["loci_list_for"]] <-
          self$`loci_list_for`
      }
      if (!is.null(self$`href`)) {
        ReferenceFileObject[["href"]] <-
          self$`href`
      }
      if (!is.null(self$`s3_uri`)) {
        ReferenceFileObject[["s3_uri"]] <-
          self$`s3_uri`
      }
      if (!is.null(self$`upload_credentials`)) {
        ReferenceFileObject[["upload_credentials"]] <-
          self$`upload_credentials`
      }
      ReferenceFileObject
    },
    #' Deserialize JSON string into an instance of ReferenceFile
    #'
    #' @description
    #' Deserialize JSON string into an instance of ReferenceFile
    #'
    #' @param input_json the JSON input
    #' @return the instance of ReferenceFile
    #' @export
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`assembly`)) {
        if (!is.null(this_object$`assembly`) && !(this_object$`assembly` %in% c("GRCh38", "hg19", "GRCm39", "mm10"))) {
          stop(paste("Error! \"", this_object$`assembly`, "\" cannot be assigned to `assembly`. Must be \"GRCh38\", \"hg19\", \"GRCm39\", \"mm10\".", sep = ""))
        }
      ...
      if (!is.null(this_object$`file_format`)) {
        if (!is.null(this_object$`file_format`) && !(this_object$`file_format` %in% c("bed", "csv", "dat", "fasta", "gaf", "gds", "gtf", "obo", "owl", "PWM", "tar", "tsv", "txt", "vcf", "xml"))) {
          stop(paste("Error! \"", this_object$`file_format`, "\" cannot be assigned to `file_format`. Must be \"bed\", \"csv\", \"dat\", \"fasta\", \"gaf\", \"gds\", \"gtf\", \"obo\", \"owl\", \"PWM\", \"tar\", \"tsv\", \"txt\", \"vcf\", \"xml\".", sep = ""))
        }
    ...
    #' Validate JSON input with respect to ReferenceFile
    #'
    #' @description
    #' Validate JSON input with respect to ReferenceFile and throw an exception if invalid
    #'
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of ReferenceFile
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# ReferenceFile$unlock()
#
## Below is an example to define the print function
# ReferenceFile$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
