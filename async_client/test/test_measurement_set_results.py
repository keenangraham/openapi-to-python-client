...
class TestMeasurementSetResults(unittest.TestCase):
    """MeasurementSetResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MeasurementSetResults:
        """Test MeasurementSetResults
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MeasurementSetResults`
        """
        model = MeasurementSetResults()
        if include_optional:
            return MeasurementSetResults(
                graph = [
                    async_igvf_client.models.measurement_set.Measurement Set(
    ...
    def testMeasurementSetResults(self):
        """Test MeasurementSetResults"""
