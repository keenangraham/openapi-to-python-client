...
class TestSoftwareResults(unittest.TestCase):
    """SoftwareResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SoftwareResults:
        """Test SoftwareResults
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SoftwareResults`
        """
        model = SoftwareResults()
        if include_optional:
            return SoftwareResults(
                graph = [
                    async_igvf_client.models.software.Software(
