...
class TestMultiplexedSampleResults(unittest.TestCase):
    """MultiplexedSampleResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MultiplexedSampleResults:
        """Test MultiplexedSampleResults
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MultiplexedSampleResults`
        """
        model = MultiplexedSampleResults()
        if include_optional:
            return MultiplexedSampleResults(
                graph = [
                    async_igvf_client.models.multiplexed_sample.Multiplexed Sample(
    ...
    def testMultiplexedSampleResults(self):
        """Test MultiplexedSampleResults"""
