...
class TestInVitroSystemResults(unittest.TestCase):
    """InVitroSystemResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InVitroSystemResults:
        """Test InVitroSystemResults
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InVitroSystemResults`
        """
        model = InVitroSystemResults()
        if include_optional:
            return InVitroSystemResults(
                graph = [
                    async_igvf_client.models.in_vitro_system.In Vitro System(
    ...
    def testInVitroSystemResults(self):
        """Test InVitroSystemResults"""
