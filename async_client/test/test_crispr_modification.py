...
class TestCrisprModification(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CrisprModification:
        """Test CrisprModification
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CrisprModification`
        """
        model = CrisprModification()
        if include_optional:
    ...
    def testCrisprModification(self):
        """Test CrisprModification"""
