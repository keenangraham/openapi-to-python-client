...
class TestAnalysisStepVersionResults(unittest.TestCase):
    """AnalysisStepVersionResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnalysisStepVersionResults:
        """Test AnalysisStepVersionResults
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnalysisStepVersionResults`
        """
        model = AnalysisStepVersionResults()
        if include_optional:
            return AnalysisStepVersionResults(
                graph = [
                    async_igvf_client.models.analysis_step_version.Analysis Step Version(
    ...
    def testAnalysisStepVersionResults(self):
        """Test AnalysisStepVersionResults"""
