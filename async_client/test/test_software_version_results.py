...
class TestSoftwareVersionResults(unittest.TestCase):
    """SoftwareVersionResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SoftwareVersionResults:
        """Test SoftwareVersionResults
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SoftwareVersionResults`
        """
        model = SoftwareVersionResults()
        if include_optional:
            return SoftwareVersionResults(
                graph = [
                    async_igvf_client.models.software_version.Software Version(
    ...
    def testSoftwareVersionResults(self):
        """Test SoftwareVersionResults"""
