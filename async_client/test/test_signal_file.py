...
class TestSignalFile(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SignalFile:
        """Test SignalFile
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SignalFile`
        """
        model = SignalFile()
        if include_optional:
            return SignalFile(
