...
class TestPageResults(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PageResults:
        """Test PageResults
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PageResults`
        """
        model = PageResults()
        if include_optional:
            return PageResults(
                graph = [
                    async_igvf_client.models.page.Page(
