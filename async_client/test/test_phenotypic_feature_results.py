...
class TestPhenotypicFeatureResults(unittest.TestCase):
    """PhenotypicFeatureResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PhenotypicFeatureResults:
        """Test PhenotypicFeatureResults
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PhenotypicFeatureResults`
        """
        model = PhenotypicFeatureResults()
        if include_optional:
            return PhenotypicFeatureResults(
                graph = [
                    async_igvf_client.models.phenotypic_feature.Phenotypic Feature(
                        ...
                        observation_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), 
                        @id = '', 
                        @type = [
                            ''
                            ], 
    ...
    def testPhenotypicFeatureResults(self):
        """Test PhenotypicFeatureResults"""
