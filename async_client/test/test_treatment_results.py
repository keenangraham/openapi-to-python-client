...
class TestTreatmentResults(unittest.TestCase):
    """TreatmentResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TreatmentResults:
        """Test TreatmentResults
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TreatmentResults`
        """
        model = TreatmentResults()
        if include_optional:
            return TreatmentResults(
                graph = [
                    async_igvf_client.models.treatment.Treatment(
