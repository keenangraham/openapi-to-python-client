...
class TestSampleTermResults(unittest.TestCase):
    """SampleTermResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SampleTermResults:
        """Test SampleTermResults
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SampleTermResults`
        """
        model = SampleTermResults()
        if include_optional:
            return SampleTermResults(
                graph = [
                    async_igvf_client.models.sample_term.Sample Term(
    ...
    def testSampleTermResults(self):
        """Test SampleTermResults"""
