...
class TestSignalFileResults(unittest.TestCase):
    """SignalFileResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SignalFileResults:
        """Test SignalFileResults
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SignalFileResults`
        """
        model = SignalFileResults()
        if include_optional:
            return SignalFileResults(
                graph = [
                    async_igvf_client.models.signal_file.Signal File(
    ...
    def testSignalFileResults(self):
        """Test SignalFileResults"""
