...
class TestImageResults(unittest.TestCase):
    """ImageResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ImageResults:
        """Test ImageResults
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ImageResults`
        """
        model = ImageResults()
        if include_optional:
            return ImageResults(
                graph = [
                    async_igvf_client.models.image.Image(
