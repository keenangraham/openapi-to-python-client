...
class TestTissueResults(unittest.TestCase):
    """TissueResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TissueResults:
        """Test TissueResults
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TissueResults`
        """
        model = TissueResults()
        if include_optional:
            return TissueResults(
                graph = [
                    async_igvf_client.models.tissue.Tissue(
