...
class TestWorkflowResults(unittest.TestCase):
    """WorkflowResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkflowResults:
        """Test WorkflowResults
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkflowResults`
        """
        model = WorkflowResults()
        if include_optional:
            return WorkflowResults(
                graph = [
                    async_igvf_client.models.workflow.Workflow(
