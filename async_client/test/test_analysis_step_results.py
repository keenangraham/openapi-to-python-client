...
class TestAnalysisStepResults(unittest.TestCase):
    """AnalysisStepResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnalysisStepResults:
        """Test AnalysisStepResults
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnalysisStepResults`
        """
        model = AnalysisStepResults()
        if include_optional:
            return AnalysisStepResults(
                graph = [
                    async_igvf_client.models.analysis_step.Analysis Step(
    ...
    def testAnalysisStepResults(self):
        """Test AnalysisStepResults"""
