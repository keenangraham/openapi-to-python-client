...
class TestSourceResults(unittest.TestCase):
    """SourceResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SourceResults:
        """Test SourceResults
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SourceResults`
        """
        model = SourceResults()
        if include_optional:
            return SourceResults(
                graph = [
                    async_igvf_client.models.source.Source(
