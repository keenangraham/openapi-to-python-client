...
class TestImageFileResults(unittest.TestCase):
    """ImageFileResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ImageFileResults:
        """Test ImageFileResults
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ImageFileResults`
        """
        model = ImageFileResults()
        if include_optional:
            return ImageFileResults(
                graph = [
                    async_igvf_client.models.image_file.Image File(
