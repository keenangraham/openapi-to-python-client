...
class TestModelSetResults(unittest.TestCase):
    """ModelSetResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ModelSetResults:
        """Test ModelSetResults
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ModelSetResults`
        """
        model = ModelSetResults()
        if include_optional:
            return ModelSetResults(
                graph = [
                    async_igvf_client.models.model_set.Model Set(
                        input_file_sets = [
                            ''
                            ], 
