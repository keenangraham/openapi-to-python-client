...
class TestOpenReadingFrameResults(unittest.TestCase):
    """OpenReadingFrameResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OpenReadingFrameResults:
        """Test OpenReadingFrameResults
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OpenReadingFrameResults`
        """
        model = OpenReadingFrameResults()
        if include_optional:
            return OpenReadingFrameResults(
                graph = [
                    async_igvf_client.models.open_reading_frame.Open Reading Frame(
    ...
    def testOpenReadingFrameResults(self):
        """Test OpenReadingFrameResults"""
