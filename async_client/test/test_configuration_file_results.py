...
class TestConfigurationFileResults(unittest.TestCase):
    """ConfigurationFileResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConfigurationFileResults:
        """Test ConfigurationFileResults
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConfigurationFileResults`
        """
        model = ConfigurationFileResults()
        if include_optional:
            return ConfigurationFileResults(
                graph = [
                    async_igvf_client.models.configuration_file.Configuration File(
    ...
    def testConfigurationFileResults(self):
        """Test ConfigurationFileResults"""
