...
class TestModelFileResults(unittest.TestCase):
    """ModelFileResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ModelFileResults:
        """Test ModelFileResults
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ModelFileResults`
        """
        model = ModelFileResults()
        if include_optional:
            return ModelFileResults(
                graph = [
                    async_igvf_client.models.model_file.Model File(
