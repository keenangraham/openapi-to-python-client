...
class TestAuxiliarySetResults(unittest.TestCase):
    """AuxiliarySetResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuxiliarySetResults:
        """Test AuxiliarySetResults
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuxiliarySetResults`
        """
        model = AuxiliarySetResults()
        if include_optional:
            return AuxiliarySetResults(
                graph = [
                    async_igvf_client.models.auxiliary_set.Auxiliary Set(
    ...
    def testAuxiliarySetResults(self):
        """Test AuxiliarySetResults"""
