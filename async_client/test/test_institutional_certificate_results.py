...
class TestInstitutionalCertificateResults(unittest.TestCase):
    """InstitutionalCertificateResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InstitutionalCertificateResults:
        """Test InstitutionalCertificateResults
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InstitutionalCertificateResults`
        """
        model = InstitutionalCertificateResults()
        if include_optional:
            return InstitutionalCertificateResults(
                graph = [
                    async_igvf_client.models.institutional_certificate.Institutional Certificate(
    ...
    def testInstitutionalCertificateResults(self):
        """Test InstitutionalCertificateResults"""
