...
class TestGenomeBrowserAnnotationFileResults(unittest.TestCase):
    """GenomeBrowserAnnotationFileResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GenomeBrowserAnnotationFileResults:
        """Test GenomeBrowserAnnotationFileResults
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GenomeBrowserAnnotationFileResults`
        """
        model = GenomeBrowserAnnotationFileResults()
        if include_optional:
            return GenomeBrowserAnnotationFileResults(
                graph = [
                    async_igvf_client.models.genome_browser_annotation_file.Genome Browser Annotation File(
                        assembly = 'GRCh38', 
                        ...
                        href = '', 
                        s3_uri = '', 
                        upload_credentials = async_igvf_client.models.upload_credentials.Upload Credentials(), )
                    ],
                id = '',
                type = [
                    ''
                ...
                total = 56,
                facets = [
                    async_igvf_client.models.search_facet.SearchFacet(
                        field = '', 
                        title = '', 
                        terms = [
                            async_igvf_client.models.search_facet_term_value.SearchFacetTermValue()
                            ], )
                    ]
            )
        else:
    ...
    def testGenomeBrowserAnnotationFileResults(self):
        """Test GenomeBrowserAnnotationFileResults"""
