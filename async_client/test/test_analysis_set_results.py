...
class TestAnalysisSetResults(unittest.TestCase):
    """AnalysisSetResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnalysisSetResults:
        """Test AnalysisSetResults
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnalysisSetResults`
        """
        model = AnalysisSetResults()
        if include_optional:
            return AnalysisSetResults(
                graph = [
                    async_igvf_client.models.analysis_set.Analysis Set(
                        input_file_sets = [
                            ''
                            ], 
    ...
    def testAnalysisSetResults(self):
        """Test AnalysisSetResults"""
