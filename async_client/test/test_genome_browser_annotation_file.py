...
class TestGenomeBrowserAnnotationFile(unittest.TestCase):
    """GenomeBrowserAnnotationFile unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GenomeBrowserAnnotationFile:
        """Test GenomeBrowserAnnotationFile
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GenomeBrowserAnnotationFile`
        """
        model = GenomeBrowserAnnotationFile()
        if include_optional:
            return GenomeBrowserAnnotationFile(
                assembly = 'GRCh38',
    ...
    def testGenomeBrowserAnnotationFile(self):
        """Test GenomeBrowserAnnotationFile"""
