...
class TestRodentDonorResults(unittest.TestCase):
    """RodentDonorResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RodentDonorResults:
        """Test RodentDonorResults
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RodentDonorResults`
        """
        model = RodentDonorResults()
        if include_optional:
            return RodentDonorResults(
                graph = [
                    async_igvf_client.models.rodent_donor.Rodent Donor(
    ...
    def testRodentDonorResults(self):
        """Test RodentDonorResults"""
