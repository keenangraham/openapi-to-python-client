...
class TestPlatformTermResults(unittest.TestCase):
    """PlatformTermResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PlatformTermResults:
        """Test PlatformTermResults
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PlatformTermResults`
        """
        model = PlatformTermResults()
        if include_optional:
            return PlatformTermResults(
                graph = [
                    async_igvf_client.models.platform_term.Platform Term(
    ...
    def testPlatformTermResults(self):
        """Test PlatformTermResults"""
