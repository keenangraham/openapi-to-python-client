...
class TestTechnicalSampleResults(unittest.TestCase):
    """TechnicalSampleResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TechnicalSampleResults:
        """Test TechnicalSampleResults
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TechnicalSampleResults`
        """
        model = TechnicalSampleResults()
        if include_optional:
            return TechnicalSampleResults(
                graph = [
                    async_igvf_client.models.technical_sample.Technical Sample(
    ...
    def testTechnicalSampleResults(self):
        """Test TechnicalSampleResults"""
