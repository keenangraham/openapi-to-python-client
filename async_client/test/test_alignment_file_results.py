...
class TestAlignmentFileResults(unittest.TestCase):
    """AlignmentFileResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AlignmentFileResults:
        """Test AlignmentFileResults
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AlignmentFileResults`
        """
        model = AlignmentFileResults()
        if include_optional:
            return AlignmentFileResults(
                graph = [
                    async_igvf_client.models.alignment_file.Alignment File(
    ...
    def testAlignmentFileResults(self):
        """Test AlignmentFileResults"""
