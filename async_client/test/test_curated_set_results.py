...
class TestCuratedSetResults(unittest.TestCase):
    """CuratedSetResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CuratedSetResults:
        """Test CuratedSetResults
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CuratedSetResults`
        """
        model = CuratedSetResults()
        if include_optional:
            return CuratedSetResults(
                graph = [
                    async_igvf_client.models.curated_set.Curated Set(
    ...
    def testCuratedSetResults(self):
        """Test CuratedSetResults"""
