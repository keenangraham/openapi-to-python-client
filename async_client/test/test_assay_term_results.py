...
class TestAssayTermResults(unittest.TestCase):
    """AssayTermResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AssayTermResults:
        """Test AssayTermResults
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AssayTermResults`
        """
        model = AssayTermResults()
        if include_optional:
            return AssayTermResults(
                graph = [
                    async_igvf_client.models.assay_term.Assay Term(
