...
class TestPhenotypeTermResults(unittest.TestCase):
    """PhenotypeTermResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PhenotypeTermResults:
        """Test PhenotypeTermResults
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PhenotypeTermResults`
        """
        model = PhenotypeTermResults()
        if include_optional:
            return PhenotypeTermResults(
                graph = [
                    async_igvf_client.models.phenotype_term.Phenotype Term(
    ...
    def testPhenotypeTermResults(self):
        """Test PhenotypeTermResults"""
