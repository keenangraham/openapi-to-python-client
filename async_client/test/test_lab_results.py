...
class TestLabResults(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> LabResults:
        """Test LabResults
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LabResults`
        """
        model = LabResults()
        if include_optional:
            return LabResults(
                graph = [
                    async_igvf_client.models.lab.Lab(
                        status = 'current', 
                        url = '', 
                        schema_version = '3', 
                        uuid = '', 
