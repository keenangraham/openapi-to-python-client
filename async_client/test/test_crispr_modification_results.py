...
class TestCrisprModificationResults(unittest.TestCase):
    """CrisprModificationResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CrisprModificationResults:
        """Test CrisprModificationResults
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CrisprModificationResults`
        """
        model = CrisprModificationResults()
        if include_optional:
            return CrisprModificationResults(
                graph = [
                    async_igvf_client.models.crispr_modification.CRISPR Modification(
    ...
    def testCrisprModificationResults(self):
        """Test CrisprModificationResults"""
