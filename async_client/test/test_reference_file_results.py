...
class TestReferenceFileResults(unittest.TestCase):
    """ReferenceFileResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReferenceFileResults:
        """Test ReferenceFileResults
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReferenceFileResults`
        """
        model = ReferenceFileResults()
        if include_optional:
            return ReferenceFileResults(
                graph = [
                    async_igvf_client.models.reference_file.Reference File(
    ...
    def testReferenceFileResults(self):
        """Test ReferenceFileResults"""
