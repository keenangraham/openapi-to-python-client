    ...
    def make_instance(self, include_optional) -> Item:
        ...
        if include_optional:
            return Item(
                ...
                attachment = async_igvf_client.models.attachment.Attachment(
                    download = '', 
                    href = '', 
                ...
                virtual = True,
                related_donors = [
                    async_igvf_client.models.related_donor.Related Donor(
                        donor = '', 
                ...
                small_scale_loci_list = [
                    async_igvf_client.models.locus.Locus(
                        assembly = 'GRCh38', 
                        chromosome = 'chrH', 
                        start = 1, 
                        end = 1, )
                ...
                exon = 'k',
                tile = async_igvf_client.models.tile.Tile(
                    tile_id = 'k', 
                    tile_start = 1, 
                    tile_end = 1, ),
                guide_type = 'sgRNA',
                ...
                symbol = '',
                locations = [
                    async_igvf_client.models.gene_location.Gene Location(
                        assembly = 'GRCh38', 
                        chromosome = 'chrC', 
                        start = 0, 
                        end = 0, )
                ...
                pct_coverage_orf = 0,
                parent = '',
                layout = async_igvf_client.models.page_layout.Page Layout(
                    blocks = [
                        async_igvf_client.models.page_layout_components.Page Layout Components(
                            @id = '', 
                            @type = '', 
                            body = '', 
                            direction = '', )
                ...
                date_revised = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(),
                issue = '',
                page = '',
                volume = '',
                journal = '',
