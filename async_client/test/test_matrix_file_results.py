...
class TestMatrixFileResults(unittest.TestCase):
    """MatrixFileResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatrixFileResults:
        """Test MatrixFileResults
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatrixFileResults`
        """
        model = MatrixFileResults()
        if include_optional:
            return MatrixFileResults(
                graph = [
                    async_igvf_client.models.matrix_file.Matrix File(
    ...
    def testMatrixFileResults(self):
        """Test MatrixFileResults"""
