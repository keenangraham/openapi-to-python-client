...
class TestWholeOrganismResults(unittest.TestCase):
    """WholeOrganismResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WholeOrganismResults:
        """Test WholeOrganismResults
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WholeOrganismResults`
        """
        model = WholeOrganismResults()
        if include_optional:
            return WholeOrganismResults(
                graph = [
                    async_igvf_client.models.whole_organism.Whole Organism(
    ...
    def testWholeOrganismResults(self):
        """Test WholeOrganismResults"""
