...
class TestPrimaryCellResults(unittest.TestCase):
    """PrimaryCellResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PrimaryCellResults:
        """Test PrimaryCellResults
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrimaryCellResults`
        """
        model = PrimaryCellResults()
        if include_optional:
            return PrimaryCellResults(
                graph = [
                    async_igvf_client.models.primary_cell.Primary Cell(
    ...
    def testPrimaryCellResults(self):
        """Test PrimaryCellResults"""
