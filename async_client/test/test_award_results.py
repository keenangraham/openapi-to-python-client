...
class TestAwardResults(unittest.TestCase):
    """AwardResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AwardResults:
        """Test AwardResults
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AwardResults`
        """
        model = AwardResults()
        if include_optional:
            return AwardResults(
                graph = [
                    async_igvf_client.models.grant.Grant(
                        status = 'current', 
                        url = '', 
                        schema_version = '5', 
                        uuid = '', 
