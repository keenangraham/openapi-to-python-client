...
class TestBiomarkerResults(unittest.TestCase):
    """BiomarkerResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BiomarkerResults:
        """Test BiomarkerResults
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BiomarkerResults`
        """
        model = BiomarkerResults()
        if include_optional:
            return BiomarkerResults(
                graph = [
                    async_igvf_client.models.biomarker.Biomarker(
