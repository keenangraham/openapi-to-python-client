...
class TestTabularFileResults(unittest.TestCase):
    """TabularFileResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TabularFileResults:
        """Test TabularFileResults
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TabularFileResults`
        """
        model = TabularFileResults()
        if include_optional:
            return TabularFileResults(
                graph = [
                    async_igvf_client.models.tabular_file.Tabular File(
    ...
    def testTabularFileResults(self):
        """Test TabularFileResults"""
