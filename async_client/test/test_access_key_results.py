...
class TestAccessKeyResults(unittest.TestCase):
    """AccessKeyResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AccessKeyResults:
        """Test AccessKeyResults
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AccessKeyResults`
        """
        model = AccessKeyResults()
        if include_optional:
            return AccessKeyResults(
                graph = [
                    async_igvf_client.models.access_key.Access Key(
                        schema_version = '2', 
                        uuid = '', 
                        notes = 'k', 
                        aliases = [
