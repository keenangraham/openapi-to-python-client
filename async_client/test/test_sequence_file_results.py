...
class TestSequenceFileResults(unittest.TestCase):
    """SequenceFileResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SequenceFileResults:
        """Test SequenceFileResults
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SequenceFileResults`
        """
        model = SequenceFileResults()
        if include_optional:
            return SequenceFileResults(
                graph = [
                    async_igvf_client.models.sequence_file.Sequence File(
    ...
    def testSequenceFileResults(self):
        """Test SequenceFileResults"""
