...
class TestDegronModificationResults(unittest.TestCase):
    """DegronModificationResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DegronModificationResults:
        """Test DegronModificationResults
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DegronModificationResults`
        """
        model = DegronModificationResults()
        if include_optional:
            return DegronModificationResults(
                graph = [
                    async_igvf_client.models.degron_modification.Degron Modification(
    ...
    def testDegronModificationResults(self):
        """Test DegronModificationResults"""
