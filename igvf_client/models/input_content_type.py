...
class InputContentType(BaseModel):
    ...
    # data type: InputContentTypeAnyOf
    anyof_schema_4_validator: Optional[InputContentTypeAnyOf] = None
    # data type: str
    anyof_schema_5_validator: Optional[StrictStr] = None
    # data type: str
    anyof_schema_6_validator: Optional[StrictStr] = None
    if TYPE_CHECKING:
        actual_instance: Optional[Union[InputContentTypeAnyOf, str]] = None
    else:
        actual_instance: Any = None
    any_of_schemas: Set[str] = { "InputContentTypeAnyOf", "str" }
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        try:
            ...
            error_messages.append(str(e))
        # validate data type: InputContentTypeAnyOf
        if not isinstance(v, InputContentTypeAnyOf):
            error_messages.append(f"Error! Input type `{type(v)}` is not `InputContentTypeAnyOf`")
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # anyof_schema_4_validator: Optional[InputContentTypeAnyOf] = None
        try:
            instance.actual_instance = InputContentTypeAnyOf.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # deserialize data into str
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], InputContentTypeAnyOf, str]]:
