...
class NoResultsResponseSortValue(BaseModel):
    """
    NoResultsResponseSortValue
    """ # noqa: E501
    order: Optional[StrictStr] = None
    unmapped_type: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["order", "unmapped_type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "order": obj.get("order"),
            "unmapped_type": obj.get("unmapped_type")
        })
        return _obj
