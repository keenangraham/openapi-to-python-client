...
class NoResultsResponseFacetGroupsInner(BaseModel):
    """
    NoResultsResponseFacetGroupsInner
    """ # noqa: E501
    name: Optional[StrictStr] = None
    title: Optional[StrictStr] = None
    facet_fields: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["name", "title", "facet_fields"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "title": obj.get("title"),
            "facet_fields": obj.get("facet_fields")
        })
        return _obj
