...
class TissuesApi:
    ...
    def tissues(
        ...
        pmi: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="Filter by pmi")] = None,
        pmi_units: Annotated[Optional[StrictStr], Field(description="Filter by pmi_units")] = None,
        ccf_id: Annotated[Optional[StrictStr], Field(description="Filter by ccf_id")] = None,
