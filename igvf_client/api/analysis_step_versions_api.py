...
class AnalysisStepVersionsApi:
    ...
    def analysis_step_versions(
        ...
        analysis_step: Annotated[Optional[StrictStr], Field(description="Filter by analysis_step")] = None,
        ...
        :param analysis_step: Filter by analysis_step
    ...
    def _analysis_step_versions_serialize(
        ...
        if analysis_step is not None:
            ...
            _query_params.append(('analysis_step', analysis_step))
