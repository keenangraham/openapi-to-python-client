...
class AccessKeysApi:
    ...
    def access_keys(
        ...
        user: Annotated[Optional[StrictStr], Field(description="Filter by user")] = None,
        access_key_id: Annotated[Optional[StrictStr], Field(description="Filter by access_key_id")] = None,
        secret_access_key_hash: Annotated[Optional[StrictStr], Field(description="Filter by secret_access_key_hash")] = None,
        ...
        :type secret_access_key_hash: str
