...
class PagesApi:
    ...
    def pages(
        ...
        layout: Annotated[Optional[Dict[str, Any]], Field(description="Filter by layout")] = None,
        ...
        canonical_uri: Annotated[Optional[StrictStr], Field(description="Filter by canonical_uri")] = None,
