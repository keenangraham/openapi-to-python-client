...
class MeasurementSetsApi:
    ...
    def measurement_sets(
        ...
        assay_term: Annotated[Optional[StrictStr], Field(description="Filter by assay_term")] = None,
        ...
        preferred_assay_title: Annotated[Optional[StrictStr], Field(description="Filter by preferred_assay_title")] = None,
        multiome_size: Annotated[Optional[Annotated[int, Field(strict=True, ge=2)]], Field(description="Filter by multiome_size")] = None,
        control_file_sets: Annotated[Optional[List[StrictStr]], Field(description="Filter by control_file_sets")] = None,
        sequencing_library_types: Annotated[Optional[List[StrictStr]], Field(description="Filter by sequencing_library_types")] = None,
        auxiliary_sets: Annotated[Optional[List[StrictStr]], Field(description="Filter by auxiliary_sets")] = None,
        ...
        :param assay_term: Filter by assay_term
        :type assay_term: str
        :param library_construction_platform: Filter by library_construction_platform
        :type library_construction_platform: str
        :param protocols: Filter by protocols
        :type protocols: List[str]
        :param preferred_assay_title: Filter by preferred_assay_title
        :type preferred_assay_title: str
        :param multiome_size: Filter by multiome_size
        :type multiome_size: int
        :param control_file_sets: Filter by control_file_sets
        :type control_file_sets: List[str]
        :param sequencing_library_types: Filter by sequencing_library_types
        :type sequencing_library_types: List[str]
        :param auxiliary_sets: Filter by auxiliary_sets
        :type auxiliary_sets: List[str]
        :param external_image_url: Filter by external_image_url
        :type external_image_url: str
        :param targeted_genes: Filter by targeted_genes
        :type targeted_genes: List[str]
        ...
        _param = self._measurement_sets_serialize(
            ...
            control_file_sets=control_file_sets,
    ...
    def _measurement_sets_serialize(
        ...
        _collection_formats: Dict[str, str] = {
            ...
            'donors': 'multi',
            'protocols': 'multi',
            'control_file_sets': 'multi',
            'sequencing_library_types': 'multi',
            'auxiliary_sets': 'multi',
            'targeted_genes': 'multi',
            'files': 'multi',
            'control_for': 'multi',
            'input_file_set_for': 'multi',
            'related_multiome_datasets': 'multi',
        }
        ...
        if assay_term is not None:
            
            _query_params.append(('assay_term', assay_term))
        ...
        if control_file_sets is not None:
            
            _query_params.append(('control_file_sets', control_file_sets))
            
        if sequencing_library_types is not None:
            
            _query_params.append(('sequencing_library_types', sequencing_library_types))
            
        if auxiliary_sets is not None:
            
            _query_params.append(('auxiliary_sets', auxiliary_sets))
            
        if external_image_url is not None:
            
            _query_params.append(('external_image_url', external_image_url))
            
        if targeted_genes is not None:
            
            _query_params.append(('targeted_genes', targeted_genes))
        ...
        if related_multiome_datasets is not None:
            
            _query_params.append(('related_multiome_datasets', related_multiome_datasets))
