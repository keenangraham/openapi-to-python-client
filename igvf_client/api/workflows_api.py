...
class WorkflowsApi:
    ...
    def workflows(
        ...
        source_url: Annotated[Optional[Annotated[str, Field(strict=True)]], Field(description="Filter by source_url")] = None,
        workflow_repositories: Annotated[Optional[List[StrictStr]], Field(description="Filter by workflow_repositories")] = None,
        standards_page: Annotated[Optional[StrictStr], Field(description="Filter by standards_page")] = None,
        ...
        :param standards_page: Filter by standards_page
        :type standards_page: str
    ...
    def _workflows_serialize(
        ...
        if standards_page is not None:
            
            _query_params.append(('standards_page', standards_page))
