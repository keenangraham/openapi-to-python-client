...
class ModelSetsApi:
    ...
    def model_sets(
        ...
        model_name: Annotated[Optional[StrictStr], Field(description="Filter by model_name")] = None,
        model_version: Annotated[Optional[Annotated[str, Field(strict=True)]], Field(description="Filter by model_version")] = None,
