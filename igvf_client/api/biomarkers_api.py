...
class BiomarkersApi:
    ...
    def biomarkers(
        ...
        classification: Annotated[Optional[StrictStr], Field(description="Filter by classification")] = None,
        quantification: Annotated[Optional[StrictStr], Field(description="Filter by quantification")] = None,
        synonyms: Annotated[Optional[List[StrictStr]], Field(description="Filter by synonyms")] = None,
        gene: Annotated[Optional[StrictStr], Field(description="Filter by gene")] = None,
