...
class ReferenceFilesApi:
    ...
    def reference_files(
        ...
        source_url: Annotated[Optional[StrictStr], Field(description="Filter by source_url")] = None,
        sources: Annotated[Optional[List[StrictStr]], Field(description="Filter by sources")] = None,
        external: Annotated[Optional[StrictBool], Field(description="Filter by external")] = None,
