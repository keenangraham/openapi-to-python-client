...
class SignalFilesApi:
    ...
    def signal_files(
        ...
        strand_specificity: Annotated[Optional[StrictStr], Field(description="Filter by strand_specificity")] = None,
        filtered: Annotated[Optional[StrictBool], Field(description="Filter by filtered")] = None,
        normalized: Annotated[Optional[StrictBool], Field(description="Filter by normalized")] = None,
        ...
        content_summary: Annotated[Optional[StrictStr], Field(description="Filter by content_summary")] = None,
