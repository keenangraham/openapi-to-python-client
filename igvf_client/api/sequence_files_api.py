...
class SequenceFilesApi:
    ...
    def sequence_files(
        ...
        flowcell_id: Annotated[Optional[Annotated[str, Field(strict=True)]], Field(description="Filter by flowcell_id")] = None,
        lane: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="Filter by lane")] = None,
        read_count: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Filter by read_count")] = None,
        minimum_read_length: Annotated[Optional[Annotated[int, Field(le=300000000, strict=True, ge=0)]], Field(description="Filter by minimum_read_length")] = None,
        maximum_read_length: Annotated[Optional[Annotated[int, Field(le=300000000, strict=True, ge=0)]], Field(description="Filter by maximum_read_length")] = None,
        mean_read_length: Annotated[Optional[Union[Annotated[float, Field(le=300000000, strict=True, ge=0)], Annotated[int, Field(le=300000000, strict=True, ge=0)]]], Field(description="Filter by mean_read_length")] = None,
        sequencing_platform: Annotated[Optional[StrictStr], Field(description="Filter by sequencing_platform")] = None,
        sequencing_kit: Annotated[Optional[StrictStr], Field(description="Filter by sequencing_kit")] = None,
        sequencing_run: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="Filter by sequencing_run")] = None,
        illumina_read_type: Annotated[Optional[StrictStr], Field(description="Filter by illumina_read_type")] = None,
