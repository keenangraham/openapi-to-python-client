...
class TestLINKTO32(unittest.TestCase):
    """LINKTO32 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LINKTO32:
        """Test LINKTO32
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LINKTO32`
        """
        model = LINKTO32()
        if include_optional:
            return LINKTO32(
