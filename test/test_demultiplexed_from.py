...
class TestDemultiplexedFrom(unittest.TestCase):
    """DemultiplexedFrom unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DemultiplexedFrom:
        """Test DemultiplexedFrom
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DemultiplexedFrom`
        """
        model = DemultiplexedFrom()
        if include_optional:
            return DemultiplexedFrom(
    ...
    def testDemultiplexedFrom(self):
        """Test DemultiplexedFrom"""
