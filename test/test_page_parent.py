...
class TestPageParent(unittest.TestCase):
    """PageParent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PageParent:
        """Test PageParent
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PageParent`
        """
        model = PageParent()
        if include_optional:
            return PageParent(
