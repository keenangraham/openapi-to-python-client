...
class TestLINKTO2(unittest.TestCase):
    """LINKTO2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LINKTO2:
        """Test LINKTO2
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LINKTO2`
        """
        model = LINKTO2()
        if include_optional:
            return LINKTO2(
