...
class TestSequenceFileSequencingPlatform(unittest.TestCase):
    """SequenceFileSequencingPlatform unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SequenceFileSequencingPlatform:
        """Test SequenceFileSequencingPlatform
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SequenceFileSequencingPlatform`
        """
        model = SequenceFileSequencingPlatform()
        if include_optional:
            return SequenceFileSequencingPlatform(
    ...
    def testSequenceFileSequencingPlatform(self):
        """Test SequenceFileSequencingPlatform"""
