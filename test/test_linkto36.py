...
class TestLINKTO36(unittest.TestCase):
    """LINKTO36 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LINKTO36:
        """Test LINKTO36
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LINKTO36`
        """
        model = LINKTO36()
        if include_optional:
            return LINKTO36(
