...
class TestInVitroSystemBiomarkersInner(unittest.TestCase):
    """InVitroSystemBiomarkersInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InVitroSystemBiomarkersInner:
        """Test InVitroSystemBiomarkersInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InVitroSystemBiomarkersInner`
        """
        model = InVitroSystemBiomarkersInner()
        if include_optional:
            return InVitroSystemBiomarkersInner(
    ...
    def testInVitroSystemBiomarkersInner(self):
        """Test InVitroSystemBiomarkersInner"""
