...
class TestAlignmentFileFileSet(unittest.TestCase):
    """AlignmentFileFileSet unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AlignmentFileFileSet:
        """Test AlignmentFileFileSet
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AlignmentFileFileSet`
        """
        model = AlignmentFileFileSet()
        if include_optional:
            return AlignmentFileFileSet(
    ...
    def testAlignmentFileFileSet(self):
        """Test AlignmentFileFileSet"""
