...
class TestTaggedProtein(unittest.TestCase):
    """TaggedProtein unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TaggedProtein:
        """Test TaggedProtein
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TaggedProtein`
        """
        model = TaggedProtein()
        if include_optional:
            return TaggedProtein(
