...
class TestInVitroSystemPooledFromInner(unittest.TestCase):
    """InVitroSystemPooledFromInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InVitroSystemPooledFromInner:
        """Test InVitroSystemPooledFromInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InVitroSystemPooledFromInner`
        """
        model = InVitroSystemPooledFromInner()
        if include_optional:
    ...
    def testInVitroSystemPooledFromInner(self):
        """Test InVitroSystemPooledFromInner"""
