...
class TestLINKTO3(unittest.TestCase):
    """LINKTO3 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LINKTO3:
        """Test LINKTO3
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LINKTO3`
        """
        model = LINKTO3()
        if include_optional:
            return LINKTO3(
