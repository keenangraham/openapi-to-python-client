...
class TestLINKTO47(unittest.TestCase):
    """LINKTO47 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LINKTO47:
        """Test LINKTO47
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LINKTO47`
        """
        model = LINKTO47()
        if include_optional:
            return LINKTO47(
