...
class TestDocumentAward(unittest.TestCase):
    """DocumentAward unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentAward:
        """Test DocumentAward
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentAward`
        """
        model = DocumentAward()
        if include_optional:
            return DocumentAward(
                status = 'current',
                url = '',
                schema_version = '5',
                uuid = '',
