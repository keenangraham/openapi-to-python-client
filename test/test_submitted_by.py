...
class TestSubmittedBy(unittest.TestCase):
    """SubmittedBy unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubmittedBy:
        """Test SubmittedBy
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubmittedBy`
        """
        model = SubmittedBy()
        if include_optional:
            return SubmittedBy(
