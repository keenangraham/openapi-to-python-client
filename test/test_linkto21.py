...
class TestLINKTO21(unittest.TestCase):
    """LINKTO21 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LINKTO21:
        """Test LINKTO21
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LINKTO21`
        """
        model = LINKTO21()
        if include_optional:
            return LINKTO21(
