...
class TestLINKTO27(unittest.TestCase):
    """LINKTO27 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LINKTO27:
        """Test LINKTO27
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LINKTO27`
        """
        model = LINKTO27()
        if include_optional:
            return LINKTO27(
