...
class TestLargeScaleLociList(unittest.TestCase):
    """LargeScaleLociList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LargeScaleLociList:
        """Test LargeScaleLociList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LargeScaleLociList`
        """
        model = LargeScaleLociList()
        if include_optional:
            return LargeScaleLociList(
    ...
    def testLargeScaleLociList(self):
        """Test LargeScaleLociList"""
