...
class TestLINKTO17(unittest.TestCase):
    """LINKTO17 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LINKTO17:
        """Test LINKTO17
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LINKTO17`
        """
        model = LINKTO17()
        if include_optional:
            return LINKTO17(
