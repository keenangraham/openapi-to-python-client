...
class TestDiseaseTerm(unittest.TestCase):
    """DiseaseTerm unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DiseaseTerm:
        """Test DiseaseTerm
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DiseaseTerm`
        """
        model = DiseaseTerm()
        if include_optional:
            return DiseaseTerm(
