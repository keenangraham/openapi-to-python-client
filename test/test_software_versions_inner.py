...
class TestSoftwareVersionsInner(unittest.TestCase):
    """SoftwareVersionsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SoftwareVersionsInner:
        """Test SoftwareVersionsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SoftwareVersionsInner`
        """
        model = SoftwareVersionsInner()
        if include_optional:
            return SoftwareVersionsInner(
    ...
    def testSoftwareVersionsInner(self):
        """Test SoftwareVersionsInner"""
