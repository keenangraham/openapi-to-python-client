...
class TestTargetedSampleTerm(unittest.TestCase):
    """TargetedSampleTerm unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TargetedSampleTerm:
        """Test TargetedSampleTerm
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TargetedSampleTerm`
        """
        model = TargetedSampleTerm()
        if include_optional:
            return TargetedSampleTerm(
    ...
    def testTargetedSampleTerm(self):
        """Test TargetedSampleTerm"""
