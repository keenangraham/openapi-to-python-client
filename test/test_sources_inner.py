...
class TestSourcesInner(unittest.TestCase):
    """SourcesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SourcesInner:
        """Test SourcesInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SourcesInner`
        """
        model = SourcesInner()
        if include_optional:
            return SourcesInner(
