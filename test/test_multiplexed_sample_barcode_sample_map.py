...
class TestMultiplexedSampleBarcodeSampleMap(unittest.TestCase):
    """MultiplexedSampleBarcodeSampleMap unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MultiplexedSampleBarcodeSampleMap:
        """Test MultiplexedSampleBarcodeSampleMap
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MultiplexedSampleBarcodeSampleMap`
        """
        model = MultiplexedSampleBarcodeSampleMap()
        if include_optional:
            return MultiplexedSampleBarcodeSampleMap(
    ...
    def testMultiplexedSampleBarcodeSampleMap(self):
        """Test MultiplexedSampleBarcodeSampleMap"""
