...
class TestInVitroSystemOriginatedFrom(unittest.TestCase):
    """InVitroSystemOriginatedFrom unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InVitroSystemOriginatedFrom:
        """Test InVitroSystemOriginatedFrom
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InVitroSystemOriginatedFrom`
        """
        model = InVitroSystemOriginatedFrom()
        if include_optional:
            return InVitroSystemOriginatedFrom(
    ...
    def testInVitroSystemOriginatedFrom(self):
        """Test InVitroSystemOriginatedFrom"""
