...
class TestLargeScaleGeneList(unittest.TestCase):
    """LargeScaleGeneList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LargeScaleGeneList:
        """Test LargeScaleGeneList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LargeScaleGeneList`
        """
        model = LargeScaleGeneList()
        if include_optional:
            return LargeScaleGeneList(
    ...
    def testLargeScaleGeneList(self):
        """Test LargeScaleGeneList"""
