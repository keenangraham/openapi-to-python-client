...
class TestModelSetSoftwareVersion(unittest.TestCase):
    """ModelSetSoftwareVersion unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ModelSetSoftwareVersion:
        """Test ModelSetSoftwareVersion
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ModelSetSoftwareVersion`
        """
        model = ModelSetSoftwareVersion()
        if include_optional:
            return ModelSetSoftwareVersion(
    ...
    def testModelSetSoftwareVersion(self):
        """Test ModelSetSoftwareVersion"""
