...
class TestMultiplexedSampleMultiplexedSamplesInner(unittest.TestCase):
    """MultiplexedSampleMultiplexedSamplesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MultiplexedSampleMultiplexedSamplesInner:
        """Test MultiplexedSampleMultiplexedSamplesInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MultiplexedSampleMultiplexedSamplesInner`
        """
        model = MultiplexedSampleMultiplexedSamplesInner()
        if include_optional:
            return MultiplexedSampleMultiplexedSamplesInner(
    ...
    def testMultiplexedSampleMultiplexedSamplesInner(self):
        """Test MultiplexedSampleMultiplexedSamplesInner"""
