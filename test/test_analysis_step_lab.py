...
class TestAnalysisStepLab(unittest.TestCase):
    """AnalysisStepLab unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnalysisStepLab:
        """Test AnalysisStepLab
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnalysisStepLab`
        """
        model = AnalysisStepLab()
        if include_optional:
            return AnalysisStepLab(
                status = 'current',
                url = '',
                schema_version = '3',
                uuid = '',
