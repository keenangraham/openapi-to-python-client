...
class TestAnalysisStepVersion(unittest.TestCase):
    """AnalysisStepVersion unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnalysisStepVersion:
        """Test AnalysisStepVersion
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnalysisStepVersion`
        """
        model = AnalysisStepVersion()
        if include_optional:
            return AnalysisStepVersion(
    ...
    def testAnalysisStepVersion(self):
        """Test AnalysisStepVersion"""
