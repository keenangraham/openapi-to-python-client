...
class TestInVitroSystemDiseaseTermsInner(unittest.TestCase):
    """InVitroSystemDiseaseTermsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InVitroSystemDiseaseTermsInner:
        """Test InVitroSystemDiseaseTermsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InVitroSystemDiseaseTermsInner`
        """
        model = InVitroSystemDiseaseTermsInner()
        if include_optional:
            return InVitroSystemDiseaseTermsInner(
    ...
    def testInVitroSystemDiseaseTermsInner(self):
        """Test InVitroSystemDiseaseTermsInner"""
