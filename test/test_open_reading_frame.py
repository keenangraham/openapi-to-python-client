...
class TestOpenReadingFrame(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> OpenReadingFrame:
        """Test OpenReadingFrame
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OpenReadingFrame`
        """
        model = OpenReadingFrame()
        if include_optional:
