...
class TestLINKTO25(unittest.TestCase):
    """LINKTO25 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LINKTO25:
        """Test LINKTO25
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LINKTO25`
        """
        model = LINKTO25()
        if include_optional:
            return LINKTO25(
