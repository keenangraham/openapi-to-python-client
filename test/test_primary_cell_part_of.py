...
class TestPrimaryCellPartOf(unittest.TestCase):
    """PrimaryCellPartOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PrimaryCellPartOf:
        """Test PrimaryCellPartOf
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrimaryCellPartOf`
        """
        model = PrimaryCellPartOf()
        if include_optional:
            return PrimaryCellPartOf(
    ...
    def testPrimaryCellPartOf(self):
        """Test PrimaryCellPartOf"""
