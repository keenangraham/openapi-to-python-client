...
class TestAlignmentFileDerivedFromInner(unittest.TestCase):
    """AlignmentFileDerivedFromInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AlignmentFileDerivedFromInner:
        """Test AlignmentFileDerivedFromInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AlignmentFileDerivedFromInner`
        """
        model = AlignmentFileDerivedFromInner()
        if include_optional:
            return AlignmentFileDerivedFromInner(
    ...
    def testAlignmentFileDerivedFromInner(self):
        """Test AlignmentFileDerivedFromInner"""
