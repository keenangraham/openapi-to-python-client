...
class TestPhenotypicFeature1(unittest.TestCase):
    """PhenotypicFeature1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PhenotypicFeature1:
        """Test PhenotypicFeature1
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PhenotypicFeature1`
        """
        model = PhenotypicFeature1()
        if include_optional:
            return PhenotypicFeature1(
    ...
    def testPhenotypicFeature1(self):
        """Test PhenotypicFeature1"""
