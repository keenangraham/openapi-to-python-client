...
class TestSampleTerm1(unittest.TestCase):
    """SampleTerm1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SampleTerm1:
        """Test SampleTerm1
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SampleTerm1`
        """
        model = SampleTerm1()
        if include_optional:
            return SampleTerm1(
