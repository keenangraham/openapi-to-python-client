...
class TestSequencingPlatform(unittest.TestCase):
    """SequencingPlatform unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SequencingPlatform:
        """Test SequencingPlatform
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SequencingPlatform`
        """
    ...
    def testSequencingPlatform(self):
        """Test SequencingPlatform"""
