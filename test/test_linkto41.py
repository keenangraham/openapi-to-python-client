...
class TestLINKTO41(unittest.TestCase):
    """LINKTO41 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LINKTO41:
        """Test LINKTO41
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LINKTO41`
        """
        model = LINKTO41()
        if include_optional:
            return LINKTO41(
