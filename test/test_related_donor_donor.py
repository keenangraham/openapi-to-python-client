...
class TestRelatedDonorDonor(unittest.TestCase):
    """RelatedDonorDonor unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RelatedDonorDonor:
        """Test RelatedDonorDonor
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RelatedDonorDonor`
        """
        model = RelatedDonorDonor()
        if include_optional:
            return RelatedDonorDonor(
    ...
    def testRelatedDonorDonor(self):
        """Test RelatedDonorDonor"""
