...
class TestLINKTO35(unittest.TestCase):
    """LINKTO35 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LINKTO35:
        """Test LINKTO35
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LINKTO35`
        """
        model = LINKTO35()
        if include_optional:
            return LINKTO35(
