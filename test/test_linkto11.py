...
class TestLINKTO11(unittest.TestCase):
    """LINKTO11 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LINKTO11:
        """Test LINKTO11
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LINKTO11`
        """
        model = LINKTO11()
        if include_optional:
            return LINKTO11(
