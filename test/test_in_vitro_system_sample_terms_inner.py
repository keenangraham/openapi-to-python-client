...
class TestInVitroSystemSampleTermsInner(unittest.TestCase):
    """InVitroSystemSampleTermsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InVitroSystemSampleTermsInner:
        """Test InVitroSystemSampleTermsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InVitroSystemSampleTermsInner`
        """
        model = InVitroSystemSampleTermsInner()
        if include_optional:
            return InVitroSystemSampleTermsInner(
    ...
    def testInVitroSystemSampleTermsInner(self):
        """Test InVitroSystemSampleTermsInner"""
