...
class TestParentPage(unittest.TestCase):
    """ParentPage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ParentPage:
        """Test ParentPage
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ParentPage`
        """
        model = ParentPage()
        if include_optional:
            return ParentPage(
