...
class TestAssociatedPhenotype(unittest.TestCase):
    """AssociatedPhenotype unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AssociatedPhenotype:
        """Test AssociatedPhenotype
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AssociatedPhenotype`
        """
        model = AssociatedPhenotype()
        if include_optional:
            return AssociatedPhenotype(
    ...
    def testAssociatedPhenotype(self):
        """Test AssociatedPhenotype"""
