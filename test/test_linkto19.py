...
class TestLINKTO19(unittest.TestCase):
    """LINKTO19 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LINKTO19:
        """Test LINKTO19
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LINKTO19`
        """
        model = LINKTO19()
        if include_optional:
            return LINKTO19(
