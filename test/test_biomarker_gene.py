...
class TestBiomarkerGene(unittest.TestCase):
    """BiomarkerGene unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BiomarkerGene:
        """Test BiomarkerGene
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BiomarkerGene`
        """
        model = BiomarkerGene()
        if include_optional:
            return BiomarkerGene(
