...
class TestFileFormatSpecificationsDocument(unittest.TestCase):
    """FileFormatSpecificationsDocument unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FileFormatSpecificationsDocument:
        """Test FileFormatSpecificationsDocument
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FileFormatSpecificationsDocument`
        """
        model = FileFormatSpecificationsDocument()
        if include_optional:
            return FileFormatSpecificationsDocument(
    ...
    def testFileFormatSpecificationsDocument(self):
        """Test FileFormatSpecificationsDocument"""
