...
class TestLINKTO33(unittest.TestCase):
    """LINKTO33 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LINKTO33:
        """Test LINKTO33
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LINKTO33`
        """
        model = LINKTO33()
        if include_optional:
            return LINKTO33(
