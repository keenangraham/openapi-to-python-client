...
class TestLINKTO14(unittest.TestCase):
    """LINKTO14 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LINKTO14:
        """Test LINKTO14
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LINKTO14`
        """
        model = LINKTO14()
        if include_optional:
            return LINKTO14(
