...
class TestLINKTO40(unittest.TestCase):
    """LINKTO40 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LINKTO40:
        """Test LINKTO40
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LINKTO40`
        """
        model = LINKTO40()
        if include_optional:
            return LINKTO40(
