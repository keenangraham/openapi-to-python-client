...
class TestLINKTO44(unittest.TestCase):
    """LINKTO44 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LINKTO44:
        """Test LINKTO44
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LINKTO44`
        """
        model = LINKTO44()
        if include_optional:
            return LINKTO44(
