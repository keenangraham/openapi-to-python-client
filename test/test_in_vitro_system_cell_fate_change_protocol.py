...
class TestInVitroSystemCellFateChangeProtocol(unittest.TestCase):
    """InVitroSystemCellFateChangeProtocol unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InVitroSystemCellFateChangeProtocol:
        """Test InVitroSystemCellFateChangeProtocol
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InVitroSystemCellFateChangeProtocol`
        """
        model = InVitroSystemCellFateChangeProtocol()
        if include_optional:
            return InVitroSystemCellFateChangeProtocol(
    ...
    def testInVitroSystemCellFateChangeProtocol(self):
        """Test InVitroSystemCellFateChangeProtocol"""
