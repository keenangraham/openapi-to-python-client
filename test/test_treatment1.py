...
class TestTreatment1(unittest.TestCase):
    """Treatment1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Treatment1:
        """Test Treatment1
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Treatment1`
        """
        model = Treatment1()
        if include_optional:
            return Treatment1(
