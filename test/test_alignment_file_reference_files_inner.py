...
class TestAlignmentFileReferenceFilesInner(unittest.TestCase):
    """AlignmentFileReferenceFilesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AlignmentFileReferenceFilesInner:
        """Test AlignmentFileReferenceFilesInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AlignmentFileReferenceFilesInner`
        """
        model = AlignmentFileReferenceFilesInner()
        if include_optional:
            return AlignmentFileReferenceFilesInner(
    ...
    def testAlignmentFileReferenceFilesInner(self):
        """Test AlignmentFileReferenceFilesInner"""
