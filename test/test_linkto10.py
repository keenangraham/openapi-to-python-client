...
class TestLINKTO10(unittest.TestCase):
    """LINKTO10 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LINKTO10:
        """Test LINKTO10
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LINKTO10`
        """
        model = LINKTO10()
        if include_optional:
            return LINKTO10(
