...
class TestInVitroSystemDemultiplexedFrom(unittest.TestCase):
    """InVitroSystemDemultiplexedFrom unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InVitroSystemDemultiplexedFrom:
        """Test InVitroSystemDemultiplexedFrom
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InVitroSystemDemultiplexedFrom`
        """
        model = InVitroSystemDemultiplexedFrom()
        if include_optional:
            return InVitroSystemDemultiplexedFrom(
    ...
    def testInVitroSystemDemultiplexedFrom(self):
        """Test InVitroSystemDemultiplexedFrom"""
