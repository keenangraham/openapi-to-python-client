...
class TestPhenotypicFeaturesInner(unittest.TestCase):
    """PhenotypicFeaturesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PhenotypicFeaturesInner:
        """Test PhenotypicFeaturesInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PhenotypicFeaturesInner`
        """
        model = PhenotypicFeaturesInner()
        if include_optional:
            return PhenotypicFeaturesInner(
    ...
    def testPhenotypicFeaturesInner(self):
        """Test PhenotypicFeaturesInner"""
