...
class TestLINKTO13(unittest.TestCase):
    """LINKTO13 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LINKTO13:
        """Test LINKTO13
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LINKTO13`
        """
        model = LINKTO13()
        if include_optional:
            return LINKTO13(
