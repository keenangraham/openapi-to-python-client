...
class TestLibraryConstructionPlatform(unittest.TestCase):
    """LibraryConstructionPlatform unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LibraryConstructionPlatform:
        """Test LibraryConstructionPlatform
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LibraryConstructionPlatform`
        """
        model = LibraryConstructionPlatform()
        if include_optional:
            return LibraryConstructionPlatform(
    ...
    def testLibraryConstructionPlatform(self):
        """Test LibraryConstructionPlatform"""
