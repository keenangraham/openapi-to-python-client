...
class TestDocumentLab(unittest.TestCase):
    """DocumentLab unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentLab:
        """Test DocumentLab
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentLab`
        """
        model = DocumentLab()
        if include_optional:
            return DocumentLab(
