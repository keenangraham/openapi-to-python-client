...
class TestSubmittedBy1(unittest.TestCase):
    """SubmittedBy1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubmittedBy1:
        """Test SubmittedBy1
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubmittedBy1`
        """
        model = SubmittedBy1()
        if include_optional:
            return SubmittedBy1(
