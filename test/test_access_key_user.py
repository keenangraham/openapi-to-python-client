...
class TestAccessKeyUser(unittest.TestCase):
    """AccessKeyUser unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AccessKeyUser:
        """Test AccessKeyUser
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AccessKeyUser`
        """
        model = AccessKeyUser()
        if include_optional:
            return AccessKeyUser(
                status = 'current',
                schema_version = '5',
                uuid = '',
                notes = 'k',
