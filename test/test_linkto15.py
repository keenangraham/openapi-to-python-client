...
class TestLINKTO15(unittest.TestCase):
    """LINKTO15 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LINKTO15:
        """Test LINKTO15
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LINKTO15`
        """
        model = LINKTO15()
        if include_optional:
            return LINKTO15(
