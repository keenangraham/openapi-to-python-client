...
class TestAnalysisSetSamplesInner(unittest.TestCase):
    """AnalysisSetSamplesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnalysisSetSamplesInner:
        """Test AnalysisSetSamplesInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnalysisSetSamplesInner`
        """
        model = AnalysisSetSamplesInner()
        if include_optional:
            return AnalysisSetSamplesInner(
    ...
    def testAnalysisSetSamplesInner(self):
        """Test AnalysisSetSamplesInner"""
