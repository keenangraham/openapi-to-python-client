...
class TestMeasurementSetAssayTerm(unittest.TestCase):
    """MeasurementSetAssayTerm unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MeasurementSetAssayTerm:
        """Test MeasurementSetAssayTerm
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MeasurementSetAssayTerm`
        """
        model = MeasurementSetAssayTerm()
        if include_optional:
            return MeasurementSetAssayTerm(
    ...
    def testMeasurementSetAssayTerm(self):
        """Test MeasurementSetAssayTerm"""
