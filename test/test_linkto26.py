...
class TestLINKTO26(unittest.TestCase):
    """LINKTO26 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LINKTO26:
        """Test LINKTO26
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LINKTO26`
        """
        model = LINKTO26()
        if include_optional:
            return LINKTO26(
