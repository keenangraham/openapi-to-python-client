...
class TestInVitroSystemTreatmentsInner(unittest.TestCase):
    """InVitroSystemTreatmentsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InVitroSystemTreatmentsInner:
        """Test InVitroSystemTreatmentsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InVitroSystemTreatmentsInner`
        """
        model = InVitroSystemTreatmentsInner()
        if include_optional:
            return InVitroSystemTreatmentsInner(
    ...
    def testInVitroSystemTreatmentsInner(self):
        """Test InVitroSystemTreatmentsInner"""
