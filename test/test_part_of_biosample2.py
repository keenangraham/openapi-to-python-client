...
class TestPartOfBiosample2(unittest.TestCase):
    """PartOfBiosample2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PartOfBiosample2:
        """Test PartOfBiosample2
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PartOfBiosample2`
        """
        model = PartOfBiosample2()
        if include_optional:
