...
class TestLINKTO20(unittest.TestCase):
    """LINKTO20 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LINKTO20:
        """Test LINKTO20
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LINKTO20`
        """
        model = LINKTO20()
        if include_optional:
            return LINKTO20(
