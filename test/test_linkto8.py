...
class TestLINKTO8(unittest.TestCase):
    """LINKTO8 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LINKTO8:
        """Test LINKTO8
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LINKTO8`
        """
        model = LINKTO8()
        if include_optional:
            return LINKTO8(
