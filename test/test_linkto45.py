...
class TestLINKTO45(unittest.TestCase):
    """LINKTO45 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LINKTO45:
        """Test LINKTO45
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LINKTO45`
        """
        model = LINKTO45()
        if include_optional:
            return LINKTO45(
