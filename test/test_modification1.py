...
class TestModification1(unittest.TestCase):
    """Modification1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Modification1:
        """Test Modification1
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Modification1`
        """
        model = Modification1()
        if include_optional:
