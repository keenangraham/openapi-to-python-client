...
class TestLabAwardsInner(unittest.TestCase):
    """LabAwardsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LabAwardsInner:
        """Test LabAwardsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LabAwardsInner`
        """
        model = LabAwardsInner()
        if include_optional:
            return LabAwardsInner(
                status = 'current',
                url = '',
                schema_version = '5',
                uuid = '',
