...
class TestConfigurationFileSeqspecOfInner(unittest.TestCase):
    """ConfigurationFileSeqspecOfInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConfigurationFileSeqspecOfInner:
        """Test ConfigurationFileSeqspecOfInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConfigurationFileSeqspecOfInner`
        """
        model = ConfigurationFileSeqspecOfInner()
        if include_optional:
            return ConfigurationFileSeqspecOfInner(
    ...
    def testConfigurationFileSeqspecOfInner(self):
        """Test ConfigurationFileSeqspecOfInner"""
