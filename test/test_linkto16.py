...
class TestLINKTO16(unittest.TestCase):
    """LINKTO16 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LINKTO16:
        """Test LINKTO16
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LINKTO16`
        """
        model = LINKTO16()
        if include_optional:
            return LINKTO16(
