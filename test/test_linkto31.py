...
class TestLINKTO31(unittest.TestCase):
    """LINKTO31 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LINKTO31:
        """Test LINKTO31
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LINKTO31`
        """
        model = LINKTO31()
        if include_optional:
            return LINKTO31(
