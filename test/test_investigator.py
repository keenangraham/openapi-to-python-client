...
class TestInvestigator(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Investigator:
        """Test Investigator
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Investigator`
        """
        model = Investigator()
        if include_optional:
            return Investigator(
