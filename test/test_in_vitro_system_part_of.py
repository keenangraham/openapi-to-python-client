...
class TestInVitroSystemPartOf(unittest.TestCase):
    """InVitroSystemPartOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InVitroSystemPartOf:
        """Test InVitroSystemPartOf
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InVitroSystemPartOf`
        """
        model = InVitroSystemPartOf()
        if include_optional:
            return InVitroSystemPartOf(
    ...
    def testInVitroSystemPartOf(self):
        """Test InVitroSystemPartOf"""
