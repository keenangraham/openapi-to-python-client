...
class TestOpenReadingFrameGeneInner(unittest.TestCase):
    """OpenReadingFrameGeneInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OpenReadingFrameGeneInner:
        """Test OpenReadingFrameGeneInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OpenReadingFrameGeneInner`
        """
        model = OpenReadingFrameGeneInner()
        if include_optional:
            return OpenReadingFrameGeneInner(
    ...
    def testOpenReadingFrameGeneInner(self):
        """Test OpenReadingFrameGeneInner"""
