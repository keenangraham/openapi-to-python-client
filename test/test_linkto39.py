...
class TestLINKTO39(unittest.TestCase):
    """LINKTO39 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LINKTO39:
        """Test LINKTO39
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LINKTO39`
        """
        model = LINKTO39()
        if include_optional:
            return LINKTO39(
