...
class TestListOfOpenReadingFramesORF(unittest.TestCase):
    """ListOfOpenReadingFramesORF unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListOfOpenReadingFramesORF:
        """Test ListOfOpenReadingFramesORF
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListOfOpenReadingFramesORF`
        """
        model = ListOfOpenReadingFramesORF()
        if include_optional:
            return ListOfOpenReadingFramesORF(
    ...
    def testListOfOpenReadingFramesORF(self):
        """Test ListOfOpenReadingFramesORF"""
