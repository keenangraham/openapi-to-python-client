...
class TestLINKTO12(unittest.TestCase):
    """LINKTO12 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LINKTO12:
        """Test LINKTO12
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LINKTO12`
        """
        model = LINKTO12()
        if include_optional:
            return LINKTO12(
