...
class TestWorkflowStandardsPage(unittest.TestCase):
    """WorkflowStandardsPage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkflowStandardsPage:
        """Test WorkflowStandardsPage
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkflowStandardsPage`
        """
        model = WorkflowStandardsPage()
        if include_optional:
            return WorkflowStandardsPage(
    ...
    def testWorkflowStandardsPage(self):
        """Test WorkflowStandardsPage"""
