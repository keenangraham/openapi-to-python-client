...
class TestBiosamplePooledFrom(unittest.TestCase):
    """BiosamplePooledFrom unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BiosamplePooledFrom:
        """Test BiosamplePooledFrom
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BiosamplePooledFrom`
        """
        model = BiosamplePooledFrom()
        if include_optional:
            return BiosamplePooledFrom(
    ...
    def testBiosamplePooledFrom(self):
        """Test BiosamplePooledFrom"""
