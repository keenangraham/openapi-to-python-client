...
class TestTreatment2(unittest.TestCase):
    """Treatment2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Treatment2:
        """Test Treatment2
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Treatment2`
        """
        model = Treatment2()
        if include_optional:
            return Treatment2(
