...
class TestLINKTO28(unittest.TestCase):
    """LINKTO28 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LINKTO28:
        """Test LINKTO28
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LINKTO28`
        """
        model = LINKTO28()
        if include_optional:
            return LINKTO28(
