...
class TestAuxiliarySetLibraryConstructionPlatform(unittest.TestCase):
    """AuxiliarySetLibraryConstructionPlatform unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuxiliarySetLibraryConstructionPlatform:
        """Test AuxiliarySetLibraryConstructionPlatform
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuxiliarySetLibraryConstructionPlatform`
        """
        model = AuxiliarySetLibraryConstructionPlatform()
        if include_optional:
            return AuxiliarySetLibraryConstructionPlatform(
    ...
    def testAuxiliarySetLibraryConstructionPlatform(self):
        """Test AuxiliarySetLibraryConstructionPlatform"""
