...
class TestUserSubmitsForInner(unittest.TestCase):
    """UserSubmitsForInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserSubmitsForInner:
        """Test UserSubmitsForInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserSubmitsForInner`
        """
        model = UserSubmitsForInner()
        if include_optional:
            return UserSubmitsForInner(
                status = 'current',
                url = '',
                schema_version = '3',
                uuid = '',
    ...
    def testUserSubmitsForInner(self):
        """Test UserSubmitsForInner"""
