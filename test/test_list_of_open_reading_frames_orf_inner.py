...
class TestListOfOpenReadingFramesORFInner(unittest.TestCase):
    """ListOfOpenReadingFramesORFInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListOfOpenReadingFramesORFInner:
        """Test ListOfOpenReadingFramesORFInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListOfOpenReadingFramesORFInner`
        """
        model = ListOfOpenReadingFramesORFInner()
        if include_optional:
            return ListOfOpenReadingFramesORFInner(
    ...
    def testListOfOpenReadingFramesORFInner(self):
        """Test ListOfOpenReadingFramesORFInner"""
