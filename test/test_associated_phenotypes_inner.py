...
class TestAssociatedPhenotypesInner(unittest.TestCase):
    """AssociatedPhenotypesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AssociatedPhenotypesInner:
        """Test AssociatedPhenotypesInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AssociatedPhenotypesInner`
        """
        model = AssociatedPhenotypesInner()
        if include_optional:
            return AssociatedPhenotypesInner(
    ...
    def testAssociatedPhenotypesInner(self):
        """Test AssociatedPhenotypesInner"""
