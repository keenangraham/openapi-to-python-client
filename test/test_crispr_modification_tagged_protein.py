...
class TestCrisprModificationTaggedProtein(unittest.TestCase):
    """CrisprModificationTaggedProtein unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CrisprModificationTaggedProtein:
        """Test CrisprModificationTaggedProtein
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CrisprModificationTaggedProtein`
        """
        model = CrisprModificationTaggedProtein()
        if include_optional:
            return CrisprModificationTaggedProtein(
    ...
    def testCrisprModificationTaggedProtein(self):
        """Test CrisprModificationTaggedProtein"""
