...
class TestLINKTO5(unittest.TestCase):
    """LINKTO5 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LINKTO5:
        """Test LINKTO5
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LINKTO5`
        """
        model = LINKTO5()
        if include_optional:
            return LINKTO5(
