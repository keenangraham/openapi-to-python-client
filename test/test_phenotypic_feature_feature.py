...
class TestPhenotypicFeatureFeature(unittest.TestCase):
    """PhenotypicFeatureFeature unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PhenotypicFeatureFeature:
        """Test PhenotypicFeatureFeature
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PhenotypicFeatureFeature`
        """
        model = PhenotypicFeatureFeature()
        if include_optional:
            return PhenotypicFeatureFeature(
    ...
    def testPhenotypicFeatureFeature(self):
        """Test PhenotypicFeatureFeature"""
