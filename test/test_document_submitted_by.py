...
class TestDocumentSubmittedBy(unittest.TestCase):
    """DocumentSubmittedBy unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentSubmittedBy:
        """Test DocumentSubmittedBy
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentSubmittedBy`
        """
        model = DocumentSubmittedBy()
        if include_optional:
    ...
    def testDocumentSubmittedBy(self):
        """Test DocumentSubmittedBy"""
