...
class TestLINKTO24(unittest.TestCase):
    """LINKTO24 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LINKTO24:
        """Test LINKTO24
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LINKTO24`
        """
        model = LINKTO24()
        if include_optional:
            return LINKTO24(
