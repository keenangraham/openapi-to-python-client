...
class TestAccessKeySubmittedBy(unittest.TestCase):
    """AccessKeySubmittedBy unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AccessKeySubmittedBy:
        """Test AccessKeySubmittedBy
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AccessKeySubmittedBy`
        """
        model = AccessKeySubmittedBy()
        if include_optional:
            return AccessKeySubmittedBy(
                status = 'current',
                schema_version = '5',
                uuid = '',
                notes = 'k',
    ...
    def testAccessKeySubmittedBy(self):
        """Test AccessKeySubmittedBy"""
