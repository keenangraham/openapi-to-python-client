...
class TestMeasurementSetRelatedMultiomeDatasetsInner(unittest.TestCase):
    """MeasurementSetRelatedMultiomeDatasetsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MeasurementSetRelatedMultiomeDatasetsInner:
        """Test MeasurementSetRelatedMultiomeDatasetsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MeasurementSetRelatedMultiomeDatasetsInner`
        """
        model = MeasurementSetRelatedMultiomeDatasetsInner()
        if include_optional:
            return MeasurementSetRelatedMultiomeDatasetsInner(
    ...
    def testMeasurementSetRelatedMultiomeDatasetsInner(self):
        """Test MeasurementSetRelatedMultiomeDatasetsInner"""
