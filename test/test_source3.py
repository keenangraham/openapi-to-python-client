...
class TestSource3(unittest.TestCase):
    """Source3 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Source3:
        """Test Source3
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Source3`
        """
        model = Source3()
        if include_optional:
            return Source3(
