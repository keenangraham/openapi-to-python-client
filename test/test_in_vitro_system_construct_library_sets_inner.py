...
class TestInVitroSystemConstructLibrarySetsInner(unittest.TestCase):
    """InVitroSystemConstructLibrarySetsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InVitroSystemConstructLibrarySetsInner:
        """Test InVitroSystemConstructLibrarySetsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InVitroSystemConstructLibrarySetsInner`
        """
        model = InVitroSystemConstructLibrarySetsInner()
        if include_optional:
            return InVitroSystemConstructLibrarySetsInner(
    ...
    def testInVitroSystemConstructLibrarySetsInner(self):
        """Test InVitroSystemConstructLibrarySetsInner"""
