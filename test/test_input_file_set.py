...
class TestInputFileSet(unittest.TestCase):
    """InputFileSet unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InputFileSet:
        """Test InputFileSet
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InputFileSet`
        """
        model = InputFileSet()
        if include_optional:
            return InputFileSet(
