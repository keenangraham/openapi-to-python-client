...
class TestCellFateChangeProtocol(unittest.TestCase):
    """CellFateChangeProtocol unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CellFateChangeProtocol:
        """Test CellFateChangeProtocol
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CellFateChangeProtocol`
        """
        model = CellFateChangeProtocol()
        if include_optional:
            return CellFateChangeProtocol(
    ...
    def testCellFateChangeProtocol(self):
        """Test CellFateChangeProtocol"""
