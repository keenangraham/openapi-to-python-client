...
class TestInstitutionalCertificate(unittest.TestCase):
    """InstitutionalCertificate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InstitutionalCertificate:
        """Test InstitutionalCertificate
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InstitutionalCertificate`
        """
        model = InstitutionalCertificate()
        if include_optional:
            return InstitutionalCertificate(
    ...
    def testInstitutionalCertificate(self):
        """Test InstitutionalCertificate"""
