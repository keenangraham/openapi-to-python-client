...
class TestLINKTO34(unittest.TestCase):
    """LINKTO34 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LINKTO34:
        """Test LINKTO34
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LINKTO34`
        """
        model = LINKTO34()
        if include_optional:
            return LINKTO34(
