...
class TestInVitroSystemModificationsInner(unittest.TestCase):
    """InVitroSystemModificationsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InVitroSystemModificationsInner:
        """Test InVitroSystemModificationsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InVitroSystemModificationsInner`
        """
        model = InVitroSystemModificationsInner()
        if include_optional:
            return InVitroSystemModificationsInner(
    ...
    def testInVitroSystemModificationsInner(self):
        """Test InVitroSystemModificationsInner"""
