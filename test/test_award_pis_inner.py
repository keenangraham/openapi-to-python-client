...
class TestAwardPisInner(unittest.TestCase):
    """AwardPisInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AwardPisInner:
        """Test AwardPisInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AwardPisInner`
        """
        model = AwardPisInner()
        if include_optional:
            return AwardPisInner(
                status = 'current',
                schema_version = '5',
                uuid = '',
                notes = 'k',
