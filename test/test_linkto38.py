...
class TestLINKTO38(unittest.TestCase):
    """LINKTO38 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LINKTO38:
        """Test LINKTO38
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LINKTO38`
        """
        model = LINKTO38()
        if include_optional:
            return LINKTO38(
