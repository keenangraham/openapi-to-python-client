...
class TestRelatedMultiomeDataset(unittest.TestCase):
    """RelatedMultiomeDataset unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RelatedMultiomeDataset:
        """Test RelatedMultiomeDataset
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RelatedMultiomeDataset`
        """
        model = RelatedMultiomeDataset()
        if include_optional:
            return RelatedMultiomeDataset(
    ...
    def testRelatedMultiomeDataset(self):
        """Test RelatedMultiomeDataset"""
