...
class TestLINKTO42(unittest.TestCase):
    """LINKTO42 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LINKTO42:
        """Test LINKTO42
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LINKTO42`
        """
        model = LINKTO42()
        if include_optional:
            return LINKTO42(
