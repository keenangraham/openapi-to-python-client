...
class TestWholeOrganismPooledFromInner(unittest.TestCase):
    """WholeOrganismPooledFromInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WholeOrganismPooledFromInner:
        """Test WholeOrganismPooledFromInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WholeOrganismPooledFromInner`
        """
        model = WholeOrganismPooledFromInner()
        if include_optional:
            return WholeOrganismPooledFromInner(
    ...
    def testWholeOrganismPooledFromInner(self):
        """Test WholeOrganismPooledFromInner"""
