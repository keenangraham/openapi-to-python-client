...
class TestBiomarker1(unittest.TestCase):
    """Biomarker1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Biomarker1:
        """Test Biomarker1
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Biomarker1`
        """
        model = Biomarker1()
        if include_optional:
            return Biomarker1(
