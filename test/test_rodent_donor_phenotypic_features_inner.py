...
class TestRodentDonorPhenotypicFeaturesInner(unittest.TestCase):
    """RodentDonorPhenotypicFeaturesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RodentDonorPhenotypicFeaturesInner:
        """Test RodentDonorPhenotypicFeaturesInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RodentDonorPhenotypicFeaturesInner`
        """
        model = RodentDonorPhenotypicFeaturesInner()
        if include_optional:
            return RodentDonorPhenotypicFeaturesInner(
    ...
    def testRodentDonorPhenotypicFeaturesInner(self):
        """Test RodentDonorPhenotypicFeaturesInner"""
