...
class TestPartOfBiosample1(unittest.TestCase):
    """PartOfBiosample1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PartOfBiosample1:
        """Test PartOfBiosample1
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PartOfBiosample1`
        """
        model = PartOfBiosample1()
        if include_optional:
            return PartOfBiosample1(
