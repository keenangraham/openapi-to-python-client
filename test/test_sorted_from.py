...
class TestSortedFrom(unittest.TestCase):
    """SortedFrom unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SortedFrom:
        """Test SortedFrom
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SortedFrom`
        """
        model = SortedFrom()
        if include_optional:
            return SortedFrom(
