...
class TestLINKTO46(unittest.TestCase):
    """LINKTO46 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LINKTO46:
        """Test LINKTO46
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LINKTO46`
        """
        model = LINKTO46()
        if include_optional:
            return LINKTO46(
