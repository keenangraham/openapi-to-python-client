...
class TestLINKTO1(unittest.TestCase):
    """LINKTO1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LINKTO1:
        """Test LINKTO1
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LINKTO1`
        """
        model = LINKTO1()
        if include_optional:
            return LINKTO1(
