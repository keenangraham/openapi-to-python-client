...
class TestLINKTO29(unittest.TestCase):
    """LINKTO29 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LINKTO29:
        """Test LINKTO29
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LINKTO29`
        """
        model = LINKTO29()
        if include_optional:
            return LINKTO29(
