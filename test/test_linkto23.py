...
class TestLINKTO23(unittest.TestCase):
    """LINKTO23 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LINKTO23:
        """Test LINKTO23
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LINKTO23`
        """
        model = LINKTO23()
        if include_optional:
            return LINKTO23(
