...
class TestLINKTO6(unittest.TestCase):
    """LINKTO6 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LINKTO6:
        """Test LINKTO6
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LINKTO6`
        """
        model = LINKTO6()
        if include_optional:
            return LINKTO6(
