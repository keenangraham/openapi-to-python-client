...
class TestIntegratedContentFile(unittest.TestCase):
    """IntegratedContentFile unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IntegratedContentFile:
        """Test IntegratedContentFile
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IntegratedContentFile`
        """
    ...
    def testIntegratedContentFile(self):
        """Test IntegratedContentFile"""
