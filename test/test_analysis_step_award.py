...
class TestAnalysisStepAward(unittest.TestCase):
    """AnalysisStepAward unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnalysisStepAward:
        """Test AnalysisStepAward
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnalysisStepAward`
        """
        model = AnalysisStepAward()
        if include_optional:
            return AnalysisStepAward(
                status = 'current',
                url = '',
                schema_version = '5',
                uuid = '',
    ...
    def testAnalysisStepAward(self):
        """Test AnalysisStepAward"""
