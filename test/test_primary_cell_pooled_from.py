...
class TestPrimaryCellPooledFrom(unittest.TestCase):
    """PrimaryCellPooledFrom unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PrimaryCellPooledFrom:
        """Test PrimaryCellPooledFrom
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrimaryCellPooledFrom`
        """
        model = PrimaryCellPooledFrom()
        if include_optional:
            return PrimaryCellPooledFrom(
    ...
    def testPrimaryCellPooledFrom(self):
        """Test PrimaryCellPooledFrom"""
