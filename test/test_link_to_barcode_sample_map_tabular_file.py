...
class TestLinkToBarcodeSampleMapTabularFile(unittest.TestCase):
    """LinkToBarcodeSampleMapTabularFile unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinkToBarcodeSampleMapTabularFile:
        """Test LinkToBarcodeSampleMapTabularFile
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinkToBarcodeSampleMapTabularFile`
        """
        model = LinkToBarcodeSampleMapTabularFile()
        if include_optional:
            return LinkToBarcodeSampleMapTabularFile(
    ...
    def testLinkToBarcodeSampleMapTabularFile(self):
        """Test LinkToBarcodeSampleMapTabularFile"""
