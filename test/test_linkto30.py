...
class TestLINKTO30(unittest.TestCase):
    """LINKTO30 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LINKTO30:
        """Test LINKTO30
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LINKTO30`
        """
        model = LINKTO30()
        if include_optional:
            return LINKTO30(
