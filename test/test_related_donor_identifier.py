...
class TestRelatedDonorIdentifier(unittest.TestCase):
    """RelatedDonorIdentifier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RelatedDonorIdentifier:
        """Test RelatedDonorIdentifier
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RelatedDonorIdentifier`
        """
        model = RelatedDonorIdentifier()
        if include_optional:
            return RelatedDonorIdentifier(
    ...
    def testRelatedDonorIdentifier(self):
        """Test RelatedDonorIdentifier"""
