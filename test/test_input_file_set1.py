...
class TestInputFileSet1(unittest.TestCase):
    """InputFileSet1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InputFileSet1:
        """Test InputFileSet1
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InputFileSet1`
        """
        model = InputFileSet1()
        if include_optional:
            return InputFileSet1(
