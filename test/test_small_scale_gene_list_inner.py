...
class TestSmallScaleGeneListInner(unittest.TestCase):
    """SmallScaleGeneListInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SmallScaleGeneListInner:
        """Test SmallScaleGeneListInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SmallScaleGeneListInner`
        """
        model = SmallScaleGeneListInner()
        if include_optional:
            return SmallScaleGeneListInner(
    ...
    def testSmallScaleGeneListInner(self):
        """Test SmallScaleGeneListInner"""
