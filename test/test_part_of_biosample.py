...
class TestPartOfBiosample(unittest.TestCase):
    """PartOfBiosample unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PartOfBiosample:
        """Test PartOfBiosample
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PartOfBiosample`
        """
        model = PartOfBiosample()
        if include_optional:
            return PartOfBiosample(
