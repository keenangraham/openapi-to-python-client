...
class TestContactPI(unittest.TestCase):
    """ContactPI unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContactPI:
        """Test ContactPI
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContactPI`
        """
        model = ContactPI()
        if include_optional:
            return ContactPI(
