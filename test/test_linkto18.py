...
class TestLINKTO18(unittest.TestCase):
    """LINKTO18 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LINKTO18:
        """Test LINKTO18
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LINKTO18`
        """
        model = LINKTO18()
        if include_optional:
            return LINKTO18(
