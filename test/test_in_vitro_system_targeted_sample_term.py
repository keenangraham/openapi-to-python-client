...
class TestInVitroSystemTargetedSampleTerm(unittest.TestCase):
    """InVitroSystemTargetedSampleTerm unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InVitroSystemTargetedSampleTerm:
        """Test InVitroSystemTargetedSampleTerm
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InVitroSystemTargetedSampleTerm`
        """
        model = InVitroSystemTargetedSampleTerm()
        if include_optional:
            return InVitroSystemTargetedSampleTerm(
    ...
    def testInVitroSystemTargetedSampleTerm(self):
        """Test InVitroSystemTargetedSampleTerm"""
