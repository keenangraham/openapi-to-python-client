...
class TestLINKTO37(unittest.TestCase):
    """LINKTO37 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LINKTO37:
        """Test LINKTO37
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LINKTO37`
        """
        model = LINKTO37()
        if include_optional:
            return LINKTO37(
