...
class TestLINKTO7(unittest.TestCase):
    """LINKTO7 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LINKTO7:
        """Test LINKTO7
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LINKTO7`
        """
        model = LINKTO7()
        if include_optional:
            return LINKTO7(
