...
class TestPrimaryCellPooledFromInner(unittest.TestCase):
    """PrimaryCellPooledFromInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PrimaryCellPooledFromInner:
        """Test PrimaryCellPooledFromInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrimaryCellPooledFromInner`
        """
        model = PrimaryCellPooledFromInner()
        if include_optional:
            return PrimaryCellPooledFromInner(
    ...
    def testPrimaryCellPooledFromInner(self):
        """Test PrimaryCellPooledFromInner"""
