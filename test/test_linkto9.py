...
class TestLINKTO9(unittest.TestCase):
    """LINKTO9 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LINKTO9:
        """Test LINKTO9
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LINKTO9`
        """
        model = LINKTO9()
        if include_optional:
            return LINKTO9(
