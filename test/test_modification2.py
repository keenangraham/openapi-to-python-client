...
class TestModification2(unittest.TestCase):
    """Modification2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Modification2:
        """Test Modification2
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Modification2`
        """
        model = Modification2()
        if include_optional:
