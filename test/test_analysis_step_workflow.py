...
class TestAnalysisStepWorkflow(unittest.TestCase):
    """AnalysisStepWorkflow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnalysisStepWorkflow:
        """Test AnalysisStepWorkflow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnalysisStepWorkflow`
        """
        model = AnalysisStepWorkflow()
        if include_optional:
            return AnalysisStepWorkflow(
    ...
    def testAnalysisStepWorkflow(self):
        """Test AnalysisStepWorkflow"""
