...
class TestLINKTO4(unittest.TestCase):
    """LINKTO4 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LINKTO4:
        """Test LINKTO4
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LINKTO4`
        """
        model = LINKTO4()
        if include_optional:
            return LINKTO4(
