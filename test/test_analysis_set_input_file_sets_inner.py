...
class TestAnalysisSetInputFileSetsInner(unittest.TestCase):
    """AnalysisSetInputFileSetsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnalysisSetInputFileSetsInner:
        """Test AnalysisSetInputFileSetsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnalysisSetInputFileSetsInner`
        """
        model = AnalysisSetInputFileSetsInner()
        if include_optional:
            return AnalysisSetInputFileSetsInner(
    ...
    def testAnalysisSetInputFileSetsInner(self):
        """Test AnalysisSetInputFileSetsInner"""
