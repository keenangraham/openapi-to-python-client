...
class TestIntegratedContentFilesInner(unittest.TestCase):
    """IntegratedContentFilesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IntegratedContentFilesInner:
        """Test IntegratedContentFilesInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IntegratedContentFilesInner`
        """
        model = IntegratedContentFilesInner()
        if include_optional:
            return IntegratedContentFilesInner(
                assembly = 'GRCh38',
    ...
    def testIntegratedContentFilesInner(self):
        """Test IntegratedContentFilesInner"""
