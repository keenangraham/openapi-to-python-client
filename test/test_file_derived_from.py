...
class TestFileDerivedFrom(unittest.TestCase):
    """FileDerivedFrom unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FileDerivedFrom:
        """Test FileDerivedFrom
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FileDerivedFrom`
        """
        model = FileDerivedFrom()
        if include_optional:
            return FileDerivedFrom(
