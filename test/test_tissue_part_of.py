...
class TestTissuePartOf(unittest.TestCase):
    """TissuePartOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TissuePartOf:
        """Test TissuePartOf
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TissuePartOf`
        """
        model = TissuePartOf()
        if include_optional:
            return TissuePartOf(
