...
class TestLINKTO22(unittest.TestCase):
    """LINKTO22 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LINKTO22:
        """Test LINKTO22
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LINKTO22`
        """
        model = LINKTO22()
        if include_optional:
            return LINKTO22(
