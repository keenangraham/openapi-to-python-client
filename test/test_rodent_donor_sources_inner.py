...
class TestRodentDonorSourcesInner(unittest.TestCase):
    """RodentDonorSourcesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RodentDonorSourcesInner:
        """Test RodentDonorSourcesInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RodentDonorSourcesInner`
        """
        model = RodentDonorSourcesInner()
        if include_optional:
            return RodentDonorSourcesInner(
                status = 'in progress',
                url = '',
                schema_version = '4',
                uuid = '',
    ...
    def testRodentDonorSourcesInner(self):
        """Test RodentDonorSourcesInner"""
