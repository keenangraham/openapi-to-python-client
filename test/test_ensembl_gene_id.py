...
class TestENSEMBLGeneID(unittest.TestCase):
    """ENSEMBLGeneID unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ENSEMBLGeneID:
        """Test ENSEMBLGeneID
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ENSEMBLGeneID`
        """
        model = ENSEMBLGeneID()
        if include_optional:
