...
class TestLINKTO43(unittest.TestCase):
    """LINKTO43 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LINKTO43:
        """Test LINKTO43
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LINKTO43`
        """
        model = LINKTO43()
        if include_optional:
            return LINKTO43(
