...
class TestPhenotypicFeature2(unittest.TestCase):
    """PhenotypicFeature2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PhenotypicFeature2:
        """Test PhenotypicFeature2
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PhenotypicFeature2`
        """
        model = PhenotypicFeature2()
        if include_optional:
            return PhenotypicFeature2(
    ...
    def testPhenotypicFeature2(self):
        """Test PhenotypicFeature2"""
