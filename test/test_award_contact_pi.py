...
class TestAwardContactPi(unittest.TestCase):
    """AwardContactPi unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AwardContactPi:
        """Test AwardContactPi
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AwardContactPi`
        """
        model = AwardContactPi()
        if include_optional:
            return AwardContactPi(
                status = 'current',
                schema_version = '5',
                uuid = '',
                notes = 'k',
