...
class TestLabSubmittableFor(unittest.TestCase):
    """LabSubmittableFor unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LabSubmittableFor:
        """Test LabSubmittableFor
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LabSubmittableFor`
        """
        model = LabSubmittableFor()
        if include_optional:
            return LabSubmittableFor(
                status = 'current',
                url = '',
                schema_version = '3',
                uuid = '',
    ...
    def testLabSubmittableFor(self):
        """Test LabSubmittableFor"""
