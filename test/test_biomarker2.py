...
class TestBiomarker2(unittest.TestCase):
    """Biomarker2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Biomarker2:
        """Test Biomarker2
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Biomarker2`
        """
        model = Biomarker2()
        if include_optional:
            return Biomarker2(
