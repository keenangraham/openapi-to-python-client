...
class TestTissuePooledFrom(unittest.TestCase):
    """TissuePooledFrom unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TissuePooledFrom:
        """Test TissuePooledFrom
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TissuePooledFrom`
        """
        model = TissuePooledFrom()
        if include_optional:
            return TissuePooledFrom(
