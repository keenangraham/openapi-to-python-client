...
class TestMeasurementSetControlFileSetsInner(unittest.TestCase):
    """MeasurementSetControlFileSetsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MeasurementSetControlFileSetsInner:
        """Test MeasurementSetControlFileSetsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MeasurementSetControlFileSetsInner`
        """
        model = MeasurementSetControlFileSetsInner()
        if include_optional:
            return MeasurementSetControlFileSetsInner(
    ...
    def testMeasurementSetControlFileSetsInner(self):
        """Test MeasurementSetControlFileSetsInner"""
