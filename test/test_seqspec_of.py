...
class TestSeqspecOf(unittest.TestCase):
    """SeqspecOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SeqspecOf:
        """Test SeqspecOf
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SeqspecOf`
        """
        model = SeqspecOf()
        if include_optional:
            return SeqspecOf(
