...
class TestAnalysisSetDonorsInner(unittest.TestCase):
    """AnalysisSetDonorsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnalysisSetDonorsInner:
        """Test AnalysisSetDonorsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnalysisSetDonorsInner`
        """
        model = AnalysisSetDonorsInner()
        if include_optional:
            return AnalysisSetDonorsInner(
    ...
    def testAnalysisSetDonorsInner(self):
        """Test AnalysisSetDonorsInner"""
