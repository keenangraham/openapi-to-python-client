...
class TestSampleTerm2(unittest.TestCase):
    """SampleTerm2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SampleTerm2:
        """Test SampleTerm2
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SampleTerm2`
        """
        model = SampleTerm2()
        if include_optional:
            return SampleTerm2(
