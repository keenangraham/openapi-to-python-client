...
**pooled_from** | [**List[LINKTO45]**](LINKTO45.md) | The biosamples this biosample is pooled from. | [optional] 
**part_of** | [**LINKTO46**](LINKTO46.md) |  | [optional] 
...
```python
from openapi_client.models.linkto45 import LINKTO45

# TODO update the JSON string below
json = "{}"
# create an instance of LINKTO45 from a JSON string
linkto45_instance = LINKTO45.from_json(json)
# print the JSON string representation of the object
print(LINKTO45.to_json())

# convert the object into a dict
linkto45_dict = linkto45_instance.to_dict()
# create an instance of LINKTO45 from a dict
linkto45_from_dict = LINKTO45.from_dict(linkto45_dict)
```
