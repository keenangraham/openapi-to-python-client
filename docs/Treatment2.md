...
A treatment applied to the biosample.
...
**documents** | [**List[Document2]**](Document2.md) | Documents that describe the treatment protocol details. | [optional] 
...
```python
from openapi_client.models.treatment2 import Treatment2

# TODO update the JSON string below
json = "{}"
# create an instance of Treatment2 from a JSON string
treatment2_instance = Treatment2.from_json(json)
# print the JSON string representation of the object
print(Treatment2.to_json())

# convert the object into a dict
treatment2_dict = treatment2_instance.to_dict()
# create an instance of Treatment2 from a dict
treatment2_from_dict = Treatment2.from_dict(treatment2_dict)
```
