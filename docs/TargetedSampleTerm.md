...
json = "{}"
# create an instance of TargetedSampleTerm from a JSON string
targeted_sample_term_instance = TargetedSampleTerm.from_json(json)
# print the JSON string representation of the object
print(TargetedSampleTerm.to_json())

# convert the object into a dict
targeted_sample_term_dict = targeted_sample_term_instance.to_dict()
# create an instance of TargetedSampleTerm from a dict
targeted_sample_term_from_dict = TargetedSampleTerm.from_dict(targeted_sample_term_dict)
```
