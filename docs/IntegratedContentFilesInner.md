...
json = "{}"
# create an instance of IntegratedContentFilesInner from a JSON string
integrated_content_files_inner_instance = IntegratedContentFilesInner.from_json(json)
# print the JSON string representation of the object
print(IntegratedContentFilesInner.to_json())

# convert the object into a dict
integrated_content_files_inner_dict = integrated_content_files_inner_instance.to_dict()
# create an instance of IntegratedContentFilesInner from a dict
integrated_content_files_inner_from_dict = IntegratedContentFilesInner.from_dict(integrated_content_files_inner_dict)
```
