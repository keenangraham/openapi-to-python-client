# igvf_client.PredictionSetsApi

All URIs are relative to *https://api.data.igvf.org*

Method | HTTP request | Description
------------- | ------------- | -------------
[**prediction_sets**](PredictionSetsApi.md#prediction_sets) | **GET** /prediction-sets/@@listing | List items in the PredictionSet collection.
...
with igvf_client.ApiClient(configuration) as api_client:
    ...
    api_instance = igvf_client.PredictionSetsApi(api_client)
    ...
    try:
        ...
        print("The response of PredictionSetsApi->prediction_sets:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PredictionSetsApi->prediction_sets: %s\n" % e)
```
