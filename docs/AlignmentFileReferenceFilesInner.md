# AlignmentFileReferenceFilesInner
...
**schema_version** | **str** | The version of the JSON schema that the server uses to validate the object. | [optional] [default to '14']
...
**content_type** | [**ContentType1**](ContentType1.md) |  | 
...
json = "{}"
# create an instance of AlignmentFileReferenceFilesInner from a JSON string
alignment_file_reference_files_inner_instance = AlignmentFileReferenceFilesInner.from_json(json)
# print the JSON string representation of the object
print(AlignmentFileReferenceFilesInner.to_json())

# convert the object into a dict
alignment_file_reference_files_inner_dict = alignment_file_reference_files_inner_instance.to_dict()
# create an instance of AlignmentFileReferenceFilesInner from a dict
alignment_file_reference_files_inner_from_dict = AlignmentFileReferenceFilesInner.from_dict(alignment_file_reference_files_inner_dict)
```
