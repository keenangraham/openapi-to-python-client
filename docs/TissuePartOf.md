...
json = "{}"
# create an instance of TissuePartOf from a JSON string
tissue_part_of_instance = TissuePartOf.from_json(json)
# print the JSON string representation of the object
print(TissuePartOf.to_json())

# convert the object into a dict
tissue_part_of_dict = tissue_part_of_instance.to_dict()
# create an instance of TissuePartOf from a dict
tissue_part_of_from_dict = TissuePartOf.from_dict(tissue_part_of_dict)
```
