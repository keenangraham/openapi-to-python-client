...
**phenotypic_features** | [**List[LINKTO10]**](LINKTO10.md) | A list of associated phenotypic features of the donor. | [optional] 
...
```python
from openapi_client.models.linkto11 import LINKTO11

# TODO update the JSON string below
json = "{}"
# create an instance of LINKTO11 from a JSON string
linkto11_instance = LINKTO11.from_json(json)
# print the JSON string representation of the object
print(LINKTO11.to_json())

# convert the object into a dict
linkto11_dict = linkto11_instance.to_dict()
# create an instance of LINKTO11 from a dict
linkto11_from_dict = LINKTO11.from_dict(linkto11_dict)
```
