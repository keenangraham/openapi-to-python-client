...
json = "{}"
# create an instance of InputFileSet from a JSON string
input_file_set_instance = InputFileSet.from_json(json)
# print the JSON string representation of the object
print(InputFileSet.to_json())

# convert the object into a dict
input_file_set_dict = input_file_set_instance.to_dict()
# create an instance of InputFileSet from a dict
input_file_set_from_dict = InputFileSet.from_dict(input_file_set_dict)
```
