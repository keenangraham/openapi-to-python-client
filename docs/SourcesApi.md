# igvf_client.SourcesApi

All URIs are relative to *https://api.data.igvf.org*

Method | HTTP request | Description
------------- | ------------- | -------------
[**sources**](SourcesApi.md#sources) | **GET** /sources/@@listing | List items in the Source collection.
...
with igvf_client.ApiClient(configuration) as api_client:
    ...
    api_instance = igvf_client.SourcesApi(api_client)
    ...
    try:
        ...
        print("The response of SourcesApi->sources:\n")
        pprint(api_response)
