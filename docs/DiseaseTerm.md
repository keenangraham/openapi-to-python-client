...
json = "{}"
# create an instance of DiseaseTerm from a JSON string
disease_term_instance = DiseaseTerm.from_json(json)
# print the JSON string representation of the object
print(DiseaseTerm.to_json())

# convert the object into a dict
disease_term_dict = disease_term_instance.to_dict()
# create an instance of DiseaseTerm from a dict
disease_term_from_dict = DiseaseTerm.from_dict(disease_term_dict)
```
