...
```python
from openapi_client.models.linkto33 import LINKTO33

# TODO update the JSON string below
json = "{}"
# create an instance of LINKTO33 from a JSON string
linkto33_instance = LINKTO33.from_json(json)
# print the JSON string representation of the object
print(LINKTO33.to_json())

# convert the object into a dict
linkto33_dict = linkto33_instance.to_dict()
# create an instance of LINKTO33 from a dict
linkto33_from_dict = LINKTO33.from_dict(linkto33_dict)
```
