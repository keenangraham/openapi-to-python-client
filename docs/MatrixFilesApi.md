# igvf_client.MatrixFilesApi

All URIs are relative to *https://api.data.igvf.org*

Method | HTTP request | Description
------------- | ------------- | -------------
[**matrix_files**](MatrixFilesApi.md#matrix_files) | **GET** /matrix-files/@@listing | List items in the MatrixFile collection.
...
with igvf_client.ApiClient(configuration) as api_client:
    ...
    api_instance = igvf_client.MatrixFilesApi(api_client)
    ...
    try:
        ...
        print("The response of MatrixFilesApi->matrix_files:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MatrixFilesApi->matrix_files: %s\n" % e)
```
