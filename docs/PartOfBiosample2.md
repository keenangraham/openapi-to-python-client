...
json = "{}"
# create an instance of PartOfBiosample2 from a JSON string
part_of_biosample2_instance = PartOfBiosample2.from_json(json)
# print the JSON string representation of the object
print(PartOfBiosample2.to_json())

# convert the object into a dict
part_of_biosample2_dict = part_of_biosample2_instance.to_dict()
# create an instance of PartOfBiosample2 from a dict
part_of_biosample2_from_dict = PartOfBiosample2.from_dict(part_of_biosample2_dict)
```
