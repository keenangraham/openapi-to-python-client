...
json = "{}"
# create an instance of DocumentLab from a JSON string
document_lab_instance = DocumentLab.from_json(json)
# print the JSON string representation of the object
print(DocumentLab.to_json())

# convert the object into a dict
document_lab_dict = document_lab_instance.to_dict()
# create an instance of DocumentLab from a dict
document_lab_from_dict = DocumentLab.from_dict(document_lab_dict)
```
