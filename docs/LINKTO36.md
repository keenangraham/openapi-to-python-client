...
```python
from openapi_client.models.linkto36 import LINKTO36

# TODO update the JSON string below
json = "{}"
# create an instance of LINKTO36 from a JSON string
linkto36_instance = LINKTO36.from_json(json)
# print the JSON string representation of the object
print(LINKTO36.to_json())

# convert the object into a dict
linkto36_dict = linkto36_instance.to_dict()
# create an instance of LINKTO36 from a dict
linkto36_from_dict = LINKTO36.from_dict(linkto36_dict)
```
