# igvf_client.TechnicalSamplesApi

All URIs are relative to *https://api.data.igvf.org*

Method | HTTP request | Description
------------- | ------------- | -------------
[**technical_samples**](TechnicalSamplesApi.md#technical_samples) | **GET** /technical-samples/@@listing | List items in the TechnicalSample collection.
...
with igvf_client.ApiClient(configuration) as api_client:
    ...
    api_instance = igvf_client.TechnicalSamplesApi(api_client)
    ...
    try:
        ...
        print("The response of TechnicalSamplesApi->technical_samples:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TechnicalSamplesApi->technical_samples: %s\n" % e)
```
