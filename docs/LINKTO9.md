...
```python
from openapi_client.models.linkto9 import LINKTO9

# TODO update the JSON string below
json = "{}"
# create an instance of LINKTO9 from a JSON string
linkto9_instance = LINKTO9.from_json(json)
# print the JSON string representation of the object
print(LINKTO9.to_json())

# convert the object into a dict
linkto9_dict = linkto9_instance.to_dict()
# create an instance of LINKTO9 from a dict
linkto9_from_dict = LINKTO9.from_dict(linkto9_dict)
```
