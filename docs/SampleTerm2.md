...
Ontology term identifying a technical sample.
...
```python
from openapi_client.models.sample_term2 import SampleTerm2

# TODO update the JSON string below
json = "{}"
# create an instance of SampleTerm2 from a JSON string
sample_term2_instance = SampleTerm2.from_json(json)
# print the JSON string representation of the object
print(SampleTerm2.to_json())

# convert the object into a dict
sample_term2_dict = sample_term2_instance.to_dict()
# create an instance of SampleTerm2 from a dict
sample_term2_from_dict = SampleTerm2.from_dict(sample_term2_dict)
```
