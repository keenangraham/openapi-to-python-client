...
**summary** | **str** | A summary of the configuration file. | [optional] 
...
configuration_file_instance = ConfigurationFile.from_json(json)
# print the JSON string representation of the object
print(ConfigurationFile.to_json())

# convert the object into a dict
configuration_file_dict = configuration_file_instance.to_dict()
# create an instance of ConfigurationFile from a dict
configuration_file_from_dict = ConfigurationFile.from_dict(configuration_file_dict)
```
