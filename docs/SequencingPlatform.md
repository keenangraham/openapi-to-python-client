...
json = "{}"
# create an instance of SequencingPlatform from a JSON string
sequencing_platform_instance = SequencingPlatform.from_json(json)
# print the JSON string representation of the object
print(SequencingPlatform.to_json())

# convert the object into a dict
sequencing_platform_dict = sequencing_platform_instance.to_dict()
# create an instance of SequencingPlatform from a dict
sequencing_platform_from_dict = SequencingPlatform.from_dict(sequencing_platform_dict)
```
