...
json = "{}"
# create an instance of Treatment1 from a JSON string
treatment1_instance = Treatment1.from_json(json)
# print the JSON string representation of the object
print(Treatment1.to_json())

# convert the object into a dict
treatment1_dict = treatment1_instance.to_dict()
# create an instance of Treatment1 from a dict
treatment1_from_dict = Treatment1.from_dict(treatment1_dict)
```
