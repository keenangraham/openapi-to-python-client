...
```python
from openapi_client.models.award_contact_pi import AwardContactPi

# TODO update the JSON string below
json = "{}"
# create an instance of AwardContactPi from a JSON string
award_contact_pi_instance = AwardContactPi.from_json(json)
# print the JSON string representation of the object
print(AwardContactPi.to_json())

# convert the object into a dict
award_contact_pi_dict = award_contact_pi_instance.to_dict()
# create an instance of AwardContactPi from a dict
award_contact_pi_from_dict = AwardContactPi.from_dict(award_contact_pi_dict)
```
