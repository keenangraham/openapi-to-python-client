...
A file set that serves as input for the derivation of this model set.
...
**lab** | [**OneOfLabstring**](OneOfLabstring.md) | Lab associated with the submission. | 
**award** | [**OneOfAwardstring**](OneOfAwardstring.md) | Grant associated with the submission. | 
...
**submitted_by** | [**OneOfUserstring**](OneOfUserstring.md) | The user who submitted the object. | [optional] 
...
**input_file_sets** | [**List[InputFileSet1]**](InputFileSet1.md) | The file set(s) that served as inputs for the derivation of this model set. | [optional] 
**id** | **str** |  | [optional] 
...
**library_construction_platform** | [**LibraryConstructionPlatform1**](LibraryConstructionPlatform1.md) |  | [optional] 
