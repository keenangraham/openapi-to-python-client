...
**documents** | [**List[LINKTO13]**](LINKTO13.md) | Documents that describe the treatment protocol details. | [optional] 
...
```python
from openapi_client.models.linkto37 import LINKTO37

# TODO update the JSON string below
json = "{}"
# create an instance of LINKTO37 from a JSON string
linkto37_instance = LINKTO37.from_json(json)
# print the JSON string representation of the object
print(LINKTO37.to_json())

# convert the object into a dict
linkto37_dict = linkto37_instance.to_dict()
# create an instance of LINKTO37 from a dict
linkto37_from_dict = LINKTO37.from_dict(linkto37_dict)
```
