...
```python
from openapi_client.models.analysis_set_input_file_sets_inner import AnalysisSetInputFileSetsInner

# TODO update the JSON string below
json = "{}"
# create an instance of AnalysisSetInputFileSetsInner from a JSON string
analysis_set_input_file_sets_inner_instance = AnalysisSetInputFileSetsInner.from_json(json)
# print the JSON string representation of the object
print(AnalysisSetInputFileSetsInner.to_json())

# convert the object into a dict
analysis_set_input_file_sets_inner_dict = analysis_set_input_file_sets_inner_instance.to_dict()
# create an instance of AnalysisSetInputFileSetsInner from a dict
analysis_set_input_file_sets_inner_from_dict = AnalysisSetInputFileSetsInner.from_dict(analysis_set_input_file_sets_inner_dict)
```
