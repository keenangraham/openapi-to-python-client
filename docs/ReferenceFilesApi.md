# igvf_client.ReferenceFilesApi

All URIs are relative to *https://api.data.igvf.org*

Method | HTTP request | Description
------------- | ------------- | -------------
[**reference_files**](ReferenceFilesApi.md#reference_files) | **GET** /reference-files/@@listing | List items in the ReferenceFile collection.
...
with igvf_client.ApiClient(configuration) as api_client:
    ...
    api_instance = igvf_client.ReferenceFilesApi(api_client)
    ...
    try:
        ...
        print("The response of ReferenceFilesApi->reference_files:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ReferenceFilesApi->reference_files: %s\n" % e)
```
