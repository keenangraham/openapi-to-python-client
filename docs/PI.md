...
json = "{}"
# create an instance of PI from a JSON string
pi_instance = PI.from_json(json)
# print the JSON string representation of the object
print(PI.to_json())

# convert the object into a dict
pi_dict = pi_instance.to_dict()
# create an instance of PI from a dict
pi_from_dict = PI.from_dict(pi_dict)
```
