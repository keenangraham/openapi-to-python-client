...
```python
from openapi_client.models.linkto22 import LINKTO22

# TODO update the JSON string below
json = "{}"
# create an instance of LINKTO22 from a JSON string
linkto22_instance = LINKTO22.from_json(json)
# print the JSON string representation of the object
print(LINKTO22.to_json())

# convert the object into a dict
linkto22_dict = linkto22_instance.to_dict()
# create an instance of LINKTO22 from a dict
linkto22_from_dict = LINKTO22.from_dict(linkto22_dict)
```
