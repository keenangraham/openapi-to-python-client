...
json = "{}"
# create an instance of PartOfBiosample1 from a JSON string
part_of_biosample1_instance = PartOfBiosample1.from_json(json)
# print the JSON string representation of the object
print(PartOfBiosample1.to_json())

# convert the object into a dict
part_of_biosample1_dict = part_of_biosample1_instance.to_dict()
# create an instance of PartOfBiosample1 from a dict
part_of_biosample1_from_dict = PartOfBiosample1.from_dict(part_of_biosample1_dict)
```
