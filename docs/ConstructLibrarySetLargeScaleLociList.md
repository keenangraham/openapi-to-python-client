# ConstructLibrarySetLargeScaleLociList
...
json = "{}"
# create an instance of ConstructLibrarySetLargeScaleLociList from a JSON string
construct_library_set_large_scale_loci_list_instance = ConstructLibrarySetLargeScaleLociList.from_json(json)
# print the JSON string representation of the object
print(ConstructLibrarySetLargeScaleLociList.to_json())

# convert the object into a dict
construct_library_set_large_scale_loci_list_dict = construct_library_set_large_scale_loci_list_instance.to_dict()
# create an instance of ConstructLibrarySetLargeScaleLociList from a dict
construct_library_set_large_scale_loci_list_from_dict = ConstructLibrarySetLargeScaleLociList.from_dict(construct_library_set_large_scale_loci_list_dict)
```
