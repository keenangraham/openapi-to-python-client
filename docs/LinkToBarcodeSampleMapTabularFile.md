# LinkToBarcodeSampleMapTabularFile
...
json = "{}"
# create an instance of LinkToBarcodeSampleMapTabularFile from a JSON string
link_to_barcode_sample_map_tabular_file_instance = LinkToBarcodeSampleMapTabularFile.from_json(json)
# print the JSON string representation of the object
print(LinkToBarcodeSampleMapTabularFile.to_json())

# convert the object into a dict
link_to_barcode_sample_map_tabular_file_dict = link_to_barcode_sample_map_tabular_file_instance.to_dict()
# create an instance of LinkToBarcodeSampleMapTabularFile from a dict
link_to_barcode_sample_map_tabular_file_from_dict = LinkToBarcodeSampleMapTabularFile.from_dict(link_to_barcode_sample_map_tabular_file_dict)
```
