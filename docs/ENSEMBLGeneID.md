...
json = "{}"
# create an instance of ENSEMBLGeneID from a JSON string
ensembl_gene_id_instance = ENSEMBLGeneID.from_json(json)
# print the JSON string representation of the object
print(ENSEMBLGeneID.to_json())

# convert the object into a dict
ensembl_gene_id_dict = ensembl_gene_id_instance.to_dict()
# create an instance of ENSEMBLGeneID from a dict
ensembl_gene_id_from_dict = ENSEMBLGeneID.from_dict(ensembl_gene_id_dict)
```
