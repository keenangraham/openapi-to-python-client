# igvf_client.ConfigurationFilesApi
...
with igvf_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ConfigurationFilesApi->configuration_files:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ConfigurationFilesApi->configuration_files: %s\n" % e)
```
