...
```python
from openapi_client.models.linkto28 import LINKTO28

# TODO update the JSON string below
json = "{}"
# create an instance of LINKTO28 from a JSON string
linkto28_instance = LINKTO28.from_json(json)
# print the JSON string representation of the object
print(LINKTO28.to_json())

# convert the object into a dict
linkto28_dict = linkto28_instance.to_dict()
# create an instance of LINKTO28 from a dict
linkto28_from_dict = LINKTO28.from_dict(linkto28_dict)
```
