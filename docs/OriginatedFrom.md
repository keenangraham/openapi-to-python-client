...
json = "{}"
# create an instance of OriginatedFrom from a JSON string
originated_from_instance = OriginatedFrom.from_json(json)
# print the JSON string representation of the object
print(OriginatedFrom.to_json())

# convert the object into a dict
originated_from_dict = originated_from_instance.to_dict()
# create an instance of OriginatedFrom from a dict
originated_from_from_dict = OriginatedFrom.from_dict(originated_from_dict)
```
