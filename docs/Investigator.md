...
json = "{}"
# create an instance of Investigator from a JSON string
investigator_instance = Investigator.from_json(json)
# print the JSON string representation of the object
print(Investigator.to_json())

# convert the object into a dict
investigator_dict = investigator_instance.to_dict()
# create an instance of Investigator from a dict
investigator_from_dict = Investigator.from_dict(investigator_dict)
```
