# igvf_client.ImageFilesApi

All URIs are relative to *https://api.data.igvf.org*

Method | HTTP request | Description
------------- | ------------- | -------------
[**image_files**](ImageFilesApi.md#image_files) | **GET** /image-files/@@listing | List items in the ImageFile collection.
...
with igvf_client.ApiClient(configuration) as api_client:
    ...
    api_instance = igvf_client.ImageFilesApi(api_client)
    ...
    try:
        ...
        print("The response of ImageFilesApi->image_files:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ImageFilesApi->image_files: %s\n" % e)
```
