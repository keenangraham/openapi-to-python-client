...
json = "{}"
# create an instance of SeqspecOf from a JSON string
seqspec_of_instance = SeqspecOf.from_json(json)
# print the JSON string representation of the object
print(SeqspecOf.to_json())

# convert the object into a dict
seqspec_of_dict = seqspec_of_instance.to_dict()
# create an instance of SeqspecOf from a dict
seqspec_of_from_dict = SeqspecOf.from_dict(seqspec_of_dict)
```
