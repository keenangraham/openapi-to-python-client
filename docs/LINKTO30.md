...
**samples** | [**List[LINKTO20]**](LINKTO20.md) | The sample(s) associated with this file set. | 
**donors** | [**List[LINKTO21]**](LINKTO21.md) | The donors of the samples associated with this measurement set. | [optional] 
**file_set_type** | **str** | The category that best describes this measurement set. | [default to 'experimental data']
**assay_term** | [**LINKTO28**](LINKTO28.md) |  | 
**library_construction_platform** | [**LINKTO19**](LINKTO19.md) |  | [optional] 
...
**control_file_sets** | [**List[LINKTO17]**](LINKTO17.md) | File sets that can serve as scientific controls for this measurement_set. | [optional] 
**sequencing_library_types** | **List[str]** | Description of the libraries sequenced in this measurement set. | [optional] 
**auxiliary_sets** | [**List[LINKTO29]**](LINKTO29.md) | The auxiliary sets of files produced alongside raw data from this measurement set. | [optional] 
...
**related_multiome_datasets** | [**List[LINKTO30]**](LINKTO30.md) | Related datasets included in the multiome experiment this measurement set is a part of. | [optional] 

## Example

```python
from openapi_client.models.linkto30 import LINKTO30

# TODO update the JSON string below
json = "{}"
# create an instance of LINKTO30 from a JSON string
linkto30_instance = LINKTO30.from_json(json)
# print the JSON string representation of the object
print(LINKTO30.to_json())

# convert the object into a dict
linkto30_dict = linkto30_instance.to_dict()
# create an instance of LINKTO30 from a dict
linkto30_from_dict = LINKTO30.from_dict(linkto30_dict)
```
