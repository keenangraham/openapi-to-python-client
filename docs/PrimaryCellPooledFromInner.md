...
**pooled_from** | [**List[PrimaryCellPooledFromInner]**](PrimaryCellPooledFromInner.md) | The biosamples this biosample is pooled from. | [optional] 
**part_of** | [**PrimaryCellPartOf**](PrimaryCellPartOf.md) |  | [optional] 
...
json = "{}"
# create an instance of PrimaryCellPooledFromInner from a JSON string
primary_cell_pooled_from_inner_instance = PrimaryCellPooledFromInner.from_json(json)
# print the JSON string representation of the object
print(PrimaryCellPooledFromInner.to_json())

# convert the object into a dict
primary_cell_pooled_from_inner_dict = primary_cell_pooled_from_inner_instance.to_dict()
# create an instance of PrimaryCellPooledFromInner from a dict
primary_cell_pooled_from_inner_from_dict = PrimaryCellPooledFromInner.from_dict(primary_cell_pooled_from_inner_dict)
```
