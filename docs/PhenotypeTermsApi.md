# igvf_client.PhenotypeTermsApi

All URIs are relative to *https://api.data.igvf.org*

Method | HTTP request | Description
------------- | ------------- | -------------
[**phenotype_terms**](PhenotypeTermsApi.md#phenotype_terms) | **GET** /phenotype-terms/@@listing | List items in the PhenotypeTerm collection.
...
with igvf_client.ApiClient(configuration) as api_client:
    ...
    api_instance = igvf_client.PhenotypeTermsApi(api_client)
    ...
    try:
        ...
        print("The response of PhenotypeTermsApi->phenotype_terms:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PhenotypeTermsApi->phenotype_terms: %s\n" % e)
```
