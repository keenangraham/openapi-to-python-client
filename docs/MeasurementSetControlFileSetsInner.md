# MeasurementSetControlFileSetsInner
...
**input_file_sets** | [**List[AnalysisSetInputFileSetsInner]**](AnalysisSetInputFileSetsInner.md) | The file set(s) that served as inputs for the derivation of this model set. | [optional] 
**id** | **str** |  | [optional] 
...
**library_construction_platform** | [**AuxiliarySetLibraryConstructionPlatform**](AuxiliarySetLibraryConstructionPlatform.md) |  | [optional] 
...
**control_file_sets** | [**List[MeasurementSetControlFileSetsInner]**](MeasurementSetControlFileSetsInner.md) | File sets that can serve as scientific controls for this measurement_set. | [optional] 
...
```python
from openapi_client.models.measurement_set_control_file_sets_inner import MeasurementSetControlFileSetsInner

# TODO update the JSON string below
json = "{}"
# create an instance of MeasurementSetControlFileSetsInner from a JSON string
measurement_set_control_file_sets_inner_instance = MeasurementSetControlFileSetsInner.from_json(json)
# print the JSON string representation of the object
print(MeasurementSetControlFileSetsInner.to_json())

# convert the object into a dict
measurement_set_control_file_sets_inner_dict = measurement_set_control_file_sets_inner_instance.to_dict()
# create an instance of MeasurementSetControlFileSetsInner from a dict
measurement_set_control_file_sets_inner_from_dict = MeasurementSetControlFileSetsInner.from_dict(measurement_set_control_file_sets_inner_dict)
```
