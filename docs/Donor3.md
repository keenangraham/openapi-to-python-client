...
Donor of a sample associated with this measurement set.
...
```python
from openapi_client.models.donor3 import Donor3

# TODO update the JSON string below
json = "{}"
# create an instance of Donor3 from a JSON string
donor3_instance = Donor3.from_json(json)
# print the JSON string representation of the object
print(Donor3.to_json())

# convert the object into a dict
donor3_dict = donor3_instance.to_dict()
# create an instance of Donor3 from a dict
donor3_from_dict = Donor3.from_dict(donor3_dict)
```
