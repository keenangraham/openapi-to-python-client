...
```python
from openapi_client.models.donor4 import Donor4

# TODO update the JSON string below
json = "{}"
# create an instance of Donor4 from a JSON string
donor4_instance = Donor4.from_json(json)
# print the JSON string representation of the object
print(Donor4.to_json())

# convert the object into a dict
donor4_dict = donor4_instance.to_dict()
# create an instance of Donor4 from a dict
donor4_from_dict = Donor4.from_dict(donor4_dict)
```
