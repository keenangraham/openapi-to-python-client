# igvf_client.AuxiliarySetsApi

All URIs are relative to *https://api.data.igvf.org*

Method | HTTP request | Description
------------- | ------------- | -------------
[**auxiliary_sets**](AuxiliarySetsApi.md#auxiliary_sets) | **GET** /auxiliary-sets/@@listing | List items in the AuxiliarySet collection.
...
with igvf_client.ApiClient(configuration) as api_client:
    ...
    api_instance = igvf_client.AuxiliarySetsApi(api_client)
    ...
    try:
        ...
        print("The response of AuxiliarySetsApi->auxiliary_sets:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AuxiliarySetsApi->auxiliary_sets: %s\n" % e)
```
