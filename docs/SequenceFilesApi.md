# igvf_client.SequenceFilesApi

All URIs are relative to *https://api.data.igvf.org*

Method | HTTP request | Description
------------- | ------------- | -------------
[**sequence_files**](SequenceFilesApi.md#sequence_files) | **GET** /sequence-files/@@listing | List items in the SequenceFile collection.
...
with igvf_client.ApiClient(configuration) as api_client:
    ...
    api_instance = igvf_client.SequenceFilesApi(api_client)
    ...
    try:
        ...
        print("The response of SequenceFilesApi->sequence_files:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SequenceFilesApi->sequence_files: %s\n" % e)
```
