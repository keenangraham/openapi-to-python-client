...
**phenotypic_features** | [**List[LINKTO14]**](LINKTO14.md) | A list of associated phenotypic features of the donor. | [optional] 
...
```python
from openapi_client.models.linkto21 import LINKTO21

# TODO update the JSON string below
json = "{}"
# create an instance of LINKTO21 from a JSON string
linkto21_instance = LINKTO21.from_json(json)
# print the JSON string representation of the object
print(LINKTO21.to_json())

# convert the object into a dict
linkto21_dict = linkto21_instance.to_dict()
# create an instance of LINKTO21 from a dict
linkto21_from_dict = LINKTO21.from_dict(linkto21_dict)
```
