...
json = "{}"
# create an instance of Award2 from a JSON string
award2_instance = Award2.from_json(json)
# print the JSON string representation of the object
print(Award2.to_json())

# convert the object into a dict
award2_dict = award2_instance.to_dict()
# create an instance of Award2 from a dict
award2_from_dict = Award2.from_dict(award2_dict)
```
