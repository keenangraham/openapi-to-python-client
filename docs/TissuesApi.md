# igvf_client.TissuesApi

All URIs are relative to *https://api.data.igvf.org*

Method | HTTP request | Description
------------- | ------------- | -------------
[**tissues**](TissuesApi.md#tissues) | **GET** /tissues/@@listing | List items in the Tissue collection.
...
with igvf_client.ApiClient(configuration) as api_client:
    ...
    api_instance = igvf_client.TissuesApi(api_client)
    ...
    try:
        ...
        print("The response of TissuesApi->tissues:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TissuesApi->tissues: %s\n" % e)
```
