...
**documents** | [**List[RodentDonorDocumentsInner]**](RodentDonorDocumentsInner.md) | Documents that describe the treatment protocol details. | [optional] 
...
json = "{}"
# create an instance of InVitroSystemTreatmentsInner from a JSON string
in_vitro_system_treatments_inner_instance = InVitroSystemTreatmentsInner.from_json(json)
# print the JSON string representation of the object
print(InVitroSystemTreatmentsInner.to_json())

# convert the object into a dict
in_vitro_system_treatments_inner_dict = in_vitro_system_treatments_inner_instance.to_dict()
# create an instance of InVitroSystemTreatmentsInner from a dict
in_vitro_system_treatments_inner_from_dict = InVitroSystemTreatmentsInner.from_dict(in_vitro_system_treatments_inner_dict)
```
