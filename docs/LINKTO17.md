...
**input_file_sets** | [**List[LINKTO17]**](LINKTO17.md) | The file set(s) that served as inputs for the derivation of this model set. | [optional] 
**id** | **str** |  | [optional] 
...
**software_version** | [**LINKTO31**](LINKTO31.md) |  | 

## Example

```python
from openapi_client.models.linkto17 import LINKTO17

# TODO update the JSON string below
json = "{}"
# create an instance of LINKTO17 from a JSON string
linkto17_instance = LINKTO17.from_json(json)
# print the JSON string representation of the object
print(LINKTO17.to_json())

# convert the object into a dict
linkto17_dict = linkto17_instance.to_dict()
# create an instance of LINKTO17 from a dict
linkto17_from_dict = LINKTO17.from_dict(linkto17_dict)
```
