...
json = "{}"
# create an instance of Lab1 from a JSON string
lab1_instance = Lab1.from_json(json)
# print the JSON string representation of the object
print(Lab1.to_json())

# convert the object into a dict
lab1_dict = lab1_instance.to_dict()
# create an instance of Lab1 from a dict
lab1_from_dict = Lab1.from_dict(lab1_dict)
```
