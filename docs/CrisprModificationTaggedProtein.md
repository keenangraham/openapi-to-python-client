# CrisprModificationTaggedProtein
...
```python
from openapi_client.models.crispr_modification_tagged_protein import CrisprModificationTaggedProtein

# TODO update the JSON string below
json = "{}"
# create an instance of CrisprModificationTaggedProtein from a JSON string
crispr_modification_tagged_protein_instance = CrisprModificationTaggedProtein.from_json(json)
# print the JSON string representation of the object
print(CrisprModificationTaggedProtein.to_json())

# convert the object into a dict
crispr_modification_tagged_protein_dict = crispr_modification_tagged_protein_instance.to_dict()
# create an instance of CrisprModificationTaggedProtein from a dict
crispr_modification_tagged_protein_from_dict = CrisprModificationTaggedProtein.from_dict(crispr_modification_tagged_protein_dict)
```
