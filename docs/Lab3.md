...
```python
from openapi_client.models.lab3 import Lab3

# TODO update the JSON string below
json = "{}"
# create an instance of Lab3 from a JSON string
lab3_instance = Lab3.from_json(json)
# print the JSON string representation of the object
print(Lab3.to_json())

# convert the object into a dict
lab3_dict = lab3_instance.to_dict()
# create an instance of Lab3 from a dict
lab3_from_dict = Lab3.from_dict(lab3_dict)
```
