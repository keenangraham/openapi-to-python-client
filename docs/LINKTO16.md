...
```python
from openapi_client.models.linkto16 import LINKTO16

# TODO update the JSON string below
json = "{}"
# create an instance of LINKTO16 from a JSON string
linkto16_instance = LINKTO16.from_json(json)
# print the JSON string representation of the object
print(LINKTO16.to_json())

# convert the object into a dict
linkto16_dict = linkto16_instance.to_dict()
# create an instance of LINKTO16 from a dict
linkto16_from_dict = LINKTO16.from_dict(linkto16_dict)
```
