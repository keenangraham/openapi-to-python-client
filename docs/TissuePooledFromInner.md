...
json = "{}"
# create an instance of TissuePooledFromInner from a JSON string
tissue_pooled_from_inner_instance = TissuePooledFromInner.from_json(json)
# print the JSON string representation of the object
print(TissuePooledFromInner.to_json())

# convert the object into a dict
tissue_pooled_from_inner_dict = tissue_pooled_from_inner_instance.to_dict()
# create an instance of TissuePooledFromInner from a dict
tissue_pooled_from_inner_from_dict = TissuePooledFromInner.from_dict(tissue_pooled_from_inner_dict)
```
