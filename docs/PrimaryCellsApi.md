# igvf_client.PrimaryCellsApi

All URIs are relative to *https://api.data.igvf.org*

Method | HTTP request | Description
------------- | ------------- | -------------
[**primary_cells**](PrimaryCellsApi.md#primary_cells) | **GET** /primary-cells/@@listing | List items in the PrimaryCell collection.
...
with igvf_client.ApiClient(configuration) as api_client:
    ...
    api_instance = igvf_client.PrimaryCellsApi(api_client)
    ...
    try:
        ...
        print("The response of PrimaryCellsApi->primary_cells:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PrimaryCellsApi->primary_cells: %s\n" % e)
```
