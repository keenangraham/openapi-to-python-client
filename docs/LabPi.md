...
```python
from openapi_client.models.lab_pi import LabPi

# TODO update the JSON string below
json = "{}"
# create an instance of LabPi from a JSON string
lab_pi_instance = LabPi.from_json(json)
# print the JSON string representation of the object
print(LabPi.to_json())

# convert the object into a dict
lab_pi_dict = lab_pi_instance.to_dict()
# create an instance of LabPi from a dict
lab_pi_from_dict = LabPi.from_dict(lab_pi_dict)
```
