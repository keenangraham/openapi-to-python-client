...
```python
from openapi_client.models.in_vitro_system_part_of import InVitroSystemPartOf

# TODO update the JSON string below
json = "{}"
# create an instance of InVitroSystemPartOf from a JSON string
in_vitro_system_part_of_instance = InVitroSystemPartOf.from_json(json)
# print the JSON string representation of the object
print(InVitroSystemPartOf.to_json())

# convert the object into a dict
in_vitro_system_part_of_dict = in_vitro_system_part_of_instance.to_dict()
# create an instance of InVitroSystemPartOf from a dict
in_vitro_system_part_of_from_dict = InVitroSystemPartOf.from_dict(in_vitro_system_part_of_dict)
```
