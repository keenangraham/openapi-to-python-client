...
json = "{}"
# create an instance of InVitroSystemSampleTermsInner from a JSON string
in_vitro_system_sample_terms_inner_instance = InVitroSystemSampleTermsInner.from_json(json)
# print the JSON string representation of the object
print(InVitroSystemSampleTermsInner.to_json())

# convert the object into a dict
in_vitro_system_sample_terms_inner_dict = in_vitro_system_sample_terms_inner_instance.to_dict()
# create an instance of InVitroSystemSampleTermsInner from a dict
in_vitro_system_sample_terms_inner_from_dict = InVitroSystemSampleTermsInner.from_dict(in_vitro_system_sample_terms_inner_dict)
```
