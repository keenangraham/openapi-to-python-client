...
primary_cell_instance = PrimaryCell.from_json(json)
# print the JSON string representation of the object
print(PrimaryCell.to_json())

# convert the object into a dict
primary_cell_dict = primary_cell_instance.to_dict()
# create an instance of PrimaryCell from a dict
primary_cell_from_dict = PrimaryCell.from_dict(primary_cell_dict)
```
