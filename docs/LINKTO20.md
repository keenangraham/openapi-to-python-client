...
**sample_terms** | [**List[LINKTO35]**](LINKTO35.md) | Ontology terms identifying a biosample. | [default to [25d5ad53-15fd-4a44-878a-ece2f7e86509]]
...
**multiplexed_samples** | [**List[LINKTO20]**](LINKTO20.md) | The samples multiplexed together to produce this sample. | 
**barcode_sample_map** | [**LINKTO42**](LINKTO42.md) |  | [optional] 
...
```python
from openapi_client.models.linkto20 import LINKTO20

# TODO update the JSON string below
json = "{}"
# create an instance of LINKTO20 from a JSON string
linkto20_instance = LINKTO20.from_json(json)
# print the JSON string representation of the object
print(LINKTO20.to_json())

# convert the object into a dict
linkto20_dict = linkto20_instance.to_dict()
# create an instance of LINKTO20 from a dict
linkto20_from_dict = LINKTO20.from_dict(linkto20_dict)
```
