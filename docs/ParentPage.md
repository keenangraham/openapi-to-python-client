...
json = "{}"
# create an instance of ParentPage from a JSON string
parent_page_instance = ParentPage.from_json(json)
# print the JSON string representation of the object
print(ParentPage.to_json())

# convert the object into a dict
parent_page_dict = parent_page_instance.to_dict()
# create an instance of ParentPage from a dict
parent_page_from_dict = ParentPage.from_dict(parent_page_dict)
```
