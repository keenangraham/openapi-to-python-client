...
**donors** | [**List[Donor]**](Donor.md) | The donors of the samples associated with this analysis set. | [optional] 
...
**input_file_sets** | [**List[InputFileSet]**](InputFileSet.md) | The file set(s) required for this analysis. | [optional] 
**id** | **str** |  | [optional] 
