...
**donors** | [**List[Donor4]**](Donor4.md) | Donor(s) the sample was derived from. | 
...
**cell_fate_change_treatments** | [**List[Treatment2]**](Treatment2.md) | A list of treatments applied to the biosample with the purpose of differentiation, dedifferentiation, or reprogramming. | [optional] 
...
json = "{}"
# create an instance of Sample1 from a JSON string
sample1_instance = Sample1.from_json(json)
# print the JSON string representation of the object
print(Sample1.to_json())

# convert the object into a dict
sample1_dict = sample1_instance.to_dict()
# create an instance of Sample1 from a dict
sample1_from_dict = Sample1.from_dict(sample1_dict)
```
