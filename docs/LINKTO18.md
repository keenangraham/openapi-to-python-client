...
```python
from openapi_client.models.linkto18 import LINKTO18

# TODO update the JSON string below
json = "{}"
# create an instance of LINKTO18 from a JSON string
linkto18_instance = LINKTO18.from_json(json)
# print the JSON string representation of the object
print(LINKTO18.to_json())

# convert the object into a dict
linkto18_dict = linkto18_instance.to_dict()
# create an instance of LINKTO18 from a dict
linkto18_from_dict = LINKTO18.from_dict(linkto18_dict)
```
