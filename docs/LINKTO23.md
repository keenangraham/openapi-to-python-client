...
```python
from openapi_client.models.linkto23 import LINKTO23

# TODO update the JSON string below
json = "{}"
# create an instance of LINKTO23 from a JSON string
linkto23_instance = LINKTO23.from_json(json)
# print the JSON string representation of the object
print(LINKTO23.to_json())

# convert the object into a dict
linkto23_dict = linkto23_instance.to_dict()
# create an instance of LINKTO23 from a dict
linkto23_from_dict = LINKTO23.from_dict(linkto23_dict)
```
