...
```python
from openapi_client.models.linkto15 import LINKTO15

# TODO update the JSON string below
json = "{}"
# create an instance of LINKTO15 from a JSON string
linkto15_instance = LINKTO15.from_json(json)
# print the JSON string representation of the object
print(LINKTO15.to_json())

# convert the object into a dict
linkto15_dict = linkto15_instance.to_dict()
# create an instance of LINKTO15 from a dict
linkto15_from_dict = LINKTO15.from_dict(linkto15_dict)
```
