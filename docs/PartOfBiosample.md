...
json = "{}"
# create an instance of PartOfBiosample from a JSON string
part_of_biosample_instance = PartOfBiosample.from_json(json)
# print the JSON string representation of the object
print(PartOfBiosample.to_json())

# convert the object into a dict
part_of_biosample_dict = part_of_biosample_instance.to_dict()
# create an instance of PartOfBiosample from a dict
part_of_biosample_from_dict = PartOfBiosample.from_dict(part_of_biosample_dict)
```
