...
**pooled_from** | [**List[TissuePooledFrom]**](TissuePooledFrom.md) | The biosamples this biosample is pooled from. | [optional] 
**part_of** | [**PartOfBiosample2**](PartOfBiosample2.md) |  | [optional] 
...
json = "{}"
# create an instance of TissuePooledFrom from a JSON string
tissue_pooled_from_instance = TissuePooledFrom.from_json(json)
# print the JSON string representation of the object
print(TissuePooledFrom.to_json())

# convert the object into a dict
tissue_pooled_from_dict = tissue_pooled_from_instance.to_dict()
# create an instance of TissuePooledFrom from a dict
tissue_pooled_from_from_dict = TissuePooledFrom.from_dict(tissue_pooled_from_dict)
```
