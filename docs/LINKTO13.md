...
```python
from openapi_client.models.linkto13 import LINKTO13

# TODO update the JSON string below
json = "{}"
# create an instance of LINKTO13 from a JSON string
linkto13_instance = LINKTO13.from_json(json)
# print the JSON string representation of the object
print(LINKTO13.to_json())

# convert the object into a dict
linkto13_dict = linkto13_instance.to_dict()
# create an instance of LINKTO13 from a dict
linkto13_from_dict = LINKTO13.from_dict(linkto13_dict)
```
