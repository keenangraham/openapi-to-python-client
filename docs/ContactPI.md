...
json = "{}"
# create an instance of ContactPI from a JSON string
contact_pi_instance = ContactPI.from_json(json)
# print the JSON string representation of the object
print(ContactPI.to_json())

# convert the object into a dict
contact_pi_dict = contact_pi_instance.to_dict()
# create an instance of ContactPI from a dict
contact_pi_from_dict = ContactPI.from_dict(contact_pi_dict)
```
