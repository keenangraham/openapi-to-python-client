# igvf_client.SignalFilesApi

All URIs are relative to *https://api.data.igvf.org*

Method | HTTP request | Description
------------- | ------------- | -------------
[**signal_files**](SignalFilesApi.md#signal_files) | **GET** /signal-files/@@listing | List items in the SignalFile collection.
...
with igvf_client.ApiClient(configuration) as api_client:
    ...
    api_instance = igvf_client.SignalFilesApi(api_client)
    ...
    try:
        ...
        print("The response of SignalFilesApi->signal_files:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SignalFilesApi->signal_files: %s\n" % e)
```
