...
```python
from openapi_client.models.in_vitro_system_originated_from import InVitroSystemOriginatedFrom

# TODO update the JSON string below
json = "{}"
# create an instance of InVitroSystemOriginatedFrom from a JSON string
in_vitro_system_originated_from_instance = InVitroSystemOriginatedFrom.from_json(json)
# print the JSON string representation of the object
print(InVitroSystemOriginatedFrom.to_json())

# convert the object into a dict
in_vitro_system_originated_from_dict = in_vitro_system_originated_from_instance.to_dict()
# create an instance of InVitroSystemOriginatedFrom from a dict
in_vitro_system_originated_from_from_dict = InVitroSystemOriginatedFrom.from_dict(in_vitro_system_originated_from_dict)
```
