# AuxiliarySetLibraryConstructionPlatform
...
```python
from openapi_client.models.auxiliary_set_library_construction_platform import AuxiliarySetLibraryConstructionPlatform

# TODO update the JSON string below
json = "{}"
# create an instance of AuxiliarySetLibraryConstructionPlatform from a JSON string
auxiliary_set_library_construction_platform_instance = AuxiliarySetLibraryConstructionPlatform.from_json(json)
# print the JSON string representation of the object
print(AuxiliarySetLibraryConstructionPlatform.to_json())

# convert the object into a dict
auxiliary_set_library_construction_platform_dict = auxiliary_set_library_construction_platform_instance.to_dict()
# create an instance of AuxiliarySetLibraryConstructionPlatform from a dict
auxiliary_set_library_construction_platform_from_dict = AuxiliarySetLibraryConstructionPlatform.from_dict(auxiliary_set_library_construction_platform_dict)
```
