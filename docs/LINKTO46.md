...
```python
from openapi_client.models.linkto46 import LINKTO46

# TODO update the JSON string below
json = "{}"
# create an instance of LINKTO46 from a JSON string
linkto46_instance = LINKTO46.from_json(json)
# print the JSON string representation of the object
print(LINKTO46.to_json())

# convert the object into a dict
linkto46_dict = linkto46_instance.to_dict()
# create an instance of LINKTO46 from a dict
linkto46_from_dict = LINKTO46.from_dict(linkto46_dict)
```
