# igvf_client.InstitutionalCertificatesApi

All URIs are relative to *https://api.data.igvf.org*

Method | HTTP request | Description
------------- | ------------- | -------------
[**institutional_certificates**](InstitutionalCertificatesApi.md#institutional_certificates) | **GET** /institutional-certificates/@@listing | List items in the InstitutionalCertificate collection.
...
with igvf_client.ApiClient(configuration) as api_client:
    ...
    api_instance = igvf_client.InstitutionalCertificatesApi(api_client)
    ...
    try:
        ...
        print("The response of InstitutionalCertificatesApi->institutional_certificates:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling InstitutionalCertificatesApi->institutional_certificates: %s\n" % e)
```
