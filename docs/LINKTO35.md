...
```python
from openapi_client.models.linkto35 import LINKTO35

# TODO update the JSON string below
json = "{}"
# create an instance of LINKTO35 from a JSON string
linkto35_instance = LINKTO35.from_json(json)
# print the JSON string representation of the object
print(LINKTO35.to_json())

# convert the object into a dict
linkto35_dict = linkto35_instance.to_dict()
# create an instance of LINKTO35 from a dict
linkto35_from_dict = LINKTO35.from_dict(linkto35_dict)
```
