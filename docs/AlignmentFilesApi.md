# igvf_client.AlignmentFilesApi

All URIs are relative to *https://api.data.igvf.org*

Method | HTTP request | Description
------------- | ------------- | -------------
[**alignment_files**](AlignmentFilesApi.md#alignment_files) | **GET** /alignment-files/@@listing | List items in the AlignmentFile collection.
...
with igvf_client.ApiClient(configuration) as api_client:
    ...
    api_instance = igvf_client.AlignmentFilesApi(api_client)
    ...
    try:
        ...
        print("The response of AlignmentFilesApi->alignment_files:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AlignmentFilesApi->alignment_files: %s\n" % e)
```
