...
```python
from openapi_client.models.sample_term1 import SampleTerm1

# TODO update the JSON string below
json = "{}"
# create an instance of SampleTerm1 from a JSON string
sample_term1_instance = SampleTerm1.from_json(json)
# print the JSON string representation of the object
print(SampleTerm1.to_json())

# convert the object into a dict
sample_term1_dict = sample_term1_instance.to_dict()
# create an instance of SampleTerm1 from a dict
sample_term1_from_dict = SampleTerm1.from_dict(sample_term1_dict)
```
