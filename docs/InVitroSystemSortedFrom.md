...
```python
from openapi_client.models.in_vitro_system_sorted_from import InVitroSystemSortedFrom

# TODO update the JSON string below
json = "{}"
# create an instance of InVitroSystemSortedFrom from a JSON string
in_vitro_system_sorted_from_instance = InVitroSystemSortedFrom.from_json(json)
# print the JSON string representation of the object
print(InVitroSystemSortedFrom.to_json())

# convert the object into a dict
in_vitro_system_sorted_from_dict = in_vitro_system_sorted_from_instance.to_dict()
# create an instance of InVitroSystemSortedFrom from a dict
in_vitro_system_sorted_from_from_dict = InVitroSystemSortedFrom.from_dict(in_vitro_system_sorted_from_dict)
```
