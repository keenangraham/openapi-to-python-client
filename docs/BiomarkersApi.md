# igvf_client.BiomarkersApi

All URIs are relative to *https://api.data.igvf.org*

Method | HTTP request | Description
------------- | ------------- | -------------
[**biomarkers**](BiomarkersApi.md#biomarkers) | **GET** /biomarkers/@@listing | List items in the Biomarker collection.
...
with igvf_client.ApiClient(configuration) as api_client:
    ...
    api_instance = igvf_client.BiomarkersApi(api_client)
    ...
    try:
        ...
        print("The response of BiomarkersApi->biomarkers:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BiomarkersApi->biomarkers: %s\n" % e)
```
