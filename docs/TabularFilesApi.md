# igvf_client.TabularFilesApi

All URIs are relative to *https://api.data.igvf.org*

Method | HTTP request | Description
------------- | ------------- | -------------
[**tabular_files**](TabularFilesApi.md#tabular_files) | **GET** /tabular-files/@@listing | List items in the TabularFile collection.
...
with igvf_client.ApiClient(configuration) as api_client:
    ...
    api_instance = igvf_client.TabularFilesApi(api_client)
    ...
    try:
        ...
        print("The response of TabularFilesApi->tabular_files:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TabularFilesApi->tabular_files: %s\n" % e)
```
