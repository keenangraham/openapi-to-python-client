...
**disease_terms** | [**List[InVitroSystemDiseaseTermsInner]**](InVitroSystemDiseaseTermsInner.md) | Ontology term of the disease associated with the biosample. | [optional] 
**pooled_from** | [**List[WholeOrganismPooledFromInner]**](WholeOrganismPooledFromInner.md) | The biosamples this biosample is pooled from. | [optional] 
**part_of** | [**InVitroSystemPartOf**](InVitroSystemPartOf.md) |  | [optional] 
**originated_from** | [**InVitroSystemOriginatedFrom**](InVitroSystemOriginatedFrom.md) |  | [optional] 
...
**sorted_from** | [**InVitroSystemSortedFrom**](InVitroSystemSortedFrom.md) |  | [optional] 
...
**cell_fate_change_protocol** | [**InVitroSystemCellFateChangeProtocol**](InVitroSystemCellFateChangeProtocol.md) |  | [optional] 
...
**targeted_sample_term** | [**InVitroSystemTargetedSampleTerm**](InVitroSystemTargetedSampleTerm.md) |  | [optional] 
...
**multiplexed_samples** | [**List[MultiplexedSampleMultiplexedSamplesInner]**](MultiplexedSampleMultiplexedSamplesInner.md) | The samples multiplexed together to produce this sample. | 
...
```python
from openapi_client.models.multiplexed_sample_multiplexed_samples_inner import MultiplexedSampleMultiplexedSamplesInner

# TODO update the JSON string below
json = "{}"
# create an instance of MultiplexedSampleMultiplexedSamplesInner from a JSON string
multiplexed_sample_multiplexed_samples_inner_instance = MultiplexedSampleMultiplexedSamplesInner.from_json(json)
# print the JSON string representation of the object
print(MultiplexedSampleMultiplexedSamplesInner.to_json())

# convert the object into a dict
multiplexed_sample_multiplexed_samples_inner_dict = multiplexed_sample_multiplexed_samples_inner_instance.to_dict()
# create an instance of MultiplexedSampleMultiplexedSamplesInner from a dict
multiplexed_sample_multiplexed_samples_inner_from_dict = MultiplexedSampleMultiplexedSamplesInner.from_dict(multiplexed_sample_multiplexed_samples_inner_dict)
```
