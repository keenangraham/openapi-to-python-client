...
json = "{}"
# create an instance of SmallScaleGeneListInner from a JSON string
small_scale_gene_list_inner_instance = SmallScaleGeneListInner.from_json(json)
# print the JSON string representation of the object
print(SmallScaleGeneListInner.to_json())

# convert the object into a dict
small_scale_gene_list_inner_dict = small_scale_gene_list_inner_instance.to_dict()
# create an instance of SmallScaleGeneListInner from a dict
small_scale_gene_list_inner_from_dict = SmallScaleGeneListInner.from_dict(small_scale_gene_list_inner_dict)
```
