# ConstructLibrarySetLargeScaleGeneList
...
**file_format_specifications** | [**List[AlignmentFileFileFormatSpecificationsInner]**](AlignmentFileFileFormatSpecificationsInner.md) | Document that further explains the file format. | [optional] 
...
```python
from openapi_client.models.construct_library_set_large_scale_gene_list import ConstructLibrarySetLargeScaleGeneList

# TODO update the JSON string below
json = "{}"
# create an instance of ConstructLibrarySetLargeScaleGeneList from a JSON string
construct_library_set_large_scale_gene_list_instance = ConstructLibrarySetLargeScaleGeneList.from_json(json)
# print the JSON string representation of the object
print(ConstructLibrarySetLargeScaleGeneList.to_json())

# convert the object into a dict
construct_library_set_large_scale_gene_list_dict = construct_library_set_large_scale_gene_list_instance.to_dict()
# create an instance of ConstructLibrarySetLargeScaleGeneList from a dict
construct_library_set_large_scale_gene_list_from_dict = ConstructLibrarySetLargeScaleGeneList.from_dict(construct_library_set_large_scale_gene_list_dict)
```
