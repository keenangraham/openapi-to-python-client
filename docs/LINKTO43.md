...
**pooled_from** | [**List[LINKTO43]**](LINKTO43.md) | The biosamples this biosample is pooled from. | [optional] 
**part_of** | [**LINKTO44**](LINKTO44.md) |  | [optional] 
...
```python
from openapi_client.models.linkto43 import LINKTO43

# TODO update the JSON string below
json = "{}"
# create an instance of LINKTO43 from a JSON string
linkto43_instance = LINKTO43.from_json(json)
# print the JSON string representation of the object
print(LINKTO43.to_json())

# convert the object into a dict
linkto43_dict = linkto43_instance.to_dict()
# create an instance of LINKTO43 from a dict
linkto43_from_dict = LINKTO43.from_dict(linkto43_dict)
```
