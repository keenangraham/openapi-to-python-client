...
json = "{}"
# create an instance of InVitroSystemPooledFromInner from a JSON string
in_vitro_system_pooled_from_inner_instance = InVitroSystemPooledFromInner.from_json(json)
# print the JSON string representation of the object
print(InVitroSystemPooledFromInner.to_json())

# convert the object into a dict
in_vitro_system_pooled_from_inner_dict = in_vitro_system_pooled_from_inner_instance.to_dict()
# create an instance of InVitroSystemPooledFromInner from a dict
in_vitro_system_pooled_from_inner_from_dict = InVitroSystemPooledFromInner.from_dict(in_vitro_system_pooled_from_inner_dict)
```
