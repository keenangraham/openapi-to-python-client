# InVitroSystemDiseaseTermsInner
...
```python
from openapi_client.models.in_vitro_system_disease_terms_inner import InVitroSystemDiseaseTermsInner

# TODO update the JSON string below
json = "{}"
# create an instance of InVitroSystemDiseaseTermsInner from a JSON string
in_vitro_system_disease_terms_inner_instance = InVitroSystemDiseaseTermsInner.from_json(json)
# print the JSON string representation of the object
print(InVitroSystemDiseaseTermsInner.to_json())

# convert the object into a dict
in_vitro_system_disease_terms_inner_dict = in_vitro_system_disease_terms_inner_instance.to_dict()
# create an instance of InVitroSystemDiseaseTermsInner from a dict
in_vitro_system_disease_terms_inner_from_dict = InVitroSystemDiseaseTermsInner.from_dict(in_vitro_system_disease_terms_inner_dict)
```
