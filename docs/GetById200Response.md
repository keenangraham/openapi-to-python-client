...
```python
from openapi_client.models.get_by_id200_response import GetById200Response
...
get_by_id200_response_from_dict = GetById200Response.from_dict(get_by_id200_response_dict)
```
