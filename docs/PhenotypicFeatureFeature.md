...
json = "{}"
# create an instance of PhenotypicFeatureFeature from a JSON string
phenotypic_feature_feature_instance = PhenotypicFeatureFeature.from_json(json)
# print the JSON string representation of the object
print(PhenotypicFeatureFeature.to_json())

# convert the object into a dict
phenotypic_feature_feature_dict = phenotypic_feature_feature_instance.to_dict()
# create an instance of PhenotypicFeatureFeature from a dict
phenotypic_feature_feature_from_dict = PhenotypicFeatureFeature.from_dict(phenotypic_feature_feature_dict)
```
