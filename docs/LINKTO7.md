...
```python
from openapi_client.models.linkto7 import LINKTO7

# TODO update the JSON string below
json = "{}"
# create an instance of LINKTO7 from a JSON string
linkto7_instance = LINKTO7.from_json(json)
# print the JSON string representation of the object
print(LINKTO7.to_json())

# convert the object into a dict
linkto7_dict = linkto7_instance.to_dict()
# create an instance of LINKTO7 from a dict
linkto7_from_dict = LINKTO7.from_dict(linkto7_dict)
```
