...
```python
from openapi_client.models.whole_organism_pooled_from_inner import WholeOrganismPooledFromInner

# TODO update the JSON string below
json = "{}"
# create an instance of WholeOrganismPooledFromInner from a JSON string
whole_organism_pooled_from_inner_instance = WholeOrganismPooledFromInner.from_json(json)
# print the JSON string representation of the object
print(WholeOrganismPooledFromInner.to_json())

# convert the object into a dict
whole_organism_pooled_from_inner_dict = whole_organism_pooled_from_inner_instance.to_dict()
# create an instance of WholeOrganismPooledFromInner from a dict
whole_organism_pooled_from_inner_from_dict = WholeOrganismPooledFromInner.from_dict(whole_organism_pooled_from_inner_dict)
```
