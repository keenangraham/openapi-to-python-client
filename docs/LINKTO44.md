...
```python
from openapi_client.models.linkto44 import LINKTO44

# TODO update the JSON string below
json = "{}"
# create an instance of LINKTO44 from a JSON string
linkto44_instance = LINKTO44.from_json(json)
# print the JSON string representation of the object
print(LINKTO44.to_json())

# convert the object into a dict
linkto44_dict = linkto44_instance.to_dict()
# create an instance of LINKTO44 from a dict
linkto44_from_dict = LINKTO44.from_dict(linkto44_dict)
```
