...
json = "{}"
# create an instance of BiosamplePooledFrom from a JSON string
biosample_pooled_from_instance = BiosamplePooledFrom.from_json(json)
# print the JSON string representation of the object
print(BiosamplePooledFrom.to_json())

# convert the object into a dict
biosample_pooled_from_dict = biosample_pooled_from_instance.to_dict()
# create an instance of BiosamplePooledFrom from a dict
biosample_pooled_from_from_dict = BiosamplePooledFrom.from_dict(biosample_pooled_from_dict)
```
