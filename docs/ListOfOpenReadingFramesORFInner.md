# ListOfOpenReadingFramesORFInner
...
json = "{}"
# create an instance of ListOfOpenReadingFramesORFInner from a JSON string
list_of_open_reading_frames_orf_inner_instance = ListOfOpenReadingFramesORFInner.from_json(json)
# print the JSON string representation of the object
print(ListOfOpenReadingFramesORFInner.to_json())

# convert the object into a dict
list_of_open_reading_frames_orf_inner_dict = list_of_open_reading_frames_orf_inner_instance.to_dict()
# create an instance of ListOfOpenReadingFramesORFInner from a dict
list_of_open_reading_frames_orf_inner_from_dict = ListOfOpenReadingFramesORFInner.from_dict(list_of_open_reading_frames_orf_inner_dict)
```
