# ConfigurationFileSeqspecOfInner
...
json = "{}"
# create an instance of ConfigurationFileSeqspecOfInner from a JSON string
configuration_file_seqspec_of_inner_instance = ConfigurationFileSeqspecOfInner.from_json(json)
# print the JSON string representation of the object
print(ConfigurationFileSeqspecOfInner.to_json())

# convert the object into a dict
configuration_file_seqspec_of_inner_dict = configuration_file_seqspec_of_inner_instance.to_dict()
# create an instance of ConfigurationFileSeqspecOfInner from a dict
configuration_file_seqspec_of_inner_from_dict = ConfigurationFileSeqspecOfInner.from_dict(configuration_file_seqspec_of_inner_dict)
```
