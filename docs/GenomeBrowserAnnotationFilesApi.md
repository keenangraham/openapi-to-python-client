# igvf_client.GenomeBrowserAnnotationFilesApi
...
with igvf_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of GenomeBrowserAnnotationFilesApi->genome_browser_annotation_files:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling GenomeBrowserAnnotationFilesApi->genome_browser_annotation_files: %s\n" % e)
```
