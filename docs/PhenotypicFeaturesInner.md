...
json = "{}"
# create an instance of PhenotypicFeaturesInner from a JSON string
phenotypic_features_inner_instance = PhenotypicFeaturesInner.from_json(json)
# print the JSON string representation of the object
print(PhenotypicFeaturesInner.to_json())

# convert the object into a dict
phenotypic_features_inner_dict = phenotypic_features_inner_instance.to_dict()
# create an instance of PhenotypicFeaturesInner from a dict
phenotypic_features_inner_from_dict = PhenotypicFeaturesInner.from_dict(phenotypic_features_inner_dict)
```
