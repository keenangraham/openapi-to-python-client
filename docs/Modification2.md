...
```python
from openapi_client.models.modification2 import Modification2

# TODO update the JSON string below
json = "{}"
# create an instance of Modification2 from a JSON string
modification2_instance = Modification2.from_json(json)
# print the JSON string representation of the object
print(Modification2.to_json())

# convert the object into a dict
modification2_dict = modification2_instance.to_dict()
# create an instance of Modification2 from a dict
modification2_from_dict = Modification2.from_dict(modification2_dict)
```
