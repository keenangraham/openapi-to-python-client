...
export interface ConfigurationFile {
     ...
     * @memberof ConfigurationFile
     */
    collections?: Set<ConfigurationFileCollectionsEnum>;
    /**
     * The status of the metadata object.
     * @type {string}
     * @memberof ConfigurationFile
     */
    status?: ConfigurationFileStatusEnum;
    /**
     ...
     * @memberof ConfigurationFile
     */
    fileFormat?: ConfigurationFileFileFormatEnum;
    /**
     ...
     * @memberof ConfigurationFile
     */
    uploadStatus?: ConfigurationFileUploadStatusEnum;
    /**
 ...
 * @export
 */
export const ConfigurationFileCollectionsEnum = {
    ClinGen: 'ClinGen',
    Encode: 'ENCODE',
    GregoR: 'GREGoR',
...
export type ConfigurationFileCollectionsEnum = typeof ConfigurationFileCollectionsEnum[keyof typeof ConfigurationFileCollectionsEnum];

/**
 * @export
 */
export const ConfigurationFileStatusEnum = {
...
export type ConfigurationFileStatusEnum = typeof ConfigurationFileStatusEnum[keyof typeof ConfigurationFileStatusEnum];

/**
 * @export
 */
export const ConfigurationFileFileFormatEnum = {
    Yaml: 'yaml'
} as const;
export type ConfigurationFileFileFormatEnum = typeof ConfigurationFileFileFormatEnum[keyof typeof ConfigurationFileFileFormatEnum];

/**
 * @export
 */
export const ConfigurationFileUploadStatusEnum = {
    Pending: 'pending',
    FileNotFound: 'file not found',
    Invalidated: 'invalidated',
    Validated: 'validated'
} as const;
export type ConfigurationFileUploadStatusEnum = typeof ConfigurationFileUploadStatusEnum[keyof typeof ConfigurationFileUploadStatusEnum];


/**
 * Check if a given object implements the ConfigurationFile interface.
 */
export function instanceOfConfigurationFile(value: object): value is ConfigurationFile {
    return true;
}

export function ConfigurationFileFromJSON(json: any): ConfigurationFile {
    return ConfigurationFileFromJSONTyped(json, false);
}

export function ConfigurationFileFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConfigurationFile {
    if (json == null) {
        return json;
    }
    return {
        ...
        'seqspecOf': json['seqspec_of'] == null ? undefined : json['seqspec_of'],
...
export function ConfigurationFileToJSON(value?: ConfigurationFile | null): any {
    if (value == null) {
        return value;
    }
    return {
        ...
        'seqspec_of': value['seqspecOf'] == null ? undefined : Array.from(value['seqspecOf'] as Set<any>),
        '@id': value['id'],
        '@type': value['type'],
