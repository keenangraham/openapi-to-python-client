...
/**
 * The AnalysisStepVersion model module.
 * @module model/AnalysisStepVersion
 * @version 0.1.0
 */
class AnalysisStepVersion {
    /**
     * Constructs a new <code>AnalysisStepVersion</code>.
     * A step version in a computational analysis workflow.
     * @alias module:model/AnalysisStepVersion
     */
    constructor() { 
        
        AnalysisStepVersion.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AnalysisStepVersion</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AnalysisStepVersion} obj Optional instance to populate.
     * @return {module:model/AnalysisStepVersion} The populated <code>AnalysisStepVersion</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AnalysisStepVersion();
            ...
            if (data.hasOwnProperty('analysis_step')) {
                obj['analysis_step'] = ApiClient.convertToType(data['analysis_step'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>AnalysisStepVersion</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AnalysisStepVersion</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['analysis_step'] && !(typeof data['analysis_step'] === 'string' || data['analysis_step'] instanceof String)) {
            throw new Error("Expected the field `analysis_step` to be a primitive type in the JSON string but got " + data['analysis_step']);
        }
        // ensure the json data is an array
 ...
 */
AnalysisStepVersion.prototype['release_timestamp'] = undefined;

/**
 * The status of the metadata object.
 * @member {module:model/AnalysisStepVersion.StatusEnum} status
 */
AnalysisStepVersion.prototype['status'] = undefined;

/**
 * Lab associated with the submission.
 * @member {String} lab
 */
AnalysisStepVersion.prototype['lab'] = undefined;

/**
 * Grant associated with the submission.
 * @member {String} award
 */
AnalysisStepVersion.prototype['award'] = undefined;

/**
 * The version of the JSON schema that the server uses to validate the object.
 * @member {String} schema_version
 */
AnalysisStepVersion.prototype['schema_version'] = undefined;

/**
 * The unique identifier associated with every object.
 * @member {String} uuid
 */
AnalysisStepVersion.prototype['uuid'] = undefined;

/**
 * DACC internal notes.
 * @member {String} notes
 */
AnalysisStepVersion.prototype['notes'] = undefined;

/**
 * Lab specific identifiers to reference an object.
 * @member {Array.<String>} aliases
 */
AnalysisStepVersion.prototype['aliases'] = undefined;

/**
 * The date the object was created.
 * @member {String} creation_timestamp
 */
AnalysisStepVersion.prototype['creation_timestamp'] = undefined;

/**
 * The user who submitted the object.
 * @member {String} submitted_by
 */
AnalysisStepVersion.prototype['submitted_by'] = undefined;

/**
 * Additional information specified by the submitter to be displayed as a comment on the portal.
 * @member {String} submitter_comment
 */
AnalysisStepVersion.prototype['submitter_comment'] = undefined;

/**
 * A plain text description of the object.
 * @member {String} description
 */
AnalysisStepVersion.prototype['description'] = undefined;

/**
 * The analysis step which this version belongs to.
 * @member {String} analysis_step
 */
AnalysisStepVersion.prototype['analysis_step'] = undefined;

/**
 * The software versions used in this analysis step versions.
 * @member {Array.<String>} software_versions
 */
AnalysisStepVersion.prototype['software_versions'] = undefined;

/**
 * @member {String} @id
 */
AnalysisStepVersion.prototype['@id'] = undefined;

/**
 * @member {Array.<String>} @type
 */
AnalysisStepVersion.prototype['@type'] = undefined;

/**
 * A summary of the object.
 * @member {String} summary
 */
AnalysisStepVersion.prototype['summary'] = undefined;
 ...
 * @readonly
 */
AnalysisStepVersion['StatusEnum'] = {
...
export default AnalysisStepVersion;
