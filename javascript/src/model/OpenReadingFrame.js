...
/**
 * The OpenReadingFrame model module.
 * @module model/OpenReadingFrame
 * @version 0.1.0
 */
class OpenReadingFrame {
    /**
     * Constructs a new <code>OpenReadingFrame</code>.
     * Protein-encoding open reading frames (ORF)
     * @alias module:model/OpenReadingFrame
     */
    constructor() { 
        
        OpenReadingFrame.initialize(this);
    }
    ...
    /**
     * Constructs a <code>OpenReadingFrame</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OpenReadingFrame} obj Optional instance to populate.
     * @return {module:model/OpenReadingFrame} The populated <code>OpenReadingFrame</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OpenReadingFrame();
            ...
            if (data.hasOwnProperty('orf_id')) {
                obj['orf_id'] = ApiClient.convertToType(data['orf_id'], 'String');
            }
            if (data.hasOwnProperty('gene')) {
                obj['gene'] = ApiClient.convertToType(data['gene'], ['String']);
            }
            if (data.hasOwnProperty('protein_id')) {
                obj['protein_id'] = ApiClient.convertToType(data['protein_id'], 'String');
            }
            if (data.hasOwnProperty('dbxrefs')) {
                obj['dbxrefs'] = ApiClient.convertToType(data['dbxrefs'], ['String']);
            }
            if (data.hasOwnProperty('pct_identical_protein')) {
                obj['pct_identical_protein'] = ApiClient.convertToType(data['pct_identical_protein'], 'Number');
            }
            if (data.hasOwnProperty('pct_coverage_protein')) {
                obj['pct_coverage_protein'] = ApiClient.convertToType(data['pct_coverage_protein'], 'Number');
            }
            if (data.hasOwnProperty('pct_coverage_orf')) {
                obj['pct_coverage_orf'] = ApiClient.convertToType(data['pct_coverage_orf'], 'Number');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>OpenReadingFrame</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OpenReadingFrame</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['orf_id'] && !(typeof data['orf_id'] === 'string' || data['orf_id'] instanceof String)) {
            throw new Error("Expected the field `orf_id` to be a primitive type in the JSON string but got " + data['orf_id']);
        }
        // ensure the json data is an array
        ...
        // ensure the json data is a string
        if (data['protein_id'] && !(typeof data['protein_id'] === 'string' || data['protein_id'] instanceof String)) {
            throw new Error("Expected the field `protein_id` to be a primitive type in the JSON string but got " + data['protein_id']);
        }
        // ensure the json data is an array
 ...
 */
OpenReadingFrame.prototype['release_timestamp'] = undefined;

/**
 * The status of the metadata object.
 * @member {module:model/OpenReadingFrame.StatusEnum} status
 */
OpenReadingFrame.prototype['status'] = undefined;

/**
 * The version of the JSON schema that the server uses to validate the object.
 * @member {String} schema_version
 */
OpenReadingFrame.prototype['schema_version'] = undefined;

/**
 * The unique identifier associated with every object.
 * @member {String} uuid
 */
OpenReadingFrame.prototype['uuid'] = undefined;

/**
 * DACC internal notes.
 * @member {String} notes
 */
OpenReadingFrame.prototype['notes'] = undefined;

/**
 * Lab specific identifiers to reference an object.
 * @member {Array.<String>} aliases
 */
OpenReadingFrame.prototype['aliases'] = undefined;

/**
 * The date the object was created.
 * @member {String} creation_timestamp
 */
OpenReadingFrame.prototype['creation_timestamp'] = undefined;

/**
 * The user who submitted the object.
 * @member {String} submitted_by
 */
OpenReadingFrame.prototype['submitted_by'] = undefined;

/**
 * Additional information specified by the submitter to be displayed as a comment on the portal.
 * @member {String} submitter_comment
 */
OpenReadingFrame.prototype['submitter_comment'] = undefined;

/**
 * A plain text description of the object.
 * @member {String} description
 */
OpenReadingFrame.prototype['description'] = undefined;

/**
 * Lab associated with the submission.
 * @member {String} lab
 */
OpenReadingFrame.prototype['lab'] = undefined;

/**
 * Grant associated with the submission.
 * @member {String} award
 */
OpenReadingFrame.prototype['award'] = undefined;

/**
 * Open reading frame ID.
 * @member {String} orf_id
 */
OpenReadingFrame.prototype['orf_id'] = undefined;
 ...
 */
OpenReadingFrame.prototype['gene'] = undefined;
 ...
 */
OpenReadingFrame.prototype['protein_id'] = undefined;

/**
 * Unique identifiers from the hORFeome database
 * @member {Array.<String>} dbxrefs
 */
OpenReadingFrame.prototype['dbxrefs'] = undefined;

/**
 * The percentage of identical matches to Ensembl protein.
 * @member {Number} pct_identical_protein
 */
OpenReadingFrame.prototype['pct_identical_protein'] = undefined;

/**
 * The percentage of ORF covered by Ensembl protein.
 * @member {Number} pct_coverage_protein
 */
OpenReadingFrame.prototype['pct_coverage_protein'] = undefined;

/**
 * The percentage of Ensembl protein covered by ORF.
 * @member {Number} pct_coverage_orf
 */
OpenReadingFrame.prototype['pct_coverage_orf'] = undefined;

/**
 * @member {String} @id
 */
OpenReadingFrame.prototype['@id'] = undefined;

/**
 * @member {Array.<String>} @type
 */
OpenReadingFrame.prototype['@type'] = undefined;

/**
 * A summary of the object.
 * @member {String} summary
 */
OpenReadingFrame.prototype['summary'] = undefined;
...
export default OpenReadingFrame;
