...
/**
 * The TabularFile model module.
 * @module model/TabularFile
 * @version 0.1.0
 */
class TabularFile {
    /**
     * Constructs a new <code>TabularFile</code>.
     * A file containing textual data with a tabular structure.
     * @alias module:model/TabularFile
     */
    constructor() { 
        
        TabularFile.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TabularFile</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TabularFile} obj Optional instance to populate.
     * @return {module:model/TabularFile} The populated <code>TabularFile</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TabularFile();
    ...
    /**
     * Validates the JSON data with respect to <code>TabularFile</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TabularFile</code>.
     */
 ...
 */
TabularFile.prototype['controlled_access'] = undefined;

/**
 * URL linking to the controlled access file that has been deposited at AnVIL workspace.
 * @member {String} anvil_url
 */
TabularFile.prototype['anvil_url'] = undefined;

/**
 * Genome assembly applicable for the tabular data.
 * @member {module:model/TabularFile.AssemblyEnum} assembly
 */
TabularFile.prototype['assembly'] = undefined;

/**
 * The date the object was released.
 * @member {String} release_timestamp
 */
TabularFile.prototype['release_timestamp'] = undefined;

/**
 * The subtype of bed files.
 * @member {module:model/TabularFile.FileFormatTypeEnum} file_format_type
 */
TabularFile.prototype['file_format_type'] = undefined;

/**
 * The annotation and version of the reference resource.
 * @member {module:model/TabularFile.TranscriptomeAnnotationEnum} transcriptome_annotation
 */
TabularFile.prototype['transcriptome_annotation'] = undefined;

/**
 * Documents that provide additional information (not data file).
 * @member {Array.<String>} documents
 */
TabularFile.prototype['documents'] = undefined;

/**
 * Lab associated with the submission.
 * @member {String} lab
 */
TabularFile.prototype['lab'] = undefined;

/**
 * Grant associated with the submission.
 * @member {String} award
 */
TabularFile.prototype['award'] = undefined;

/**
 * A unique identifier to be used to reference the object prefixed with IGVF.
 * @member {String} accession
 */
TabularFile.prototype['accession'] = undefined;

/**
 * Accessions previously assigned to objects that have been merged with this object.
 * @member {Array.<String>} alternate_accessions
 */
TabularFile.prototype['alternate_accessions'] = undefined;

/**
 * Some samples are part of particular data collections.
 * @member {Array.<module:model/TabularFile.CollectionsEnum>} collections
 */
TabularFile.prototype['collections'] = undefined;

/**
 * The status of the metadata object.
 * @member {module:model/TabularFile.StatusEnum} status
 */
TabularFile.prototype['status'] = undefined;

/**
 * Explanation of why an object was transitioned to the revoked status.
 * @member {String} revoke_detail
 */
TabularFile.prototype['revoke_detail'] = undefined;

/**
 * The version of the JSON schema that the server uses to validate the object.
 * @member {String} schema_version
 */
TabularFile.prototype['schema_version'] = undefined;

/**
 * The unique identifier associated with every object.
 * @member {String} uuid
 */
TabularFile.prototype['uuid'] = undefined;

/**
 * DACC internal notes.
 * @member {String} notes
 */
TabularFile.prototype['notes'] = undefined;

/**
 * Lab specific identifiers to reference an object.
 * @member {Array.<String>} aliases
 */
TabularFile.prototype['aliases'] = undefined;

/**
 * The date the object was created.
 * @member {String} creation_timestamp
 */
TabularFile.prototype['creation_timestamp'] = undefined;

/**
 * The user who submitted the object.
 * @member {String} submitted_by
 */
TabularFile.prototype['submitted_by'] = undefined;

/**
 * Additional information specified by the submitter to be displayed as a comment on the portal.
 * @member {String} submitter_comment
 */
TabularFile.prototype['submitter_comment'] = undefined;

/**
 * A plain text description of the object.
 * @member {String} description
 */
TabularFile.prototype['description'] = undefined;

/**
 * The analysis step version of the file.
 * @member {String} analysis_step_version
 */
TabularFile.prototype['analysis_step_version'] = undefined;

/**
 * The MD5sum of the uncompressed file.
 * @member {String} content_md5sum
 */
TabularFile.prototype['content_md5sum'] = undefined;

/**
 * The type of content in the file.
 * @member {String} content_type
 */
TabularFile.prototype['content_type'] = undefined;
 ...
 * @readonly
 */
TabularFile['FileFormatTypeEnum'] = {
 ...
 * @readonly
 */
TabularFile['TranscriptomeAnnotationEnum'] = {
