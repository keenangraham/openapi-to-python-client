...
/**
 * The SignalFile model module.
 * @module model/SignalFile
 * @version 0.1.0
 */
class SignalFile {
    /**
     * Constructs a new <code>SignalFile</code>.
     * A file containing analyzed sequencing data in signal form using a bigwig format.
     * @alias module:model/SignalFile
     */
    constructor() { 
        
        SignalFile.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SignalFile</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SignalFile} obj Optional instance to populate.
     * @return {module:model/SignalFile} The populated <code>SignalFile</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SignalFile();
            ...
            if (data.hasOwnProperty('strand_specificity')) {
                obj['strand_specificity'] = ApiClient.convertToType(data['strand_specificity'], 'String');
            }
            ...
            if (data.hasOwnProperty('start_view_position')) {
                obj['start_view_position'] = ApiClient.convertToType(data['start_view_position'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>SignalFile</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SignalFile</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['strand_specificity'] && !(typeof data['strand_specificity'] === 'string' || data['strand_specificity'] instanceof String)) {
            throw new Error("Expected the field `strand_specificity` to be a primitive type in the JSON string but got " + data['strand_specificity']);
        }
        // ensure the json data is a string
        if (data['start_view_position'] && !(typeof data['start_view_position'] === 'string' || data['start_view_position'] instanceof String)) {
            throw new Error("Expected the field `start_view_position` to be a primitive type in the JSON string but got " + data['start_view_position']);
        }
        // ensure the json data is a string
 ...
 * @member {module:model/SignalFile.TranscriptomeAnnotationEnum} transcriptome_annotation
 */
SignalFile.prototype['transcriptome_annotation'] = undefined;

/**
 * Genome assembly applicable for the annotation data.
 * @member {module:model/SignalFile.AssemblyEnum} assembly
 */
SignalFile.prototype['assembly'] = undefined;

/**
 * The date the object was released.
 * @member {String} release_timestamp
 */
SignalFile.prototype['release_timestamp'] = undefined;

/**
 * Link to the reference files used to generate this file.
 * @member {Array.<String>} reference_files
 */
SignalFile.prototype['reference_files'] = undefined;

/**
 * Documents that provide additional information (not data file).
 * @member {Array.<String>} documents
 */
SignalFile.prototype['documents'] = undefined;

/**
 * Lab associated with the submission.
 * @member {String} lab
 */
SignalFile.prototype['lab'] = undefined;

/**
 * Grant associated with the submission.
 * @member {String} award
 */
SignalFile.prototype['award'] = undefined;

/**
 * A unique identifier to be used to reference the object prefixed with IGVF.
 * @member {String} accession
 */
SignalFile.prototype['accession'] = undefined;

/**
 * Accessions previously assigned to objects that have been merged with this object.
 * @member {Array.<String>} alternate_accessions
 */
SignalFile.prototype['alternate_accessions'] = undefined;

/**
 * Some samples are part of particular data collections.
 * @member {Array.<module:model/SignalFile.CollectionsEnum>} collections
 */
SignalFile.prototype['collections'] = undefined;

/**
 * The status of the metadata object.
 * @member {module:model/SignalFile.StatusEnum} status
 */
SignalFile.prototype['status'] = undefined;

/**
 * Explanation of why an object was transitioned to the revoked status.
 * @member {String} revoke_detail
 */
SignalFile.prototype['revoke_detail'] = undefined;

/**
 * The version of the JSON schema that the server uses to validate the object.
 * @member {String} schema_version
 */
SignalFile.prototype['schema_version'] = undefined;

/**
 * The unique identifier associated with every object.
 * @member {String} uuid
 */
SignalFile.prototype['uuid'] = undefined;

/**
 * DACC internal notes.
 * @member {String} notes
 */
SignalFile.prototype['notes'] = undefined;

/**
 * Lab specific identifiers to reference an object.
 * @member {Array.<String>} aliases
 */
SignalFile.prototype['aliases'] = undefined;

/**
 * The date the object was created.
 * @member {String} creation_timestamp
 */
SignalFile.prototype['creation_timestamp'] = undefined;

/**
 * The user who submitted the object.
 * @member {String} submitted_by
 */
SignalFile.prototype['submitted_by'] = undefined;

/**
 * Additional information specified by the submitter to be displayed as a comment on the portal.
 * @member {String} submitter_comment
 */
SignalFile.prototype['submitter_comment'] = undefined;

/**
 * A plain text description of the object.
 * @member {String} description
 */
SignalFile.prototype['description'] = undefined;

/**
 * The analysis step version of the file.
 * @member {String} analysis_step_version
 */
SignalFile.prototype['analysis_step_version'] = undefined;

/**
 * The MD5sum of the uncompressed file.
 * @member {String} content_md5sum
 */
SignalFile.prototype['content_md5sum'] = undefined;

/**
 * The type of content in the file.
 * @member {String} content_type
 */
SignalFile.prototype['content_type'] = undefined;
 ...
 * @readonly
 */
SignalFile['TranscriptomeAnnotationEnum'] = {
...
/**
 * Allowed values for the <code>strand_specificity</code> property.
 * @enum {String}
 * @readonly
 */
SignalFile['StrandSpecificityEnum'] = {
