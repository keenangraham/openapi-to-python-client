...
/**
 * The AlignmentFile model module.
 * @module model/AlignmentFile
 * @version 0.1.0
 */
class AlignmentFile {
    /**
     * Constructs a new <code>AlignmentFile</code>.
     * A file containing alignment data in bam format.
     * @alias module:model/AlignmentFile
     */
    constructor() { 
        
        AlignmentFile.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AlignmentFile</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AlignmentFile} obj Optional instance to populate.
     * @return {module:model/AlignmentFile} The populated <code>AlignmentFile</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AlignmentFile();
    ...
    /**
     * Validates the JSON data with respect to <code>AlignmentFile</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AlignmentFile</code>.
     */
 ...
 */
AlignmentFile.prototype['controlled_access'] = undefined;

/**
 * URL linking to the controlled access file that has been deposited at AnVIL workspace.
 * @member {String} anvil_url
 */
AlignmentFile.prototype['anvil_url'] = undefined;

/**
 * The annotation and version of the reference resource.
 * @member {module:model/AlignmentFile.TranscriptomeAnnotationEnum} transcriptome_annotation
 */
AlignmentFile.prototype['transcriptome_annotation'] = undefined;

/**
 * Genome assembly applicable for the annotation data.
 * @member {module:model/AlignmentFile.AssemblyEnum} assembly
 */
AlignmentFile.prototype['assembly'] = undefined;

/**
 * The date the object was released.
 * @member {String} release_timestamp
 */
AlignmentFile.prototype['release_timestamp'] = undefined;

/**
 * Link to the reference files used to generate this file.
 * @member {Array.<String>} reference_files
 */
AlignmentFile.prototype['reference_files'] = undefined;

/**
 * Documents that provide additional information (not data file).
 * @member {Array.<String>} documents
 */
AlignmentFile.prototype['documents'] = undefined;

/**
 * Lab associated with the submission.
 * @member {String} lab
 */
AlignmentFile.prototype['lab'] = undefined;

/**
 * Grant associated with the submission.
 * @member {String} award
 */
AlignmentFile.prototype['award'] = undefined;

/**
 * A unique identifier to be used to reference the object prefixed with IGVF.
 * @member {String} accession
 */
AlignmentFile.prototype['accession'] = undefined;

/**
 * Accessions previously assigned to objects that have been merged with this object.
 * @member {Array.<String>} alternate_accessions
 */
AlignmentFile.prototype['alternate_accessions'] = undefined;

/**
 * Some samples are part of particular data collections.
 * @member {Array.<module:model/AlignmentFile.CollectionsEnum>} collections
 */
AlignmentFile.prototype['collections'] = undefined;

/**
 * The status of the metadata object.
 * @member {module:model/AlignmentFile.StatusEnum} status
 */
AlignmentFile.prototype['status'] = undefined;

/**
 * Explanation of why an object was transitioned to the revoked status.
 * @member {String} revoke_detail
 */
AlignmentFile.prototype['revoke_detail'] = undefined;

/**
 * The version of the JSON schema that the server uses to validate the object.
 * @member {String} schema_version
 */
AlignmentFile.prototype['schema_version'] = undefined;

/**
 * The unique identifier associated with every object.
 * @member {String} uuid
 */
AlignmentFile.prototype['uuid'] = undefined;

/**
 * DACC internal notes.
 * @member {String} notes
 */
AlignmentFile.prototype['notes'] = undefined;

/**
 * Lab specific identifiers to reference an object.
 * @member {Array.<String>} aliases
 */
AlignmentFile.prototype['aliases'] = undefined;

/**
 * The date the object was created.
 * @member {String} creation_timestamp
 */
AlignmentFile.prototype['creation_timestamp'] = undefined;

/**
 * The user who submitted the object.
 * @member {String} submitted_by
 */
AlignmentFile.prototype['submitted_by'] = undefined;

/**
 * Additional information specified by the submitter to be displayed as a comment on the portal.
 * @member {String} submitter_comment
 */
AlignmentFile.prototype['submitter_comment'] = undefined;

/**
 * A plain text description of the object.
 * @member {String} description
 */
AlignmentFile.prototype['description'] = undefined;

/**
 * The analysis step version of the file.
 * @member {String} analysis_step_version
 */
AlignmentFile.prototype['analysis_step_version'] = undefined;

/**
 * The MD5sum of the uncompressed file.
 * @member {String} content_md5sum
 */
AlignmentFile.prototype['content_md5sum'] = undefined;

/**
 * The type of content in the file.
 * @member {String} content_type
 */
AlignmentFile.prototype['content_type'] = undefined;
 ...
 */
AlignmentFile.prototype['dbxrefs'] = undefined;

/**
 * The files participating as inputs into software to produce this output file.
 * @member {Array.<String>} derived_from
 */
AlignmentFile.prototype['derived_from'] = undefined;

/**
 * The file format or extension of the file.
 * @member {module:model/AlignmentFile.FileFormatEnum} file_format
 */
AlignmentFile.prototype['file_format'] = undefined;

/**
 * Document that further explains the file format.
 * @member {Array.<String>} file_format_specifications
 */
AlignmentFile.prototype['file_format_specifications'] = undefined;

/**
 * The file set that this file belongs to.
 * @member {String} file_set
 */
AlignmentFile.prototype['file_set'] = undefined;

/**
 * File size specified in bytes.
 * @member {Number} file_size
 */
AlignmentFile.prototype['file_size'] = undefined;

/**
 * The md5sum of the file being transferred.
 * @member {String} md5sum
 */
AlignmentFile.prototype['md5sum'] = undefined;

/**
 * Original name of the file.
 * @member {String} submitted_file_name
 */
AlignmentFile.prototype['submitted_file_name'] = undefined;

/**
 * The upload/validation status of the file.
 * @member {module:model/AlignmentFile.UploadStatusEnum} upload_status
 */
AlignmentFile.prototype['upload_status'] = undefined;

/**
 * Explanation of why the file failed the automated content checks.
 * @member {String} validation_error_detail
 */
AlignmentFile.prototype['validation_error_detail'] = undefined;
 ...
 */
AlignmentFile.prototype['redacted'] = undefined;
 ...
 * @readonly
 */
AlignmentFile['TranscriptomeAnnotationEnum'] = {
 ...
 * @readonly
 */
AlignmentFile['UploadStatusEnum'] = {
