...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IgvfProjectApi.BiomarkerResults();
  });
  ...
  describe('BiomarkerResults', function() {
    it('should create an instance of BiomarkerResults', function() {
      // uncomment below and update the code to test BiomarkerResults
      //var instance = new IgvfProjectApi.BiomarkerResults();
      //expect(instance).to.be.a(IgvfProjectApi.BiomarkerResults);
    });
