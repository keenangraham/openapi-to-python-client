...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IgvfProjectApi.SearchFacet();
  });
  ...
  describe('SearchFacet', function() {
    it('should create an instance of SearchFacet', function() {
      // uncomment below and update the code to test SearchFacet
      //var instance = new IgvfProjectApi.SearchFacet();
      //expect(instance).to.be.a(IgvfProjectApi.SearchFacet);
    });
