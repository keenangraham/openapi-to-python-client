...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IgvfProjectApi.NoResultsResponseFiltersInner();
  });
  ...
  describe('NoResultsResponseFiltersInner', function() {
    it('should create an instance of NoResultsResponseFiltersInner', function() {
      // uncomment below and update the code to test NoResultsResponseFiltersInner
      //var instance = new IgvfProjectApi.NoResultsResponseFiltersInner();
      //expect(instance).to.be.a(IgvfProjectApi.NoResultsResponseFiltersInner);
    });
