...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IgvfProjectApi.Software();
  });
  ...
  describe('Software', function() {
    it('should create an instance of Software', function() {
      // uncomment below and update the code to test Software
      //var instance = new IgvfProjectApi.Software();
      //expect(instance).to.be.a(IgvfProjectApi.Software);
    });
