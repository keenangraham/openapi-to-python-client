...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IgvfProjectApi.GeneLocation1();
  });
  ...
  describe('GeneLocation1', function() {
    it('should create an instance of GeneLocation1', function() {
      // uncomment below and update the code to test GeneLocation1
      //var instance = new IgvfProjectApi.GeneLocation1();
      //expect(instance).to.be.a(IgvfProjectApi.GeneLocation1);
    });
