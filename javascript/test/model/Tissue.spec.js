...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IgvfProjectApi.Tissue();
  });
  ...
  describe('Tissue', function() {
    it('should create an instance of Tissue', function() {
      // uncomment below and update the code to test Tissue
      //var instance = new IgvfProjectApi.Tissue();
      //expect(instance).to.be.a(IgvfProjectApi.Tissue);
    });
