...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IgvfProjectApi.ModelFileResults();
  });
  ...
  describe('ModelFileResults', function() {
    it('should create an instance of ModelFileResults', function() {
      // uncomment below and update the code to test ModelFileResults
      //var instance = new IgvfProjectApi.ModelFileResults();
      //expect(instance).to.be.a(IgvfProjectApi.ModelFileResults);
    });
