...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IgvfProjectApi.InstitutionalCertificate();
  });
  ...
  describe('InstitutionalCertificate', function() {
    it('should create an instance of InstitutionalCertificate', function() {
      // uncomment below and update the code to test InstitutionalCertificate
      //var instance = new IgvfProjectApi.InstitutionalCertificate();
      //expect(instance).to.be.a(IgvfProjectApi.InstitutionalCertificate);
    });
