...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IgvfProjectApi.SequenceFile();
  });
  ...
  describe('SequenceFile', function() {
    it('should create an instance of SequenceFile', function() {
      // uncomment below and update the code to test SequenceFile
      //var instance = new IgvfProjectApi.SequenceFile();
      //expect(instance).to.be.a(IgvfProjectApi.SequenceFile);
    });
