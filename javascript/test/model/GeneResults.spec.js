...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IgvfProjectApi.GeneResults();
  });
  ...
  describe('GeneResults', function() {
    it('should create an instance of GeneResults', function() {
      // uncomment below and update the code to test GeneResults
      //var instance = new IgvfProjectApi.GeneResults();
      //expect(instance).to.be.a(IgvfProjectApi.GeneResults);
    });
