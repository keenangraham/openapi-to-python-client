...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IgvfProjectApi.PrimaryCell();
  });
  ...
  describe('PrimaryCell', function() {
    it('should create an instance of PrimaryCell', function() {
      // uncomment below and update the code to test PrimaryCell
      //var instance = new IgvfProjectApi.PrimaryCell();
      //expect(instance).to.be.a(IgvfProjectApi.PrimaryCell);
    });
