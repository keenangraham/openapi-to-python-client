...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IgvfProjectApi.AnalysisStep();
  });
  ...
  describe('AnalysisStep', function() {
    it('should create an instance of AnalysisStep', function() {
      // uncomment below and update the code to test AnalysisStep
      //var instance = new IgvfProjectApi.AnalysisStep();
      //expect(instance).to.be.a(IgvfProjectApi.AnalysisStep);
    });
