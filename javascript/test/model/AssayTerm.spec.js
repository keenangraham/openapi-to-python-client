...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IgvfProjectApi.AssayTerm();
  });
  ...
  describe('AssayTerm', function() {
    it('should create an instance of AssayTerm', function() {
      // uncomment below and update the code to test AssayTerm
      //var instance = new IgvfProjectApi.AssayTerm();
      //expect(instance).to.be.a(IgvfProjectApi.AssayTerm);
    });
