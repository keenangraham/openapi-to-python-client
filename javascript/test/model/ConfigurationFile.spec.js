...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IgvfProjectApi.ConfigurationFile();
  });
  ...
  describe('ConfigurationFile', function() {
    it('should create an instance of ConfigurationFile', function() {
      // uncomment below and update the code to test ConfigurationFile
      //var instance = new IgvfProjectApi.ConfigurationFile();
      //expect(instance).to.be.a(IgvfProjectApi.ConfigurationFile);
    });
