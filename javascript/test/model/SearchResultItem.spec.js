...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IgvfProjectApi.SearchResultItem();
  });
  ...
  describe('SearchResultItem', function() {
    it('should create an instance of SearchResultItem', function() {
      // uncomment below and update the code to test SearchResultItem
      //var instance = new IgvfProjectApi.SearchResultItem();
      //expect(instance).to.be.a(IgvfProjectApi.SearchResultItem);
    });
