...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IgvfProjectApi.PredictionSet();
  });
  ...
  describe('PredictionSet', function() {
    it('should create an instance of PredictionSet', function() {
      // uncomment below and update the code to test PredictionSet
      //var instance = new IgvfProjectApi.PredictionSet();
      //expect(instance).to.be.a(IgvfProjectApi.PredictionSet);
    });
