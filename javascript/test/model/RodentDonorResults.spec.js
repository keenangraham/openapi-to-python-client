...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IgvfProjectApi.RodentDonorResults();
  });
  ...
  describe('RodentDonorResults', function() {
    it('should create an instance of RodentDonorResults', function() {
      // uncomment below and update the code to test RodentDonorResults
      //var instance = new IgvfProjectApi.RodentDonorResults();
      //expect(instance).to.be.a(IgvfProjectApi.RodentDonorResults);
    });
