...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IgvfProjectApi.AnalysisStepVersion();
  });
  ...
  describe('AnalysisStepVersion', function() {
    it('should create an instance of AnalysisStepVersion', function() {
      // uncomment below and update the code to test AnalysisStepVersion
      //var instance = new IgvfProjectApi.AnalysisStepVersion();
      //expect(instance).to.be.a(IgvfProjectApi.AnalysisStepVersion);
    });
