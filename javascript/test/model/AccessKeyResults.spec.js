...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IgvfProjectApi.AccessKeyResults();
  });
  ...
  describe('AccessKeyResults', function() {
    it('should create an instance of AccessKeyResults', function() {
      // uncomment below and update the code to test AccessKeyResults
      //var instance = new IgvfProjectApi.AccessKeyResults();
      //expect(instance).to.be.a(IgvfProjectApi.AccessKeyResults);
    });
