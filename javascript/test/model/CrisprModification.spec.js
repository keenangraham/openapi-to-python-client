...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IgvfProjectApi.CrisprModification();
  });
  ...
  describe('CrisprModification', function() {
    it('should create an instance of CrisprModification', function() {
      // uncomment below and update the code to test CrisprModification
      //var instance = new IgvfProjectApi.CrisprModification();
      //expect(instance).to.be.a(IgvfProjectApi.CrisprModification);
    });
