...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IgvfProjectApi.SignalFileResults();
  });
  ...
  describe('SignalFileResults', function() {
    it('should create an instance of SignalFileResults', function() {
      // uncomment below and update the code to test SignalFileResults
      //var instance = new IgvfProjectApi.SignalFileResults();
      //expect(instance).to.be.a(IgvfProjectApi.SignalFileResults);
    });
