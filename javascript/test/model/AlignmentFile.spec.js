...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IgvfProjectApi.AlignmentFile();
  });
  ...
  describe('AlignmentFile', function() {
    it('should create an instance of AlignmentFile', function() {
      // uncomment below and update the code to test AlignmentFile
      //var instance = new IgvfProjectApi.AlignmentFile();
      //expect(instance).to.be.a(IgvfProjectApi.AlignmentFile);
    });
