...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IgvfProjectApi.TabularFileResults();
  });
  ...
  describe('TabularFileResults', function() {
    it('should create an instance of TabularFileResults', function() {
      // uncomment below and update the code to test TabularFileResults
      //var instance = new IgvfProjectApi.TabularFileResults();
      //expect(instance).to.be.a(IgvfProjectApi.TabularFileResults);
    });
