...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IgvfProjectApi.DocumentResults();
  });
  ...
  describe('DocumentResults', function() {
    it('should create an instance of DocumentResults', function() {
      // uncomment below and update the code to test DocumentResults
      //var instance = new IgvfProjectApi.DocumentResults();
      //expect(instance).to.be.a(IgvfProjectApi.DocumentResults);
    });
