...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IgvfProjectApi.SampleTerm();
  });
  ...
  describe('SampleTerm', function() {
    it('should create an instance of SampleTerm', function() {
      // uncomment below and update the code to test SampleTerm
      //var instance = new IgvfProjectApi.SampleTerm();
      //expect(instance).to.be.a(IgvfProjectApi.SampleTerm);
    });
