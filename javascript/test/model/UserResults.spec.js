...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IgvfProjectApi.UserResults();
  });
  ...
  describe('UserResults', function() {
    it('should create an instance of UserResults', function() {
      // uncomment below and update the code to test UserResults
      //var instance = new IgvfProjectApi.UserResults();
      //expect(instance).to.be.a(IgvfProjectApi.UserResults);
    });
