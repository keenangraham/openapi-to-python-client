...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IgvfProjectApi.ModelSetResults();
  });
  ...
  describe('ModelSetResults', function() {
    it('should create an instance of ModelSetResults', function() {
      // uncomment below and update the code to test ModelSetResults
      //var instance = new IgvfProjectApi.ModelSetResults();
      //expect(instance).to.be.a(IgvfProjectApi.ModelSetResults);
    });
