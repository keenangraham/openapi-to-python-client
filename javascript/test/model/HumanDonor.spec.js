...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IgvfProjectApi.HumanDonor();
  });
  ...
  describe('HumanDonor', function() {
    it('should create an instance of HumanDonor', function() {
      // uncomment below and update the code to test HumanDonor
      //var instance = new IgvfProjectApi.HumanDonor();
      //expect(instance).to.be.a(IgvfProjectApi.HumanDonor);
    });
