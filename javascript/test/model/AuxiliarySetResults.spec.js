...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IgvfProjectApi.AuxiliarySetResults();
  });
  ...
  describe('AuxiliarySetResults', function() {
    it('should create an instance of AuxiliarySetResults', function() {
      // uncomment below and update the code to test AuxiliarySetResults
      //var instance = new IgvfProjectApi.AuxiliarySetResults();
      //expect(instance).to.be.a(IgvfProjectApi.AuxiliarySetResults);
    });
