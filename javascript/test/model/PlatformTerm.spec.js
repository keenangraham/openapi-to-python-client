...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IgvfProjectApi.PlatformTerm();
  });
  ...
  describe('PlatformTerm', function() {
    it('should create an instance of PlatformTerm', function() {
      // uncomment below and update the code to test PlatformTerm
      //var instance = new IgvfProjectApi.PlatformTerm();
      //expect(instance).to.be.a(IgvfProjectApi.PlatformTerm);
    });
