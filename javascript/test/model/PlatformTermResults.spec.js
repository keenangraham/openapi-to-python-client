...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IgvfProjectApi.PlatformTermResults();
  });
  ...
  describe('PlatformTermResults', function() {
    it('should create an instance of PlatformTermResults', function() {
      // uncomment below and update the code to test PlatformTermResults
      //var instance = new IgvfProjectApi.PlatformTermResults();
      //expect(instance).to.be.a(IgvfProjectApi.PlatformTermResults);
    });
