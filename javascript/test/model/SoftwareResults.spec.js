...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IgvfProjectApi.SoftwareResults();
  });
  ...
  describe('SoftwareResults', function() {
    it('should create an instance of SoftwareResults', function() {
      // uncomment below and update the code to test SoftwareResults
      //var instance = new IgvfProjectApi.SoftwareResults();
      //expect(instance).to.be.a(IgvfProjectApi.SoftwareResults);
    });
