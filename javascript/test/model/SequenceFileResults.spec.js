...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IgvfProjectApi.SequenceFileResults();
  });
  ...
  describe('SequenceFileResults', function() {
    it('should create an instance of SequenceFileResults', function() {
      // uncomment below and update the code to test SequenceFileResults
      //var instance = new IgvfProjectApi.SequenceFileResults();
      //expect(instance).to.be.a(IgvfProjectApi.SequenceFileResults);
    });
