...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IgvfProjectApi.ImageResults();
  });
  ...
  describe('ImageResults', function() {
    it('should create an instance of ImageResults', function() {
      // uncomment below and update the code to test ImageResults
      //var instance = new IgvfProjectApi.ImageResults();
      //expect(instance).to.be.a(IgvfProjectApi.ImageResults);
    });
