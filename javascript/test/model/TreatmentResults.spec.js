...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IgvfProjectApi.TreatmentResults();
  });
  ...
  describe('TreatmentResults', function() {
    it('should create an instance of TreatmentResults', function() {
      // uncomment below and update the code to test TreatmentResults
      //var instance = new IgvfProjectApi.TreatmentResults();
      //expect(instance).to.be.a(IgvfProjectApi.TreatmentResults);
    });
