...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IgvfProjectApi.TissueResults();
  });
  ...
  describe('TissueResults', function() {
    it('should create an instance of TissueResults', function() {
      // uncomment below and update the code to test TissueResults
      //var instance = new IgvfProjectApi.TissueResults();
      //expect(instance).to.be.a(IgvfProjectApi.TissueResults);
    });
