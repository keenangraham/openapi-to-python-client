...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IgvfProjectApi.PublicationResults();
  });
  ...
  describe('PublicationResults', function() {
    it('should create an instance of PublicationResults', function() {
      // uncomment below and update the code to test PublicationResults
      //var instance = new IgvfProjectApi.PublicationResults();
      //expect(instance).to.be.a(IgvfProjectApi.PublicationResults);
    });
