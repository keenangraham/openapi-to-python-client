...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IgvfProjectApi.SignalFile();
  });
  ...
  describe('SignalFile', function() {
    it('should create an instance of SignalFile', function() {
      // uncomment below and update the code to test SignalFile
      //var instance = new IgvfProjectApi.SignalFile();
      //expect(instance).to.be.a(IgvfProjectApi.SignalFile);
    });
