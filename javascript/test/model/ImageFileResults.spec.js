...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IgvfProjectApi.ImageFileResults();
  });
  ...
  describe('ImageFileResults', function() {
    it('should create an instance of ImageFileResults', function() {
      // uncomment below and update the code to test ImageFileResults
      //var instance = new IgvfProjectApi.ImageFileResults();
      //expect(instance).to.be.a(IgvfProjectApi.ImageFileResults);
    });
