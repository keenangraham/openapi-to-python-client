...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IgvfProjectApi.HumanDonorResults();
  });
  ...
  describe('HumanDonorResults', function() {
    it('should create an instance of HumanDonorResults', function() {
      // uncomment below and update the code to test HumanDonorResults
      //var instance = new IgvfProjectApi.HumanDonorResults();
      //expect(instance).to.be.a(IgvfProjectApi.HumanDonorResults);
    });
