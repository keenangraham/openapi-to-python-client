...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IgvfProjectApi.AnalysisStepResults();
  });
  ...
  describe('AnalysisStepResults', function() {
    it('should create an instance of AnalysisStepResults', function() {
      // uncomment below and update the code to test AnalysisStepResults
      //var instance = new IgvfProjectApi.AnalysisStepResults();
      //expect(instance).to.be.a(IgvfProjectApi.AnalysisStepResults);
    });
