...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IgvfProjectApi.WorkflowResults();
  });
  ...
  describe('WorkflowResults', function() {
    it('should create an instance of WorkflowResults', function() {
      // uncomment below and update the code to test WorkflowResults
      //var instance = new IgvfProjectApi.WorkflowResults();
      //expect(instance).to.be.a(IgvfProjectApi.WorkflowResults);
    });
