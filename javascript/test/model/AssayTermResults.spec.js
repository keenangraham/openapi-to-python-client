...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IgvfProjectApi.AssayTermResults();
  });
  ...
  describe('AssayTermResults', function() {
    it('should create an instance of AssayTermResults', function() {
      // uncomment below and update the code to test AssayTermResults
      //var instance = new IgvfProjectApi.AssayTermResults();
      //expect(instance).to.be.a(IgvfProjectApi.AssayTermResults);
    });
