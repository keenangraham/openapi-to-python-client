...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IgvfProjectApi.InVitroSystem();
  });
  ...
  describe('InVitroSystem', function() {
    it('should create an instance of InVitroSystem', function() {
      // uncomment below and update the code to test InVitroSystem
      //var instance = new IgvfProjectApi.InVitroSystem();
      //expect(instance).to.be.a(IgvfProjectApi.InVitroSystem);
    });
