...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IgvfProjectApi.CuratedSetResults();
  });
  ...
  describe('CuratedSetResults', function() {
    it('should create an instance of CuratedSetResults', function() {
      // uncomment below and update the code to test CuratedSetResults
      //var instance = new IgvfProjectApi.CuratedSetResults();
      //expect(instance).to.be.a(IgvfProjectApi.CuratedSetResults);
    });
