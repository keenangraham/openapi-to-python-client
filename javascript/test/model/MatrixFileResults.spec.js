...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IgvfProjectApi.MatrixFileResults();
  });
  ...
  describe('MatrixFileResults', function() {
    it('should create an instance of MatrixFileResults', function() {
      // uncomment below and update the code to test MatrixFileResults
      //var instance = new IgvfProjectApi.MatrixFileResults();
      //expect(instance).to.be.a(IgvfProjectApi.MatrixFileResults);
    });
