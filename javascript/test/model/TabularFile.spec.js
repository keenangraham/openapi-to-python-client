...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IgvfProjectApi.TabularFile();
  });
  ...
  describe('TabularFile', function() {
    it('should create an instance of TabularFile', function() {
      // uncomment below and update the code to test TabularFile
      //var instance = new IgvfProjectApi.TabularFile();
      //expect(instance).to.be.a(IgvfProjectApi.TabularFile);
    });
