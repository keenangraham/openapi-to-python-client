...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IgvfProjectApi.ModelFile();
  });
  ...
  describe('ModelFile', function() {
    it('should create an instance of ModelFile', function() {
      // uncomment below and update the code to test ModelFile
      //var instance = new IgvfProjectApi.ModelFile();
      //expect(instance).to.be.a(IgvfProjectApi.ModelFile);
    });
