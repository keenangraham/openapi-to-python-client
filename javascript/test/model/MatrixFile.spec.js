...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IgvfProjectApi.MatrixFile();
  });
  ...
  describe('MatrixFile', function() {
    it('should create an instance of MatrixFile', function() {
      // uncomment below and update the code to test MatrixFile
      //var instance = new IgvfProjectApi.MatrixFile();
      //expect(instance).to.be.a(IgvfProjectApi.MatrixFile);
    });
