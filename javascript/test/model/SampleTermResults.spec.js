...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IgvfProjectApi.SampleTermResults();
  });
  ...
  describe('SampleTermResults', function() {
    it('should create an instance of SampleTermResults', function() {
      // uncomment below and update the code to test SampleTermResults
      //var instance = new IgvfProjectApi.SampleTermResults();
      //expect(instance).to.be.a(IgvfProjectApi.SampleTermResults);
    });
