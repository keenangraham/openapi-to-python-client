...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IgvfProjectApi.PageResults();
  });
  ...
  describe('PageResults', function() {
    it('should create an instance of PageResults', function() {
      // uncomment below and update the code to test PageResults
      //var instance = new IgvfProjectApi.PageResults();
      //expect(instance).to.be.a(IgvfProjectApi.PageResults);
    });
