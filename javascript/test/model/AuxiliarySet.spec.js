...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IgvfProjectApi.AuxiliarySet();
  });
  ...
  describe('AuxiliarySet', function() {
    it('should create an instance of AuxiliarySet', function() {
      // uncomment below and update the code to test AuxiliarySet
      //var instance = new IgvfProjectApi.AuxiliarySet();
      //expect(instance).to.be.a(IgvfProjectApi.AuxiliarySet);
    });
