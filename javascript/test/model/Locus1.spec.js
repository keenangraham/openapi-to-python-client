...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IgvfProjectApi.Locus1();
  });
  ...
  describe('Locus1', function() {
    it('should create an instance of Locus1', function() {
      // uncomment below and update the code to test Locus1
      //var instance = new IgvfProjectApi.Locus1();
      //expect(instance).to.be.a(IgvfProjectApi.Locus1);
    });
