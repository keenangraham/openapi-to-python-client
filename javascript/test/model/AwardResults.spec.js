...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IgvfProjectApi.AwardResults();
  });
  ...
  describe('AwardResults', function() {
    it('should create an instance of AwardResults', function() {
      // uncomment below and update the code to test AwardResults
      //var instance = new IgvfProjectApi.AwardResults();
      //expect(instance).to.be.a(IgvfProjectApi.AwardResults);
    });
