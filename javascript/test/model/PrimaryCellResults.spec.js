...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IgvfProjectApi.PrimaryCellResults();
  });
  ...
  describe('PrimaryCellResults', function() {
    it('should create an instance of PrimaryCellResults', function() {
      // uncomment below and update the code to test PrimaryCellResults
      //var instance = new IgvfProjectApi.PrimaryCellResults();
      //expect(instance).to.be.a(IgvfProjectApi.PrimaryCellResults);
    });
