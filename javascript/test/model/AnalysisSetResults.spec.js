...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IgvfProjectApi.AnalysisSetResults();
  });
  ...
  describe('AnalysisSetResults', function() {
    it('should create an instance of AnalysisSetResults', function() {
      // uncomment below and update the code to test AnalysisSetResults
      //var instance = new IgvfProjectApi.AnalysisSetResults();
      //expect(instance).to.be.a(IgvfProjectApi.AnalysisSetResults);
    });
