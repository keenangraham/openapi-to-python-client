...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IgvfProjectApi.LabResults();
  });
  ...
  describe('LabResults', function() {
    it('should create an instance of LabResults', function() {
      // uncomment below and update the code to test LabResults
      //var instance = new IgvfProjectApi.LabResults();
      //expect(instance).to.be.a(IgvfProjectApi.LabResults);
    });
