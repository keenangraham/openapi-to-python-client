...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IgvfProjectApi.SourceResults();
  });
  ...
  describe('SourceResults', function() {
    it('should create an instance of SourceResults', function() {
      // uncomment below and update the code to test SourceResults
      //var instance = new IgvfProjectApi.SourceResults();
      //expect(instance).to.be.a(IgvfProjectApi.SourceResults);
    });
