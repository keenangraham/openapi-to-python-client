...
**fileSetType** | **String** | The category that best describes this curated file set. | [optional] 
**id** | **String** |  | [optional] 
...
* `editing templates` (value: `"editing templates"`)

* `elements` (value: `"elements"`)

* `external data for catalog` (value: `"external data for catalog"`)

* `genome` (value: `"genome"`)

* `genes` (value: `"genes"`)

* `guide RNAs` (value: `"guide RNAs"`)

* `transcriptome` (value: `"transcriptome"`)
