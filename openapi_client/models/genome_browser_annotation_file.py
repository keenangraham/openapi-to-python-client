...
class GenomeBrowserAnnotationFile(BaseModel):
    ...
    derived_from: Annotated[List[StrictStr], Field(min_length=1)] = Field(description="The files participating as inputs into software to produce this output file.")
