...
class MultiplexedSample(BaseModel):
    ...
    construct_library_sets: Optional[Annotated[List[StrictStr], Field(min_length=1)]] = Field(default=None, description="The construct library sets of the samples included in this multiplexed sample.")
    ...
    multiplexed_samples: Optional[Annotated[List[StrictStr], Field(min_length=2)]] = Field(default=None, description="The samples multiplexed together to produce this sample.")
    ...
    barcode_sample_map: Optional[StrictStr] = Field(default=None, description="The link to the barcode to sample mapping tabular file.")
    ...
    sample_terms: Optional[Annotated[List[StrictStr], Field(min_length=1)]] = Field(default=None, description="The sample terms of the samples included in this multiplexed sample.")
    disease_terms: Optional[Annotated[List[StrictStr], Field(min_length=1)]] = Field(default=None, description="The disease terms of the samples included in this multiplexed sample.")
    treatments: Optional[Annotated[List[StrictStr], Field(min_length=1)]] = Field(default=None, description="The treatments of the samples included in this multiplexed sample.")
    modifications: Optional[Annotated[List[StrictStr], Field(min_length=1)]] = Field(default=None, description="The modifications of the samples included in this multiplexed sample.")
    donors: Optional[Annotated[List[StrictStr], Field(min_length=1)]] = Field(default=None, description="The donors of the samples included in this multiplexed sample.")
    biomarkers: Optional[Annotated[List[StrictStr], Field(min_length=1)]] = Field(default=None, description="The biomarkers of the samples included in this multiplexed sample.")
    sources: Optional[Annotated[List[StrictStr], Field(min_length=1)]] = Field(default=None, description="The sources of the samples included in this multiplexed sample.")
    ...
    __properties: ClassVar[List[str]] = ["release_timestamp", "publication_identifiers", "url", "documents", "lab", "award", "accession", "alternate_accessions", "collections", "status", "revoke_detail", "schema_version", "uuid", "notes", "aliases", "creation_timestamp", "submitted_by", "submitter_comment", "description", "starting_amount", "starting_amount_units", "dbxrefs", "date_obtained", "sorted_from", "sorted_from_detail", "virtual", "construct_library_sets", "moi", "nucleic_acid_delivery", "time_post_library_delivery", "time_post_library_delivery_units", "protocols", "multiplexed_samples", "cellular_sub_pool", "barcode_sample_map", "@id", "@type", "summary", "file_sets", "multiplexed_in", "sorted_fractions", "origin_of", "institutional_certificates", "sample_terms", "disease_terms", "treatments", "modifications", "donors", "biomarkers", "sources", "classifications"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "barcode_sample_map": obj.get("barcode_sample_map"),
            "@id": obj.get("@id"),
            "@type": obj.get("@type"),
