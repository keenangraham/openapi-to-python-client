...
class RodentDonor(BaseModel):
    ...
    phenotypic_features: Optional[Annotated[List[PhenotypicFeature1], Field(min_length=1)]] = Field(default=None, description="A list of associated phenotypic features of the donor.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "phenotypic_features": [PhenotypicFeature1.from_dict(_item) for _item in obj["phenotypic_features"]] if obj.get("phenotypic_features") is not None else None,
