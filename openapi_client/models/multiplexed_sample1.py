...
MULTIPLEXEDSAMPLE1_ANY_OF_SCHEMAS = ["object"]

class MultiplexedSample1(BaseModel):
    """
    MultiplexedSample1
    """
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = MultiplexedSample1.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in MultiplexedSample1 with anyOf schemas: object. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into MultiplexedSample1 with anyOf schemas: object. Details: " + ", ".join(error_messages))
        else:
            return instance
