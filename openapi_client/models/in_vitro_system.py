...
class InVitroSystem(BaseModel):
    ...
    classifications: Optional[Annotated[List[StrictStr], Field(min_length=1, max_length=2)]] = Field(default=None, description="The general category of this type of in vitro system.")
