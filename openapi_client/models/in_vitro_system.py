...
class InVitroSystem(BaseModel):
    ...
    pooled_from: Optional[Annotated[List[InVitroSystemPooledFromInner], Field(min_length=2)]] = Field(default=None, description="The biosamples this biosample is pooled from.")
    part_of: Optional[PartOfBiosample] = None
    ...
    classifications: Annotated[List[StrictStr], Field(min_length=1, max_length=2)] = Field(description="The general category of this type of in vitro system.")
    ...
    cell_fate_change_treatments: Optional[Annotated[List[Treatment1], Field(min_length=1)]] = Field(default=None, description="A list of treatments applied to the biosample with the purpose of differentiation, dedifferentiation, or reprogramming.")
    cell_fate_change_protocol: Optional[CellFateChangeProtocol] = None
    demultiplexed_from: Optional[DemultiplexedFrom] = None
    ...
    targeted_sample_term: Optional[TargetedSampleTerm] = None
    ...
    demultiplexed_to: Optional[Annotated[List[Any], Field(min_length=1)]] = Field(default=None, description="The parts into which this sample has been demultiplexed.")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in cell_fate_change_treatments (list)
        _items = []
        if self.cell_fate_change_treatments:
            for _item in self.cell_fate_change_treatments:
                if _item:
                    _items.append(_item.to_dict())
            _dict['cell_fate_change_treatments'] = _items
        # override the default output from pydantic by calling `to_dict()` of cell_fate_change_protocol
        if self.cell_fate_change_protocol:
            _dict['cell_fate_change_protocol'] = self.cell_fate_change_protocol.to_dict()
        # override the default output from pydantic by calling `to_dict()` of demultiplexed_from
        if self.demultiplexed_from:
            _dict['demultiplexed_from'] = self.demultiplexed_from.to_dict()
        # override the default output from pydantic by calling `to_dict()` of targeted_sample_term
        if self.targeted_sample_term:
            _dict['targeted_sample_term'] = self.targeted_sample_term.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pooled_from": [InVitroSystemPooledFromInner.from_dict(_item) for _item in obj["pooled_from"]] if obj.get("pooled_from") is not None else None,
            "part_of": PartOfBiosample.from_dict(obj["part_of"]) if obj.get("part_of") is not None else None,
            ...
            "cell_fate_change_treatments": [Treatment1.from_dict(_item) for _item in obj["cell_fate_change_treatments"]] if obj.get("cell_fate_change_treatments") is not None else None,
            "cell_fate_change_protocol": CellFateChangeProtocol.from_dict(obj["cell_fate_change_protocol"]) if obj.get("cell_fate_change_protocol") is not None else None,
            "demultiplexed_from": DemultiplexedFrom.from_dict(obj["demultiplexed_from"]) if obj.get("demultiplexed_from") is not None else None,
            "passage_number": obj.get("passage_number"),
            "targeted_sample_term": TargetedSampleTerm.from_dict(obj["targeted_sample_term"]) if obj.get("targeted_sample_term") is not None else None,
...
InVitroSystem.model_rebuild(raise_errors=False)
