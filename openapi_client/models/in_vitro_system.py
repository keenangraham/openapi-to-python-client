...
class InVitroSystem(BaseModel):
    ...
    part_of: Optional[InVitroSystemPooledFromInner] = None
    ...
    cell_fate_change_treatments: Optional[Annotated[List[InVitroSystemTreatmentsInner], Field(min_length=1)]] = Field(default=None, description="A list of treatments applied to the biosample with the purpose of differentiation, dedifferentiation, or reprogramming.")
    cell_fate_change_protocol: Optional[RodentDonorDocumentsInner] = None
    demultiplexed_from: Optional[InVitroSystemDemultiplexedFrom] = None
    ...
    targeted_sample_term: Optional[InVitroSystemSampleTermsInner] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "part_of": InVitroSystemPooledFromInner.from_dict(obj["part_of"]) if obj.get("part_of") is not None else None,
            ...
            "cell_fate_change_treatments": [InVitroSystemTreatmentsInner.from_dict(_item) for _item in obj["cell_fate_change_treatments"]] if obj.get("cell_fate_change_treatments") is not None else None,
            "cell_fate_change_protocol": RodentDonorDocumentsInner.from_dict(obj["cell_fate_change_protocol"]) if obj.get("cell_fate_change_protocol") is not None else None,
            "demultiplexed_from": InVitroSystemDemultiplexedFrom.from_dict(obj["demultiplexed_from"]) if obj.get("demultiplexed_from") is not None else None,
            "passage_number": obj.get("passage_number"),
            "targeted_sample_term": InVitroSystemSampleTermsInner.from_dict(obj["targeted_sample_term"]) if obj.get("targeted_sample_term") is not None else None,
