...
class InVitroSystem(BaseModel):
    ...
    cell_fate_change_treatments: Optional[Annotated[List[StrictStr], Field(min_length=1)]] = Field(default=None, description="A list of treatments applied to the biosample with the purpose of differentiation, dedifferentiation, or reprogramming.")
    ...
    demultiplexed_to: Optional[Annotated[List[DemultiplexedTo], Field(min_length=1)]] = Field(default=None, description="The parts into which this sample has been demultiplexed.")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in demultiplexed_to (list)
        _items = []
        if self.demultiplexed_to:
            for _item in self.demultiplexed_to:
                if _item:
                    _items.append(_item.to_dict())
            _dict['demultiplexed_to'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "demultiplexed_to": [DemultiplexedTo.from_dict(_item) for _item in obj["demultiplexed_to"]] if obj.get("demultiplexed_to") is not None else None
        })
        return _obj
