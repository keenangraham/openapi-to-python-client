...
class SignalFile(BaseModel):
    ...
    strand_specificity: StrictStr = Field(description="The strandedness of the signal file: plus, minus, or unstranded.")
...
SignalFile.model_rebuild(raise_errors=False)
