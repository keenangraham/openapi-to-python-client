...
class Search200ResponseFacetsInner(BaseModel):
    """
    Search200ResponseFacetsInner
    """ # noqa: E501
    var_field: Optional[StrictStr] = Field(default=None, alias="field")
    title: Optional[StrictStr] = None
    terms: Optional[List[Search200ResponseFacetsInnerTermsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "field": obj.get("field"),
            "title": obj.get("title"),
            "terms": [Search200ResponseFacetsInnerTermsInner.from_dict(_item) for _item in obj["terms"]] if obj.get("terms") is not None else None
        })
        return _obj
