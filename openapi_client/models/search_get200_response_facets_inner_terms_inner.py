...
class SearchGet200ResponseFacetsInnerTermsInner(BaseModel):
    """
    SearchGet200ResponseFacetsInnerTermsInner
    """ # noqa: E501
    key: Optional[StrictStr] = None
    doc_count: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["key", "doc_count"]
