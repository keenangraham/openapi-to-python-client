...
class SearchGet200Response(BaseModel):
    ...
    """ # noqa: E501
    graph: Optional[List[SearchGet200ResponseGraphInner]] = Field(default=None, alias="@graph")
    id: Optional[StrictStr] = Field(default=None, alias="@id")
    type: Optional[List[StrictStr]] = Field(default=None, alias="@type")
    total: Optional[StrictInt] = None
    facets: Optional[List[SearchGet200ResponseFacetsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "@graph": [SearchGet200ResponseGraphInner.from_dict(_item) for _item in obj["@graph"]] if obj.get("@graph") is not None else None,
            "@id": obj.get("@id"),
            "@type": obj.get("@type"),
            "total": obj.get("total"),
            "facets": [SearchGet200ResponseFacetsInner.from_dict(_item) for _item in obj["facets"]] if obj.get("facets") is not None else None
        })
        return _obj
